...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    /* renamed from: X */
    public static final ViewProperty f126X = new ViewProperty("x") {
        public float getValue(View view) {
            return view.getX();
        }
    ...
    /* renamed from: Y */
    public static final ViewProperty f127Y = new ViewProperty("y") {
        public float getValue(View view) {
            return view.getY();
        }
    ...
    /* renamed from: Z */
    public static final ViewProperty f128Z = new ViewProperty("z") {
        public float getValue(View view) {
