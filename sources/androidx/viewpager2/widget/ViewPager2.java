...
public final class ViewPager2 extends ViewGroup {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        C05792 r3 = new OnPageChangeCallback() {
            public void onPageScrollStateChanged(int i) {
                if (i == 0) {
        ...
        C05803 r4 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        int[] iArr = C0565R.styleable.ViewPager2;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, iArr, attributeSet, obtainStyledAttributes, 0, 0);
        }
        try {
            setOrientation(obtainStyledAttributes.getInt(C0565R.styleable.ViewPager2_android_orientation, 0));
        } finally {
    ...
    public boolean fakeDragBy(@C0033Px @SuppressLint({"SupportAnnotationUsage"}) float f) {
