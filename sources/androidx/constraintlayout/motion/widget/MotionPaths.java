...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        ...
        zArr[1] = zArr[1] | diff(this.f97x, motionPaths.f97x) | z;
        zArr[2] = z | diff(this.f98y, motionPaths.f98y) | zArr[2];
        zArr[3] = zArr[3] | diff(this.width, motionPaths.width);
        zArr[4] = diff(this.height, motionPaths.height) | zArr[4];
    }

    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f97x, this.f98y, this.width, this.height, this.mPathRotate};
        int i = 0;
    ...
    public void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = motionPaths3.f97x;
        float f11 = motionPaths3.f98y;
        float f12 = ((f4 / 2.0f) + motionPaths4.f97x) - ((f5 / 2.0f) + f10);
        float f13 = ((f7 / 2.0f) + motionPaths4.f98y) - ((f8 / 2.0f) + f11);
        float f14 = f6 * f2;
        float f15 = f14 / 2.0f;
        this.f97x = (float) ((int) (((f12 * f) + f10) - f15));
        float f16 = (f13 * f) + f11;
        float f17 = f9 * f3;
        float f18 = f17 / 2.0f;
        this.f98y = (float) ((int) (f16 - f18));
        ...
        this.f97x = (float) ((int) (((f20 * f13) + ((f19 * f12) + motionPaths5.f97x)) - f15));
        this.f98y = (float) ((int) (((f13 * f) + ((f12 * f21) + motionPaths5.f98y)) - f18));
    ...
    public void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths3.f97x;
        float f7 = motionPaths3.width;
        float f8 = motionPaths3.f98y;
        float f9 = motionPaths3.height;
        float f10 = ((motionPaths4.width / 2.0f) + motionPaths4.f97x) - ((f7 / 2.0f) + f6);
        float f11 = ((motionPaths4.height / 2.0f) + motionPaths4.f98y) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = f4 * f2;
        float f14 = f13 / 2.0f;
        this.f97x = (float) ((int) ((f6 + f12) - f14));
        float f15 = f * f11;
        float f16 = f5 * f3;
        float f17 = f16 / 2.0f;
        this.f98y = (float) ((int) ((f8 + f15) - f17));
        ...
        this.mMode = 1;
        MotionPaths motionPaths5 = motionPaths;
        float f21 = (float) ((int) ((motionPaths5.f97x + f12) - f14));
        this.f97x = f21;
        float f22 = (float) ((int) ((motionPaths5.f98y + f15) - f17));
        this.f98y = f22;
        this.f97x = f21 + f19;
        this.f98y = f22 + f20;
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition3.mTransitionEasing);
    ...
    public void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = motionPaths3.f97x;
        float f11 = motionPaths3.f98y;
        float f12 = (f4 / 2.0f) + motionPaths4.f97x;
        float f13 = (f7 / 2.0f) + motionPaths4.f98y;
        float f14 = f6 * f2;
        this.f97x = (float) ((int) ((((f12 - ((f5 / 2.0f) + f10)) * f) + f10) - (f14 / 2.0f)));
        float f15 = f9 * f3;
        this.f98y = (float) ((int) ((((f13 - ((f8 / 2.0f) + f11)) * f) + f11) - (f15 / 2.0f)));
        this.width = (float) ((int) (f5 + f14));
        this.height = (float) ((int) (f8 + f15));
        this.mMode = 3;
        KeyPosition keyPosition3 = keyPosition;
        if (!Float.isNaN(keyPosition3.mPercentX)) {
            this.f97x = (float) ((int) (keyPosition3.mPercentX * ((float) ((int) (((float) i) - this.width)))));
        }
        if (!Float.isNaN(keyPosition3.mPercentY)) {
            this.f98y = (float) ((int) (keyPosition3.mPercentY * ((float) ((int) (((float) i2) - this.height)))));
        }
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition3.mTransitionEasing);
        this.mPathMotionArc = keyPosition3.mPathMotionArc;
    }
