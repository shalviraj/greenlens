...
public class TouchResponse {
    ...
    private void fill(TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == C0190R.styleable.OnSwipe_touchAnchorId) {
                this.mTouchAnchorId = typedArray.getResourceId(index, this.mTouchAnchorId);
            } else if (index == C0190R.styleable.OnSwipe_touchAnchorSide) {
    ...
    private void fillFromAttributeList(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0190R.styleable.OnSwipe);
    ...
    public void setupTouch() {
        ...
        if (i != -1) {
            ...
            if (view == null) {
                StringBuilder u = C0843a.m460u("cannot find TouchAnchorId @id/");
                u.append(Debug.getName(this.mMotionLayout.getContext(), this.mTouchAnchorId));
