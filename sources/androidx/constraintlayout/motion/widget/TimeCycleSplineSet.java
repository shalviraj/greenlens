...
public abstract class TimeCycleSplineSet {
    ...
    public static class CustomSet extends TimeCycleSplineSet {
        ...
        public boolean setProperty(View view, float f, long j, KeyCache keyCache) {
            ...
            while (true) {
                ...
                this.mContinue = z | (((double) fArr3[i]) != ShadowDrawableWrapper.COS_45);
    ...
    public void setup(int i) {
        int i2 = this.count;
        if (i2 == 0) {
            StringBuilder u = C0843a.m460u("Error no points added to ");
            u.append(this.mType);
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.count; i++) {
            ...
            y.append(this.mTimePoints[i]);
            y.append(" , ");
            y.append(decimalFormat.format(this.mValues[i]));
            y.append("] ");
            str = y.toString();
        }
        return str;
