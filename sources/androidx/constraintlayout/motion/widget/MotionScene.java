...
public class MotionScene {
    ...
    public static class Transition {
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public TransitionOnClick(Context context, Transition transition, XmlPullParser xmlPullParser) {
                ...
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0190R.styleable.OnClick);
                int indexCount = obtainStyledAttributes.getIndexCount();
                for (int i = 0; i < indexCount; i++) {
                    int index = obtainStyledAttributes.getIndex(i);
                    if (index == C0190R.styleable.OnClick_targetId) {
                        this.mTargetId = obtainStyledAttributes.getResourceId(index, this.mTargetId);
                    } else if (index == C0190R.styleable.OnClick_clickAction) {
            ...
            public void addOnClickListeners(MotionLayout motionLayout, int i, Transition transition) {
                ...
                if (view == null) {
                    StringBuilder u = C0843a.m460u("OnClick could not find id ");
                    u.append(this.mTargetId);
                    Log.e(MotionScene.TAG, u.toString());
                    return;
                }
            ...
            public void removeOnClickListeners(MotionLayout motionLayout) {
                ...
                if (i != -1) {
                    ...
                    if (findViewById == null) {
                        StringBuilder u = C0843a.m460u(" (*)  could not find id ");
                        u.append(this.mTargetId);
                        Log.e(MotionScene.TAG, u.toString());
                        return;
                    }
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == C0190R.styleable.Transition_constraintSetEnd) {
                    ...
                    if (index == C0190R.styleable.Transition_constraintSetStart) {
                    ...
                    } else if (index == C0190R.styleable.Transition_motionInterpolator) {
                    ...
                    } else if (index == C0190R.styleable.Transition_duration) {
                        this.mDuration = typedArray.getInt(index, this.mDuration);
                    } else if (index == C0190R.styleable.Transition_staggered) {
                        this.mStagger = typedArray.getFloat(index, this.mStagger);
                    } else if (index == C0190R.styleable.Transition_autoTransition) {
                        this.mAutoTransition = typedArray.getInteger(index, this.mAutoTransition);
                    } else if (index == C0190R.styleable.Transition_android_id) {
                        this.mId = typedArray.getResourceId(index, this.mId);
                    } else if (index == C0190R.styleable.Transition_transitionDisable) {
                        this.mDisable = typedArray.getBoolean(index, this.mDisable);
                    } else if (index == C0190R.styleable.Transition_pathMotionArc) {
                        this.mPathMotionArc = typedArray.getInteger(index, -1);
                    } else if (index == C0190R.styleable.Transition_layoutDuringTransition) {
                        this.mLayoutDuringTransition = typedArray.getInteger(index, 0);
                    } else if (index == C0190R.styleable.Transition_transitionFlags) {
        ...
        private void fillFromAttributeList(MotionScene motionScene, Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0190R.styleable.Transition);
        ...
        public String debugString(Context context) {
            ...
            if (this.mConstraintSetEnd == -1) {
                return C0843a.m451l(resourceEntryName, " -> null");
            }
            StringBuilder y = C0843a.m464y(resourceEntryName, " -> ");
            y.append(context.getResources().getResourceEntryName(this.mConstraintSetEnd));
            return y.toString();
        }
    ...
    public MotionScene(Context context, MotionLayout motionLayout, int i) {
        ...
        int i2 = C0190R.C0193id.motion_base;
    ...
    private int getId(Context context, String str) {
        int i;
        if (str.contains("/")) {
            i = context.getResources().getIdentifier(str.substring(str.indexOf(47) + 1), AnalyticsContext.Device.DEVICE_ID_KEY, context.getPackageName());
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0190R.styleable.MotionScene);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0190R.styleable.MotionScene_defaultDuration) {
                this.mDefaultDuration = obtainStyledAttributes.getInt(index, this.mDefaultDuration);
            } else if (index == C0190R.styleable.MotionScene_layoutDuringTransition) {
    ...
    private void readConstraintChain(int i) {
        ...
        if (i2 > 0) {
            ...
            if (constraintSet2 == null) {
                StringBuilder u = C0843a.m460u("ERROR! invalid deriveConstraintsFrom: @id/");
                u.append(Debug.getName(this.mMotionLayout.getContext(), i2));
    ...
    public ConstraintSet getConstraintSet(int i, int i2, int i3) {
        ...
        if (this.DEBUG_DESKTOP) {
            ...
            u.append(this.mConstraintSetMap.size());
        ...
        if (this.mConstraintSetMap.get(i) == null) {
            StringBuilder u2 = C0843a.m460u("Warning could not find ConstraintSet id/");
            u2.append(Debug.getName(this.mMotionLayout.getContext(), i));
            u2.append(" In MotionScene");
