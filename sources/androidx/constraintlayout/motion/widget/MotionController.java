...
public class MotionController {
    ...
    private void insertKey(MotionPaths motionPaths) {
        ...
        if (binarySearch == 0) {
            StringBuilder u = C0843a.m460u(" KeyPath positon \"");
            u.append(motionPaths.position);
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i3 < i2) {
            ...
            if (keyCycleOscillator2 != null) {
                fArr2[i5] = keyCycleOscillator2.get(f3) + fArr2[i5];
            } else if (splineSet != null) {
                fArr2[i5] = splineSet.get(f3) + fArr2[i5];
            }
            if (keyCycleOscillator != null) {
                int i6 = i5 + 1;
                fArr2[i6] = keyCycleOscillator.get(f3) + fArr2[i6];
            } else if (splineSet2 != null) {
                int i7 = i5 + 1;
                fArr2[i7] = splineSet2.get(f3) + fArr2[i7];
            }
            i3++;
            i2 = i;
            f = 1.0f;
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = motionPaths.f97x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f6 = f5 - motionPaths2.f97x;
        float f7 = motionPaths.f98y - motionPaths2.f98y;
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f97x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f98y;
    }
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        MotionPaths motionPaths = this.mEndMotionPath;
        float f3 = motionPaths.f97x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f4 = motionPaths2.f97x;
        float f5 = f3 - f4;
        float f6 = motionPaths.f98y;
        float f7 = motionPaths2.f98y;
        float f8 = f6 - f7;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            MotionPaths motionPaths = this.mEndMotionPath;
            float f7 = motionPaths.f97x;
            MotionPaths motionPaths2 = this.mStartMotionPath;
            float f8 = f7 - motionPaths2.f97x;
            float f9 = motionPaths.f98y - motionPaths2.f98y;
    ...
    public float getStartX() {
        return this.mStartMotionPath.f97x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f98y;
    }
    ...
    public boolean interpolate(android.view.View r23, float r24, long r25, androidx.constraintlayout.motion.widget.KeyCache r27) {
        ...
        L_0x013a:
            ...
            float r4 = r3.f97x
            float r2 = p005b.p035e.p036a.p037a.C0843a.m440a(r4, r2, r12, r2)
            float r4 = r1.f98y
            float r5 = r3.f98y
            float r4 = p005b.p035e.p036a.p037a.C0843a.m440a(r5, r4, r12, r4)
            float r5 = r1.width
            float r6 = r3.width
            float r7 = p005b.p035e.p036a.p037a.C0843a.m440a(r6, r5, r12, r5)
            float r1 = r1.height
            float r3 = r3.height
            float r8 = p005b.p035e.p036a.p037a.C0843a.m440a(r3, r1, r12, r1)
    ...
    public void setup(int r17, int r18, float r19, long r20) {
        ...
        L_0x0371:
            ...
            java.lang.String r10 = p005b.p035e.p036a.p037a.C0843a.m455p(r10, r11, r12)
            r11 = r6
        L_0x0391:
    ...
    public String toString() {
        StringBuilder u = C0843a.m460u(" start: x: ");
        u.append(this.mStartMotionPath.f97x);
        u.append(" y: ");
        u.append(this.mStartMotionPath.f98y);
        u.append(" end: x: ");
        u.append(this.mEndMotionPath.f97x);
        u.append(" y: ");
        u.append(this.mEndMotionPath.f98y);
        return u.toString();
    }
}
