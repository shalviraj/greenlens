...
public class MonotonicCurveFit extends CurveFit {
    ...
    /* renamed from: mT */
    private double[] f91mT;
    private double[][] mTangent;

    /* renamed from: mY */
    private double[][] f92mY;
    ...
    public MonotonicCurveFit(double[] dArr, double[][] dArr2) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            for (int i6 = 0; i6 < length2; i6++) {
                if (dArr5[i5][i6] == ShadowDrawableWrapper.COS_45) {
                    dArr6[i5][i6] = 0.0d;
                    dArr6[i5 + 1][i6] = 0.0d;
                } else {
    ...
    public double getPos(double d, int i) {
        double[] dArr = this.f91mT;
        int length = dArr.length;
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f92mY[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f92mY[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f91mT;
            if (d == dArr2[i2]) {
                return this.f92mY[i2][i];
            }
            int i4 = i2 + 1;
            if (d < dArr2[i4]) {
                double d2 = dArr2[i4] - dArr2[i2];
                double d3 = (d - dArr2[i2]) / d2;
                double[][] dArr3 = this.f92mY;
    ...
    public void getPos(double d, double[] dArr) {
        ...
        int i = 0;
        int length2 = this.f92mY[0].length;
        if (d <= dArr2[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                dArr[i2] = this.f92mY[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f91mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    dArr[i5] = this.f92mY[i4][i5];
                }
            }
            double[] dArr3 = this.f91mT;
            int i6 = i4 + 1;
            if (d < dArr3[i6]) {
                double d2 = dArr3[i6] - dArr3[i4];
                double d3 = (d - dArr3[i4]) / d2;
                while (i < length2) {
                    double[][] dArr4 = this.f92mY;
    ...
    public void getPos(double d, float[] fArr) {
        ...
        while (i4 < i3) {
            if (d == this.f91mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f92mY[i4][i5];
                }
            }
            double[] dArr2 = this.f91mT;
            int i6 = i4 + 1;
