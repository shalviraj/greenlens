...
public class StopLogic extends MotionInterpolator {
    ...
    public void debug(String str, String str2, float f) {
        String str3;
        StringBuilder sb;
        StringBuilder y = C0843a.m464y(str2, " ===== ");
        y.append(this.mType);
        ...
        if (this.mNumberOfStages > 1) {
            StringBuilder y2 = C0843a.m464y(str2, " dur ");
            y2.append(this.mStage2Duration);
            y2.append(" vel ");
            y2.append(this.mStage2Velocity);
            y2.append(" pos ");
            y2.append(this.mStage2EndPosition);
            Log.v(str, y2.toString());
        }
        if (this.mNumberOfStages > 2) {
            StringBuilder y3 = C0843a.m464y(str2, " dur ");
            y3.append(this.mStage3Duration);
            y3.append(" vel ");
            y3.append(this.mStage3Velocity);
            y3.append(" pos ");
            y3.append(this.mStage3EndPosition);
            Log.v(str, y3.toString());
        }
        float f2 = this.mStage1Duration;
        if (f <= f2) {
            sb = C0843a.m460u(str2);
            str3 = "stage 0";
        } else {
            int i = this.mNumberOfStages;
            if (i == 1) {
                ...
                if (f3 < f4) {
                    ...
                    int i2 = ((f3 - f4) > this.mStage3Duration ? 1 : ((f3 - f4) == this.mStage3Duration ? 0 : -1));
                    sb = C0843a.m460u(str2);
                    str3 = i2 < 0 ? " stage 2" : " end stage 2";
                }
            }
        }
        sb.append(str3);
