...
public abstract class ConstraintHelper extends View {
    ...
    private int findId(String str) {
        ...
        if (i == 0) {
            try {
                i = C0190R.C0193id.class.getField(str).getInt((Object) null);
            } catch (Exception unused) {
            }
        }
        return i == 0 ? this.myContext.getResources().getIdentifier(str, AnalyticsContext.Device.DEVICE_ID_KEY, this.myContext.getPackageName()) : i;
    }
    ...
    public void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0190R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
