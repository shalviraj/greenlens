...
public class ConstraintAttribute {
    ...
    public static /* synthetic */ class C01881 {
        ...
        public static final /* synthetic */ int[] f115x66adad53;
        ...
        static {
            ...
            L_0x000e:
                r1 = 3
                int[] r4 = f115x66adad53     // Catch:{ NoSuchFieldError -> 0x0015 }
            ...
            L_0x0015:
                int[] r3 = f115x66adad53     // Catch:{ NoSuchFieldError -> 0x001c }
            ...
            L_0x001c:
                r1 = 4
                int[] r3 = f115x66adad53     // Catch:{ NoSuchFieldError -> 0x0023 }
            ...
            L_0x0023:
                r2 = 5
                int[] r3 = f115x66adad53     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                r1 = 6
                int[] r3 = f115x66adad53     // Catch:{ NoSuchFieldError -> 0x0031 }
            ...
            L_0x0031:
                int[] r2 = f115x66adad53     // Catch:{ NoSuchFieldError -> 0x0037 }
            ...
            L_0x0037:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.widget.ConstraintAttribute.C01881.<clinit>():void");
        }
    }
    ...
    public static void parse(Context context, XmlPullParser xmlPullParser, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        float f;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0190R.styleable.CustomAttribute);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == C0190R.styleable.CustomAttribute_attributeName) {
                str = obtainStyledAttributes.getString(index);
                if (str != null && str.length() > 0) {
                    str = Character.toUpperCase(str.charAt(0)) + str.substring(1);
                }
            } else if (index == C0190R.styleable.CustomAttribute_customBoolean) {
                obj = Boolean.valueOf(obtainStyledAttributes.getBoolean(index, false));
                attributeType3 = AttributeType.BOOLEAN_TYPE;
            } else {
                if (index == C0190R.styleable.CustomAttribute_customColorValue) {
                    attributeType = AttributeType.COLOR_TYPE;
                } else if (index == C0190R.styleable.CustomAttribute_customColorDrawableValue) {
                    attributeType = AttributeType.COLOR_DRAWABLE_TYPE;
                } else {
                    if (index == C0190R.styleable.CustomAttribute_customPixelDimension) {
                    ...
                    } else if (index == C0190R.styleable.CustomAttribute_customDimension) {
                        attributeType2 = AttributeType.DIMENSION_TYPE;
                        f = obtainStyledAttributes.getDimension(index, 0.0f);
                    } else if (index == C0190R.styleable.CustomAttribute_customFloatValue) {
                        attributeType2 = AttributeType.FLOAT_TYPE;
                        f = obtainStyledAttributes.getFloat(index, Float.NaN);
                    } else if (index == C0190R.styleable.CustomAttribute_customIntegerValue) {
                        ...
                        obj = obj2;
                    } else if (index == C0190R.styleable.CustomAttribute_customStringValue) {
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        for (String next : hashMap.keySet()) {
            ...
            String l = C0843a.m451l("set", next);
            try {
                switch (constraintAttribute.mType.ordinal()) {
                    case 0:
                        cls.getMethod(l, new Class[]{Integer.TYPE}).invoke(view, new Object[]{Integer.valueOf(constraintAttribute.mIntegerValue)});
                        break;
                    case 1:
                        cls.getMethod(l, new Class[]{Float.TYPE}).invoke(view, new Object[]{Float.valueOf(constraintAttribute.mFloatValue)});
                        break;
                    case 2:
                        cls.getMethod(l, new Class[]{Integer.TYPE}).invoke(view, new Object[]{Integer.valueOf(constraintAttribute.mColorValue)});
                        break;
                    case 3:
                ...
                StringBuilder z = C0843a.m465z(" Custom Attribute \"", next, "\" not found on ");
                z.append(cls.getName());
                Log.e(TAG, z.toString());
                e2.printStackTrace();
            } catch (InvocationTargetException e3) {
                StringBuilder z2 = C0843a.m465z(" Custom Attribute \"", next, "\" not found on ");
    ...
    public void setInterpolatedValue(View view, float[] fArr) {
        ...
        try {
            ...
            StringBuilder z2 = C0843a.m465z("no method ", sb, "on View \"");
            z2.append(Debug.getName(view));
            z2.append("\"");
            Log.e(TAG, z2.toString());
            e.printStackTrace();
        } catch (IllegalAccessException e2) {
            StringBuilder z3 = C0843a.m465z("cannot access method ", sb, "on View \"");
            z3.append(Debug.getName(view));
            z3.append("\"");
            Log.e(TAG, z3.toString());
            e2.printStackTrace();
        } catch (InvocationTargetException e3) {
            e3.printStackTrace();
        }
