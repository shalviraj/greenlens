        ...
        switch (i) {
            case 1:
                if (i3 == 1) {
                    ...
                    throw new IllegalArgumentException(C0843a.m455p(C0843a.m460u("Left to "), sideToString(i3), " undefined"));
                }
            ...
            case 2:
                if (i3 == 1) {
                    ...
                    throw new IllegalArgumentException(C0843a.m455p(C0843a.m460u("right to "), sideToString(i3), " undefined"));
                }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(C0843a.m455p(sb, sideToString(i3), " unknown"));
        }
        return this;
    }
