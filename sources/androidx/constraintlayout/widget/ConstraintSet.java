...
public class ConstraintSet {
    ...
    public static class Layout {
        ...
        static {
            ...
            sparseIntArray.append(C0190R.styleable.Layout_layout_constraintLeft_toLeftOf, 24);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintLeft_toRightOf, 25);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintRight_toLeftOf, 28);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintRight_toRightOf, 29);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintTop_toTopOf, 35);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintTop_toBottomOf, 34);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintBottom_toTopOf, 4);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintBottom_toBottomOf, 3);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintBaseline_toBaselineOf, 1);
            mapToConstant.append(C0190R.styleable.Layout_layout_editor_absoluteX, 6);
            mapToConstant.append(C0190R.styleable.Layout_layout_editor_absoluteY, 7);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintGuide_begin, 17);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintGuide_end, 18);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintGuide_percent, 19);
            mapToConstant.append(C0190R.styleable.Layout_android_orientation, 26);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintStart_toEndOf, 31);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintStart_toStartOf, 32);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintEnd_toStartOf, 10);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintEnd_toEndOf, 9);
            mapToConstant.append(C0190R.styleable.Layout_layout_goneMarginLeft, 13);
            mapToConstant.append(C0190R.styleable.Layout_layout_goneMarginTop, 16);
            mapToConstant.append(C0190R.styleable.Layout_layout_goneMarginRight, 14);
            mapToConstant.append(C0190R.styleable.Layout_layout_goneMarginBottom, 11);
            mapToConstant.append(C0190R.styleable.Layout_layout_goneMarginStart, 15);
            mapToConstant.append(C0190R.styleable.Layout_layout_goneMarginEnd, 12);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintVertical_weight, 38);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintHorizontal_weight, 37);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintHorizontal_chainStyle, 39);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintVertical_chainStyle, 40);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintHorizontal_bias, 20);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintVertical_bias, 36);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintDimensionRatio, 5);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintLeft_creator, 76);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintTop_creator, 76);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintRight_creator, 76);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintBottom_creator, 76);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintBaseline_creator, 76);
            mapToConstant.append(C0190R.styleable.Layout_android_layout_marginLeft, 23);
            mapToConstant.append(C0190R.styleable.Layout_android_layout_marginRight, 27);
            mapToConstant.append(C0190R.styleable.Layout_android_layout_marginStart, 30);
            mapToConstant.append(C0190R.styleable.Layout_android_layout_marginEnd, 8);
            mapToConstant.append(C0190R.styleable.Layout_android_layout_marginTop, 33);
            mapToConstant.append(C0190R.styleable.Layout_android_layout_marginBottom, 2);
            mapToConstant.append(C0190R.styleable.Layout_android_layout_width, 22);
            mapToConstant.append(C0190R.styleable.Layout_android_layout_height, 21);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintCircle, 61);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintCircleRadius, 62);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintCircleAngle, 63);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintWidth_percent, 69);
            mapToConstant.append(C0190R.styleable.Layout_layout_constraintHeight_percent, 70);
            mapToConstant.append(C0190R.styleable.Layout_chainUseRtl, 71);
            mapToConstant.append(C0190R.styleable.Layout_barrierDirection, 72);
            mapToConstant.append(C0190R.styleable.Layout_barrierMargin, 73);
            mapToConstant.append(C0190R.styleable.Layout_constraint_referenced_ids, 74);
            mapToConstant.append(C0190R.styleable.Layout_barrierAllowsGoneWidgets, 75);
        }
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            String str;
            StringBuilder sb;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0190R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Motion {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0190R.styleable.Motion_motionPathRotate, 1);
            mapToConstant.append(C0190R.styleable.Motion_pathMotionArc, 2);
            mapToConstant.append(C0190R.styleable.Motion_transitionEasing, 3);
            mapToConstant.append(C0190R.styleable.Motion_drawPath, 4);
            mapToConstant.append(C0190R.styleable.Motion_animate_relativeTo, 5);
            mapToConstant.append(C0190R.styleable.Motion_motionStagger, 6);
        }
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0190R.styleable.Motion);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0190R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0190R.styleable.PropertySet_android_alpha) {
                    this.alpha = obtainStyledAttributes.getFloat(index, this.alpha);
                } else if (index == C0190R.styleable.PropertySet_android_visibility) {
                    this.visibility = obtainStyledAttributes.getInt(index, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (index == C0190R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = obtainStyledAttributes.getInt(index, this.mVisibilityMode);
                } else if (index == C0190R.styleable.PropertySet_motionProgress) {
    ...
    public static class Transform {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0190R.styleable.Transform_android_rotation, 1);
            mapToConstant.append(C0190R.styleable.Transform_android_rotationX, 2);
            mapToConstant.append(C0190R.styleable.Transform_android_rotationY, 3);
            mapToConstant.append(C0190R.styleable.Transform_android_scaleX, 4);
            mapToConstant.append(C0190R.styleable.Transform_android_scaleY, 5);
            mapToConstant.append(C0190R.styleable.Transform_android_transformPivotX, 6);
            mapToConstant.append(C0190R.styleable.Transform_android_transformPivotY, 7);
            mapToConstant.append(C0190R.styleable.Transform_android_translationX, 8);
            mapToConstant.append(C0190R.styleable.Transform_android_translationY, 9);
            mapToConstant.append(C0190R.styleable.Transform_android_translationZ, 10);
            mapToConstant.append(C0190R.styleable.Transform_android_elevation, 11);
        }
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0190R.styleable.Transform);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    static {
        SparseIntArray sparseIntArray = new SparseIntArray();
        mapToConstant = sparseIntArray;
        sparseIntArray.append(C0190R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintLeft_toRightOf, 26);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintRight_toLeftOf, 29);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintRight_toRightOf, 30);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintTop_toTopOf, 36);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintTop_toBottomOf, 35);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintBottom_toTopOf, 4);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintBottom_toBottomOf, 3);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintBaseline_toBaselineOf, 1);
        mapToConstant.append(C0190R.styleable.Constraint_layout_editor_absoluteX, 6);
        mapToConstant.append(C0190R.styleable.Constraint_layout_editor_absoluteY, 7);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintGuide_begin, 17);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintGuide_end, 18);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintGuide_percent, 19);
        mapToConstant.append(C0190R.styleable.Constraint_android_orientation, 27);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintStart_toEndOf, 32);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintStart_toStartOf, 33);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintEnd_toStartOf, 10);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintEnd_toEndOf, 9);
        mapToConstant.append(C0190R.styleable.Constraint_layout_goneMarginLeft, 13);
        mapToConstant.append(C0190R.styleable.Constraint_layout_goneMarginTop, 16);
        mapToConstant.append(C0190R.styleable.Constraint_layout_goneMarginRight, 14);
        mapToConstant.append(C0190R.styleable.Constraint_layout_goneMarginBottom, 11);
        mapToConstant.append(C0190R.styleable.Constraint_layout_goneMarginStart, 15);
        mapToConstant.append(C0190R.styleable.Constraint_layout_goneMarginEnd, 12);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintVertical_weight, 40);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintHorizontal_weight, 39);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintHorizontal_chainStyle, 41);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintVertical_chainStyle, 42);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintHorizontal_bias, 20);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintVertical_bias, 37);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintDimensionRatio, 5);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintLeft_creator, 82);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintTop_creator, 82);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintRight_creator, 82);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintBottom_creator, 82);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintBaseline_creator, 82);
        mapToConstant.append(C0190R.styleable.Constraint_android_layout_marginLeft, 24);
        mapToConstant.append(C0190R.styleable.Constraint_android_layout_marginRight, 28);
        mapToConstant.append(C0190R.styleable.Constraint_android_layout_marginStart, 31);
        mapToConstant.append(C0190R.styleable.Constraint_android_layout_marginEnd, 8);
        mapToConstant.append(C0190R.styleable.Constraint_android_layout_marginTop, 34);
        mapToConstant.append(C0190R.styleable.Constraint_android_layout_marginBottom, 2);
        mapToConstant.append(C0190R.styleable.Constraint_android_layout_width, 23);
        mapToConstant.append(C0190R.styleable.Constraint_android_layout_height, 21);
        mapToConstant.append(C0190R.styleable.Constraint_android_visibility, 22);
        mapToConstant.append(C0190R.styleable.Constraint_android_alpha, 43);
        mapToConstant.append(C0190R.styleable.Constraint_android_elevation, 44);
        mapToConstant.append(C0190R.styleable.Constraint_android_rotationX, 45);
        mapToConstant.append(C0190R.styleable.Constraint_android_rotationY, 46);
        mapToConstant.append(C0190R.styleable.Constraint_android_rotation, 60);
        mapToConstant.append(C0190R.styleable.Constraint_android_scaleX, 47);
        mapToConstant.append(C0190R.styleable.Constraint_android_scaleY, 48);
        mapToConstant.append(C0190R.styleable.Constraint_android_transformPivotX, 49);
        mapToConstant.append(C0190R.styleable.Constraint_android_transformPivotY, 50);
        mapToConstant.append(C0190R.styleable.Constraint_android_translationX, 51);
        mapToConstant.append(C0190R.styleable.Constraint_android_translationY, 52);
        mapToConstant.append(C0190R.styleable.Constraint_android_translationZ, 53);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintWidth_default, 54);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintHeight_default, 55);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintWidth_max, 56);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintHeight_max, 57);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintWidth_min, 58);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintHeight_min, 59);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintCircle, 61);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintCircleRadius, 62);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0190R.styleable.Constraint_animate_relativeTo, 64);
        mapToConstant.append(C0190R.styleable.Constraint_transitionEasing, 65);
        mapToConstant.append(C0190R.styleable.Constraint_drawPath, 66);
        mapToConstant.append(C0190R.styleable.Constraint_transitionPathRotate, 67);
        mapToConstant.append(C0190R.styleable.Constraint_motionStagger, 79);
        mapToConstant.append(C0190R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C0190R.styleable.Constraint_motionProgress, 68);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0190R.styleable.Constraint_chainUseRtl, 71);
        mapToConstant.append(C0190R.styleable.Constraint_barrierDirection, 72);
        mapToConstant.append(C0190R.styleable.Constraint_barrierMargin, 73);
        mapToConstant.append(C0190R.styleable.Constraint_constraint_referenced_ids, 74);
        mapToConstant.append(C0190R.styleable.Constraint_barrierAllowsGoneWidgets, 75);
        mapToConstant.append(C0190R.styleable.Constraint_pathMotionArc, 76);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constraintTag, 77);
        mapToConstant.append(C0190R.styleable.Constraint_visibilityMode, 78);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constrainedWidth, 80);
        mapToConstant.append(C0190R.styleable.Constraint_layout_constrainedHeight, 81);
    }
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0190R.C0193id.class.getField(trim).getInt((Object) null);
            } catch (Exception unused) {
                i = 0;
            }
            if (i == 0) {
                i = context.getResources().getIdentifier(trim, AnalyticsContext.Device.DEVICE_ID_KEY, context.getPackageName());
            }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0190R.styleable.Constraint);
    ...
    private void populateConstraint(Context context, Constraint constraint, TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (!(index == C0190R.styleable.Constraint_android_id || C0190R.styleable.Constraint_android_layout_marginStart == index || C0190R.styleable.Constraint_android_layout_marginEnd == index)) {
    ...
    public void applyCustomAttributes(ConstraintLayout constraintLayout) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                StringBuilder u = C0843a.m460u("id unknown ");
        ...
        switch (i2) {
            case 1:
                if (i4 == 1) {
                    ...
                    throw new IllegalArgumentException(C0843a.m455p(C0843a.m460u("left to "), sideToString(i4), " undefined"));
                }
            case 2:
                if (i4 == 1) {
                    Layout layout4 = constraint.layout;
                    ...
                    throw new IllegalArgumentException(C0843a.m455p(C0843a.m460u("right to "), sideToString(i4), " undefined"));
                }
            case 3:
                if (i4 == 3) {
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(C0843a.m455p(sb, sideToString(i4), " unknown"));
        }
    ...
    public void parseColorAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < split.length; i++) {
            ...
            if (split2.length != 2) {
                StringBuilder u = C0843a.m460u(" Unable to parse ");
                u.append(split[i]);
                Log.w(TAG, u.toString());
            } else {
