...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void addToHashMap(SolverVariable solverVariable, int i) {
        int[] iArr;
        int i2 = solverVariable.f99id % this.HASH_SIZE;
        int[] iArr2 = this.keys;
        int i3 = iArr2[i2];
        if (i3 == -1) {
            iArr2[i2] = i;
    ...
    private void addVariable(int i, SolverVariable solverVariable, float f) {
        this.variables[i] = solverVariable.f99id;
        this.values[i] = f;
        this.previous[i] = -1;
        this.next[i] = -1;
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                String l = C0843a.m451l(str3, "[p: ");
                if (this.previous[indexOf] != -1) {
                    sb = C0843a.m460u(l);
                    sb.append(this.mCache.mIndexedVariables[this.variables[this.previous[indexOf]]]);
                } else {
                    sb = C0843a.m464y(l, "none");
                }
                String l2 = C0843a.m451l(sb.toString(), ", n: ");
                if (this.next[indexOf] != -1) {
                    StringBuilder u = C0843a.m460u(l2);
                    u.append(this.mCache.mIndexedVariables[this.variables[this.next[indexOf]]]);
                    str = u.toString();
                } else {
                    str = C0843a.m451l(l2, "none");
                }
                str2 = C0843a.m451l(str, "]");
            }
        }
        return C0843a.m451l(str2, " }");
    }
