...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f, boolean z) {
        ...
        if (f <= (-f2) || f >= f2) {
            ...
            this.mArrayIndices[i7] = solverVariable.f99id;
    ...
    public String toString() {
        ...
        int i2 = 0;
        while (i != -1 && i2 < this.currentSize) {
            StringBuilder u = C0843a.m460u(C0843a.m451l(str, " -> "));
            u.append(this.mArrayValues[i]);
            u.append(" : ");
            StringBuilder u2 = C0843a.m460u(u.toString());
            u2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
            str = u2.toString();
            i = this.mArrayNextIndices[i];
            i2++;
        }
