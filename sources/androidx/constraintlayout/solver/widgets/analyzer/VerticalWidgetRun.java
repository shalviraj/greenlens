...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public static /* synthetic */ class C01821 {
        ...
        public static final /* synthetic */ int[] f111xbf6f0c8e;
        ...
        static {
            ...
            L_0x000d:
                int[] r0 = f111xbf6f0c8e     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f111xbf6f0c8e     // Catch:{ NoSuchFieldError -> 0x001b }
            ...
            L_0x001b:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.widgets.analyzer.VerticalWidgetRun.C01821.<clinit>():void");
        }
    }
    ...
    public String toString() {
        StringBuilder u = C0843a.m460u("VerticalRun ");
        u.append(this.widget.getDebugName());
        return u.toString();
    }
    ...
    public void update(Dependency dependency) {
        ...
        if (dimensionDependency.readyToSolve && !dimensionDependency.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i2 == 2) {
                ...
                i = (int) ((((float) constraintWidget4.horizontalRun.dimension.value) / constraintWidget4.getDimensionRatio()) + 0.5f);
                this.dimension.resolve(i);
            }
            i = (int) ((f * f2) + 0.5f);
            this.dimension.resolve(i);
