...
public class Barrier extends HelperWidget {
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (i6 >= 0 && i6 < 4) {
            ...
            if (this.resolved) {
                ...
                if (i7 == 0 || i7 == 1) {
                    linearSystem.addEquality(this.mLeft.mSolverVariable, this.f103mX);
                    solverVariable2 = this.mRight.mSolverVariable;
                    i4 = this.f103mX;
                } else if (i7 == 2 || i7 == 3) {
                    linearSystem.addEquality(this.mTop.mSolverVariable, this.f104mY);
    ...
    public String toString() {
        StringBuilder u = C0843a.m460u("[Barrier] ");
        u.append(getDebugName());
        u.append(" {");
