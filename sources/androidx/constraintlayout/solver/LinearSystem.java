...
public class LinearSystem {
    ...
    private void displayRows() {
        ...
        while (true) {
            ...
            if (i < i2) {
                u.append(this.mRows[i]);
                str = C0843a.m451l(u.toString(), "\n");
                i++;
            } else {
                u.append(this.mGoal);
                u.append("\n");
    ...
    private void displaySolverVariables() {
        StringBuilder u = C0843a.m460u("Display Rows (");
        u.append(this.mNumRows);
        u.append("x");
        System.out.println(C0843a.m453n(u, this.mNumColumns, ")\n"));
    }
    ...
    private String getDisplaySize(int i) {
        ...
        int i3 = i2 / 1024;
        int i4 = i3 / 1024;
        return i4 > 0 ? C0843a.m445f("", i4, " Mb") : i3 > 0 ? C0843a.m445f("", i3, " Kb") : C0843a.m445f("", i2, " bytes");
    }
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        ...
        for (int i3 = 0; i3 < this.mVariablesID + 1; i3++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym && solverVariable2.synonym == solverVariable.f99id) {
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        acquireSolverVariable.f99id = i2;
    ...
    public void displayReadableRows() {
        displaySolverVariables();
        String n = C0843a.m453n(C0843a.m460u(" num vars "), this.mVariablesID, "\n");
        for (int i = 0; i < this.mVariablesID + 1; i++) {
            SolverVariable solverVariable = this.mCache.mIndexedVariables[i];
            if (solverVariable != null && solverVariable.isFinalValue) {
                n = n + " $[" + i + "] => " + solverVariable + " = " + solverVariable.computedValue + "\n";
            }
        }
        String l = C0843a.m451l(n, "\n");
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                l = l + " ~[" + i2 + "] => " + solverVariable2 + " = " + solverVariableArr[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + "\n";
            }
        }
        String l2 = C0843a.m451l(l, "\n\n #  ");
        for (int i3 = 0; i3 < this.mNumRows; i3++) {
            StringBuilder u = C0843a.m460u(l2);
            u.append(this.mRows[i3].toReadableString());
            l2 = C0843a.m451l(u.toString(), "\n #  ");
        }
        if (this.mGoal != null) {
            StringBuilder y = C0843a.m464y(l2, "Goal: ");
            y.append(this.mGoal);
            y.append("\n");
            l2 = y.toString();
        }
    ...
    public void displaySystemInformations() {
        ...
        StringBuilder u = C0843a.m460u("Linear System -> Table size: ");
        u.append(this.TABLE_SIZE);
        u.append(" (");
        int i5 = this.TABLE_SIZE;
        u.append(getDisplaySize(i5 * i5));
        u.append(") -- row sizes: ");
        u.append(getDisplaySize(i));
        u.append(", actual size: ");
        u.append(getDisplaySize(i3));
        u.append(" rows: ");
        u.append(this.mNumRows);
        u.append("/");
        u.append(this.mMaxRows);
        u.append(" cols: ");
        u.append(this.mNumColumns);
        u.append("/");
        u.append(this.mMaxColumns);
        u.append(" ");
        u.append(0);
        u.append(" occupied cells, ");
        u.append(getDisplaySize(0));
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            if (this.mRows[i].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                StringBuilder u = C0843a.m460u(str);
                u.append(this.mRows[i].toReadableString());
                str = C0843a.m451l(u.toString(), "\n");
            }
        }
        StringBuilder u2 = C0843a.m460u(str);
        u2.append(this.mGoal);
        u2.append("\n");
