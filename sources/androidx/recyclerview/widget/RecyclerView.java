...
import androidx.recyclerview.C0413R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static /* synthetic */ class C04587 {

        /* renamed from: $SwitchMap$androidx$recyclerview$widget$RecyclerView$Adapter$StateRestorationPolicy */
        public static final /* synthetic */ int[] f134x3d106619;

        /* JADX WARNING: Failed to process nested try/catch */
        /* JADX WARNING: Missing exception handler attribute for start block: B:3:0x000e */
        static {
            /*
                androidx.recyclerview.widget.RecyclerView.Adapter.StateRestorationPolicy.values()
                r0 = 3
                int[] r0 = new int[r0]
                f134x3d106619 = r0
                r1 = 1
                r2 = 2
                androidx.recyclerview.widget.RecyclerView$Adapter$StateRestorationPolicy r3 = androidx.recyclerview.widget.RecyclerView.Adapter.StateRestorationPolicy.PREVENT     // Catch:{ NoSuchFieldError -> 0x000e }
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x000e }
            L_0x000e:
                int[] r0 = f134x3d106619     // Catch:{ NoSuchFieldError -> 0x0014 }
                androidx.recyclerview.widget.RecyclerView$Adapter$StateRestorationPolicy r3 = androidx.recyclerview.widget.RecyclerView.Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY     // Catch:{ NoSuchFieldError -> 0x0014 }
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.C04587.<clinit>():void");
        }
    }
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (indexOfChild == -1) {
                    StringBuilder u = C0843a.m460u("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
                    u.append(this.mRecyclerView.indexOfChild(view));
                    throw new IllegalStateException(C0843a.m443d(this.mRecyclerView, u));
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0413R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0413R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0413R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0413R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0413R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(C0843a.m443d(this.mRecyclerView, C0843a.m460u("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
        ...
        public void offsetChildrenHorizontal(@C0033Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@C0033Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@androidx.annotation.NonNull android.view.View r7, int r8) {
            ...
            L_0x005e:
                ...
                java.lang.StringBuilder r8 = p005b.p035e.p036a.p037a.C0843a.m463x(r0, r8, r1, r2, r3)
                androidx.recyclerview.widget.RecyclerView r0 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.RecyclerView$State r0 = r0.mState
                int r0 = r0.getItemCount()
                r8.append(r0)
                androidx.recyclerview.widget.RecyclerView r0 = androidx.recyclerview.widget.RecyclerView.this
                java.lang.String r8 = p005b.p035e.p036a.p037a.C0843a.m443d(r0, r8)
                r7.<init>(r8)
                throw r7
            L_0x007f:
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            StringBuilder v = C0843a.m461v("invalid position ", i, ". State item count is ");
            v.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(C0843a.m443d(RecyclerView.this, v));
        }
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            throw new IllegalStateException(C0843a.m443d(RecyclerView.this, sb));
        }
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                StringBuilder u = C0843a.m460u("Scrapped or attached views may not be recycled. isScrap:");
                u.append(viewHolder.isScrap());
                u.append(" isAttached:");
                if (viewHolder.itemView.getParent() != null) {
                    z3 = true;
                }
                u.append(z3);
                throw new IllegalArgumentException(C0843a.m443d(RecyclerView.this, u));
                ...
                throw new IllegalArgumentException(C0843a.m443d(RecyclerView.this, sb));
                ...
                throw new IllegalArgumentException(C0843a.m443d(RecyclerView.this, C0843a.m460u("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        }
        ...
        public void scrapView(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                ...
                throw new IllegalArgumentException(C0843a.m443d(RecyclerView.this, C0843a.m460u("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        ...
        public androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            ...
            L_0x00b1:
                ...
                java.lang.String r1 = p005b.p035e.p036a.p037a.C0843a.m443d(r2, r1)
                r0.<init>(r1)
                throw r0
            L_0x00c3:
                java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException
            ...
            L_0x0133:
                ...
                java.lang.StringBuilder r1 = p005b.p035e.p036a.p037a.C0843a.m463x(r1, r3, r2, r5, r4)
                androidx.recyclerview.widget.RecyclerView r2 = androidx.recyclerview.widget.RecyclerView.this
            ...
            L_0x01fb:
                ...
                java.lang.StringBuilder r1 = p005b.p035e.p036a.p037a.C0843a.m463x(r1, r3, r2, r3, r4)
                androidx.recyclerview.widget.RecyclerView r2 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.RecyclerView$State r2 = r2.mState
                int r2 = r2.getItemCount()
                r1.append(r2)
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder viewHolder) {
            ...
            if (i < 0 || i >= RecyclerView.this.mAdapter.getItemCount()) {
                ...
                sb.append(viewHolder);
                throw new IndexOutOfBoundsException(C0843a.m443d(RecyclerView.this, sb));
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@C0033Px int i, @C0033Px int i2) {
                this(i, i2, Integer.MIN_VALUE, (Interpolator) null);
            }

            public Action(@C0033Px int i, @C0033Px int i2, int i3) {
                this(i, i2, i3, (Interpolator) null);
            }

            public Action(@C0033Px int i, @C0033Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@C0033Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }

            public void setDy(@C0033Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0033Px int i, @C0033Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
        ...
        public PointF computeScrollVectorForPosition(int i) {
            ...
            StringBuilder u = C0843a.m460u("You should override computeScrollVectorForPosition when the LayoutManager does not implement ");
            u.append(ScrollVectorProvider.class.getCanonicalName());
            Log.w(RecyclerView.TAG, u.toString());
            return null;
        }
        ...
        public abstract void onSeekTargetStep(@C0033Px int i, @C0033Px int i2, @NonNull State state, @NonNull Action action);
        ...
        public void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            ...
            if (this.mStarted) {
                StringBuilder u = C0843a.m460u("An instance of ");
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i) {
            if ((this.mLayoutStep & i) == 0) {
                StringBuilder u = C0843a.m460u("Layout state should be one of ");
                u.append(Integer.toBinaryString(i));
                u.append(" but it is ");
                u.append(Integer.toBinaryString(this.mLayoutStep));
        ...
        public String toString() {
            StringBuilder u = C0843a.m460u("State{mTargetPosition=");
            u.append(this.mTargetPosition);
            u.append(", mData=");
            u.append(this.mData);
            u.append(", mItemCount=");
            u.append(this.mItemCount);
            u.append(", mIsMeasuring=");
            u.append(this.mIsMeasuring);
            u.append(", mPreviousLayoutItemCount=");
            u.append(this.mPreviousLayoutItemCount);
            u.append(", mDeletedInvisibleItemCountSincePreviousLayout=");
            u.append(this.mDeletedInvisibleItemCountSincePreviousLayout);
            u.append(", mStructureChanged=");
            u.append(this.mStructureChanged);
            u.append(", mInPreLayout=");
            u.append(this.mInPreLayout);
            u.append(", mRunSimpleAnimations=");
            u.append(this.mRunSimpleAnimations);
            u.append(", mRunPredictiveAnimations=");
            u.append(this.mRunPredictiveAnimations);
            u.append('}');
            return u.toString();
        }
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder y = C0843a.m464y(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            ...
            if (!isRecyclable()) {
                StringBuilder u = C0843a.m460u(" not recyclable(");
                u.append(this.mIsRecyclableCount);
                u.append(")");
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0413R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0413R.styleable.RecyclerView;
        ...
        String string = obtainStyledAttributes.getString(C0413R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C0413R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C0413R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = obtainStyledAttributes.getBoolean(C0413R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0413R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0413R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0413R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0413R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        obtainStyledAttributes.recycle();
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(C0843a.m443d(this, sb));
                }
                ...
                throw new IllegalStateException(C0843a.m443d(this, sb2));
            }
        }
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i) {
        ...
        sb.append(i);
        throw new IllegalArgumentException(C0843a.m443d(this, sb));
    }
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            throw new IllegalStateException(C0843a.m443d(this, C0843a.m460u("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
        }
        throw new IllegalStateException(C0843a.m443d(this, C0843a.m460u(str)));
    }

    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(C0843a.m443d(this, C0843a.m460u("Cannot call this method while RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(str);
        } else if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(C0843a.m443d(this, C0843a.m460u(""))));
        }
    }
    ...
    public String exceptionLabel() {
        ...
        u.append(", adapter:");
        u.append(this.mAdapter);
        u.append(", layout:");
        u.append(this.mLayout);
        u.append(", context:");
        u.append(getContext());
        return u.toString();
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(C0843a.m443d(this, C0843a.m460u("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(C0843a.m443d(this, C0843a.m460u("Trying to set fast scroller without both required drawables.")));
        }
        Resources resources = getContext().getResources();
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0413R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0413R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0413R.dimen.fastscroll_margin));
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                StringBuilder u = C0843a.m460u("Error processing scroll; pointer index for id ");
                u.append(this.mScrollPointerId);
    ...
    public void onScrolled(@C0033Px int i, @C0033Px int i2) {
    }
        ...
        if (layoutManager != this.mLayout) {
            ...
            if (layoutManager != null) {
                if (layoutManager.mRecyclerView == null) {
                    ...
                    throw new IllegalArgumentException(C0843a.m443d(layoutManager.mRecyclerView, sb));
                }
            }
            this.mRecycler.updateViewCacheSize();
            requestLayout();
    ...
    public void smoothScrollBy(@C0033Px int i, @C0033Px int i2) {
        smoothScrollBy(i, i2, (Interpolator) null);
    }

    public void smoothScrollBy(@C0033Px int i, @C0033Px int i2, @Nullable Interpolator interpolator) {
        smoothScrollBy(i, i2, interpolator, Integer.MIN_VALUE);
    }

    public void smoothScrollBy(@C0033Px int i, @C0033Px int i2, @Nullable Interpolator interpolator, int i3) {
        smoothScrollBy(i, i2, interpolator, i3, false);
    }

    public void smoothScrollBy(@C0033Px int i, @C0033Px int i2, @Nullable Interpolator interpolator, int i3, boolean z) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
