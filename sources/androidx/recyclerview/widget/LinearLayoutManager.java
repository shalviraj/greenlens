...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public String toString() {
            ...
            u.append(this.mCoordinate);
            u.append(", mLayoutFromEnd=");
            u.append(this.mLayoutFromEnd);
            u.append(", mValid=");
            u.append(this.mValid);
            u.append('}');
            return u.toString();
        }
    }
    ...
    public static class LayoutState {
        ...
        public void log() {
            StringBuilder u = C0843a.m460u("avail:");
    ...
    private void logChildren() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            StringBuilder u = C0843a.m460u("item ");
            u.append(getPosition(childAt));
            u.append(", coord:");
            u.append(this.mOrientationHelper.getDecoratedStart(childAt));
            Log.d(TAG, u.toString());
        }
        Log.d(TAG, "==============");
    }
    ...
    public void validateChildOrder() {
        StringBuilder u = C0843a.m460u("validating child count ");
        ...
        if (getChildCount() >= 1) {
            ...
            if (this.mShouldReverseLayout) {
                ...
                while (i < getChildCount()) {
                    ...
                    if (position2 < position) {
                        logChildren();
                        StringBuilder u2 = C0843a.m460u("detected invalid position. loc invalid? ");
            ...
            while (i2 < getChildCount()) {
                ...
                if (position3 < position) {
                    logChildren();
                    StringBuilder u3 = C0843a.m460u("detected invalid position. loc invalid? ");
