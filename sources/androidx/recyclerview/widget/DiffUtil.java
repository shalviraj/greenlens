...
public class DiffUtil {
    private static final Comparator<Diagonal> DIAGONAL_COMPARATOR = new Comparator<Diagonal>() {
        public int compare(Diagonal diagonal, Diagonal diagonal2) {
            return diagonal.f129x - diagonal2.f129x;
        }
    };
    ...
    public static class Diagonal {
        ...
        public int endX() {
            return this.f129x + this.size;
        }

        public int endY() {
            return this.f130y + this.size;
        }
    }
    ...
    public static class DiffResult {
        ...
        private void addEdgeDiagonals() {
            ...
            if (!(diagonal != null && diagonal.f129x == 0 && diagonal.f130y == 0)) {
        ...
        public int convertNewPositionToOld(@IntRange(from = 0) int i) {
            if (i < 0 || i >= this.mNewListSize) {
                StringBuilder v = C0843a.m461v("Index out of bounds - passed position = ", i, ", new list size = ");
                v.append(this.mNewListSize);
        ...
        public int convertOldPositionToNew(@IntRange(from = 0) int i) {
            if (i < 0 || i >= this.mOldListSize) {
                StringBuilder v = C0843a.m461v("Index out of bounds - passed position = ", i, ", old list size = ");
                v.append(this.mOldListSize);
                throw new IndexOutOfBoundsException(v.toString());
            }
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mDiagonals.size() - 1; size >= 0; size--) {
                ...
                int i10 = diagonal.f129x;
                int i11 = diagonal.f130y;
    ...
    private static Snake forward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        while (i6 <= i) {
            ...
            int i7 = ((i2 - range.oldListStart) + range.newListStart) - i6;
            int i8 = (i == 0 || i2 != i3) ? i7 : i7 - 1;
