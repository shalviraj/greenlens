...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                StringBuilder u = C0843a.m460u("FullSpanItem{mPosition=");
                u.append(this.mPosition);
                u.append(", mGapDir=");
                u.append(this.mGapDir);
                u.append(", mHasUnwantedGapAfter=");
                u.append(this.mHasUnwantedGapAfter);
                u.append(", mGapPerSpan=");
                u.append(Arrays.toString(this.mGapPerSpan));
                u.append('}');
                return u.toString();
            }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        int i7 = this.mLayoutState.mInfinite ? layoutState2.mLayoutDirection == 1 ? ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : Integer.MIN_VALUE : layoutState2.mLayoutDirection == 1 ? layoutState2.mEndLine + layoutState2.mAvailable : layoutState2.mStartLine - layoutState2.mAvailable;
        updateAllRemainingSpans(layoutState2.mLayoutDirection, i7);
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutParams.mFullSpan) {
                ...
                updateRemainingSpans(span3, this.mLayoutState.mLayoutDirection, i7);
            }
        ...
        return startAfterPadding2 > 0 ? Math.min(layoutState2.mAvailable, startAfterPadding2) : i8;
    }
    ...
    public int[] findFirstCompletelyVisibleItemPositions(int[] iArr) {
        if (iArr == null) {
            ...
            StringBuilder u = C0843a.m460u("Provided int[]'s size must be more than or equal to span count. Expected:");
            u.append(this.mSpanCount);
            u.append(", array size:");
