...
public class AsyncListUtil<T> {
    ...
    public AsyncListUtil(@NonNull Class<T> cls, int i, @NonNull DataCallback<T> dataCallback, @NonNull ViewCallback viewCallback) {
        C04201 r0 = new ThreadUtil.MainThreadCallback<T>() {
            ...
            public void addTile(int i, TileList.Tile<T> tile) {
                ...
                if (addOrReplace != null) {
                    StringBuilder u = C0843a.m460u("duplicate tile @");
                    u.append(addOrReplace.mStartPosition);
                    Log.e(AsyncListUtil.TAG, u.toString());
        ...
        C04212 r1 = new ThreadUtil.BackgroundCallback<T>() {
            ...
            private void log(String str, Object... objArr) {
                StringBuilder u = C0843a.m460u("[BKGR] ");
                u.append(String.format(str, objArr));
                Log.d(AsyncListUtil.TAG, u.toString());
            }
    ...
    public void log(String str, Object... objArr) {
        StringBuilder u = C0843a.m460u("[MAIN] ");
        u.append(String.format(str, objArr));
