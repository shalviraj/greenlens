...
public final class CustomTabsSession {
    ...
    private final C6926a mCallback;
    private final ComponentName mComponentName;
    private final Object mLock = new Object();
    private final C6929b mService;

    public CustomTabsSession(C6929b bVar, C6926a aVar, ComponentName componentName) {
        this.mService = bVar;
        this.mCallback = aVar;
    ...
    public static CustomTabsSession createMockSessionForTesting(@NonNull ComponentName componentName) {
        return new CustomTabsSession((C6929b) null, new CustomTabsSessionToken.MockCallback(), componentName);
    }
