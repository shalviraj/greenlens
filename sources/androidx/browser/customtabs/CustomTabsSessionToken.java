...
public class CustomTabsSessionToken {
    ...
    public final C6926a mCallbackBinder;

    public static class MockCallback extends C6926a.C6927a {
    ...
    public CustomTabsSessionToken(C6926a aVar) {
    ...
    public static CustomTabsSessionToken getSessionTokenFromIntent(Intent intent) {
        ...
        return new CustomTabsSessionToken(C6926a.C6927a.asInterface(binder));
    }
