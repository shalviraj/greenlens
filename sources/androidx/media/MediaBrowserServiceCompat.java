...
public abstract class MediaBrowserServiceCompat extends Service {
        ...
        public void setSessionToken(final MediaSessionCompat.Token token) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    MediaBrowserServiceCompatApi21.setSessionToken(MediaBrowserServiceImplApi21.this.mServiceObj, token.f45g);
                }
            });
        }
    }
                ...
                public void run() {
                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            ...
                            StringBuilder u = C0843a.m460u("Connection for ");
                            u.append(next.pkg);
                            u.append(" is no longer valid.");
    ...
    public static class Result<T> {
        ...
        public void detach() {
            if (this.mDetachCalled) {
                StringBuilder u = C0843a.m460u("detach() called when detach() had already been called for: ");
                u.append(this.mDebug);
                throw new IllegalStateException(u.toString());
            } else if (this.mSendResultCalled) {
                StringBuilder u2 = C0843a.m460u("detach() called when sendResult() had already been called for: ");
                u2.append(this.mDebug);
                throw new IllegalStateException(u2.toString());
            } else if (!this.mSendErrorCalled) {
                this.mDetachCalled = true;
            } else {
                StringBuilder u3 = C0843a.m460u("detach() called when sendError() had already been called for: ");
                u3.append(this.mDebug);
        ...
        public void onErrorSent(Bundle bundle) {
            StringBuilder u = C0843a.m460u("It is not supported to send an error for ");
            u.append(this.mDebug);
            throw new UnsupportedOperationException(u.toString());
        }

        public void onProgressUpdateSent(Bundle bundle) {
            StringBuilder u = C0843a.m460u("It is not supported to send an interim update for ");
            u.append(this.mDebug);
            throw new UnsupportedOperationException(u.toString());
        }
        ...
        public void sendError(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder u = C0843a.m460u("sendError() called when either sendResult() or sendError() had already been called for: ");
                u.append(this.mDebug);
                throw new IllegalStateException(u.toString());
            }
        ...
        public void sendProgressUpdate(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder u = C0843a.m460u("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ");
                u.append(this.mDebug);
                throw new IllegalStateException(u.toString());
            }
        ...
        public void sendResult(T t) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder u = C0843a.m460u("sendResult() called when either sendResult() or sendError() had already been called for: ");
                u.append(this.mDebug);
                throw new IllegalStateException(u.toString());
            }
    ...
    public class ServiceBinderImpl {
        ...
        public void addSubscription(String str, IBinder iBinder, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        StringBuilder u = C0843a.m460u("addSubscription for callback that isn't registered id=");
                        u.append(str2);
                        Log.w(MediaBrowserServiceCompat.TAG, u.toString());
                        return;
                    }
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i2)) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ...
                        if (onGetRoot == null) {
                            StringBuilder u = C0843a.m460u("No root for client ");
                            u.append(str2);
                            ...
                            try {
                                ...
                                StringBuilder u2 = C0843a.m460u("Calling onConnectFailed() failed. Ignoring. pkg=");
                                u2.append(str2);
                            ...
                            try {
                                ...
                                StringBuilder u3 = C0843a.m460u("Calling onConnect() failed. Dropping client. pkg=");
                                u3.append(str2);
        ...
        public void getMediaItem(final String str, final C6959b bVar, final ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && bVar != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                        if (connectionRecord == null) {
                            StringBuilder u = C0843a.m460u("getMediaItem for callback that isn't registered id=");
                            u.append(str);
                            Log.w(MediaBrowserServiceCompat.TAG, u.toString());
                            return;
                        }
        ...
        public void removeSubscription(final String str, final IBinder iBinder, final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                    if (connectionRecord == null) {
                        StringBuilder u = C0843a.m460u("removeSubscription for callback that isn't registered id=");
                        u.append(str);
                        Log.w(MediaBrowserServiceCompat.TAG, u.toString());
                    } else if (!MediaBrowserServiceCompat.this.removeSubscription(str, connectionRecord, iBinder)) {
                        StringBuilder u2 = C0843a.m460u("removeSubscription called for ");
                        u2.append(str);
        ...
        public void search(String str, Bundle bundle, C6959b bVar, ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && bVar != null) {
                final ServiceCallbacks serviceCallbacks2 = serviceCallbacks;
                final String str2 = str;
                final Bundle bundle2 = bundle;
                final C6959b bVar2 = bVar;
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
                        if (connectionRecord == null) {
                            StringBuilder u = C0843a.m460u("search for callback that isn't registered query=");
                            u.append(str2);
                            Log.w(MediaBrowserServiceCompat.TAG, u.toString());
                            return;
                        }
        ...
        public void sendCustomAction(String str, Bundle bundle, C6959b bVar, ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && bVar != null) {
                final ServiceCallbacks serviceCallbacks2 = serviceCallbacks;
                final String str2 = str;
                final Bundle bundle2 = bundle;
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
                        if (connectionRecord == null) {
                            StringBuilder u = C0843a.m460u("sendCustomAction for callback that isn't registered action=");
                            u.append(str2);
                            u.append(", extras=");
                            u.append(bundle2);
                            Log.w(MediaBrowserServiceCompat.TAG, u.toString());
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 4:
                    ...
                    return;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (C6959b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 6:
                ...
                case 8:
                    ...
                    MediaSessionCompat.m27a(bundle4);
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), bundle4, (C6959b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 9:
                    Bundle bundle5 = data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS);
                    MediaSessionCompat.m27a(bundle5);
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), bundle5, (C6959b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                default:
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final C6959b bVar) {
        C03834 r0 = new Result<Bundle>(str) {
            public void onErrorSent(Bundle bundle) {
                bVar.mo24342b(-1, bundle);
            }
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle, Bundle bundle2) {
        ...
        C03801 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                if (MediaBrowserServiceCompat.this.mConnections.get(connectionRecord2.callbacks.asBinder()) == connectionRecord2) {
                    ...
                    try {
                        ...
                        StringBuilder u = C0843a.m460u("Calling onLoadChildren() failed for id=");
                        u.append(str2);
                        u.append(" package=");
                        u.append(connectionRecord2.pkg);
                        Log.w(MediaBrowserServiceCompat.TAG, u.toString());
                    }
                } else if (MediaBrowserServiceCompat.DEBUG) {
                    StringBuilder u2 = C0843a.m460u("Not sending onLoadChildren result for connection that has been disconnected. pkg=");
                    u2.append(connectionRecord2.pkg);
                    u2.append(" id=");
                    u2.append(str2);
                    Log.d(MediaBrowserServiceCompat.TAG, u2.toString());
                }
            }
        };
        this.mCurConnection = connectionRecord;
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(C0843a.m456q(C0843a.m460u("onLoadChildren must call detach() or sendResult() before returning for package="), connectionRecord.pkg, " id=", str));
        }
    }

    public void performLoadItem(String str, ConnectionRecord connectionRecord, final C6959b bVar) {
        C03812 r0 = new Result<MediaBrowserCompat.MediaItem>(str) {
            public void onResultSent(MediaBrowserCompat.MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
                    bVar.mo24342b(-1, (Bundle) null);
                    return;
                }
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(C0843a.m451l("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }

    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final C6959b bVar) {
        C03823 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(C0843a.m451l("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }
