...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                u.append(pathDataNodeArr[i].mType);
                u.append(":");
                str = u.toString();
        ...
        public void printVPath(int i) {
            ...
            StringBuilder y = C0843a.m464y(str, "current path is :");
            y.append(this.mPathName);
            y.append(" pathData is ");
            y.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, y.toString());
        }
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder y = C0843a.m464y(str, "current group is :");
        y.append(vGroup.getGroupName());
        y.append(" rotation is ");
        y.append(vGroup.mRotate);
        Log.v(LOGTAG, y.toString());
