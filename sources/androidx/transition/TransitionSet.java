...
public class TransitionSet extends Transition {
    ...
    public TransitionSet setOrdering(int i) {
        if (i == 0) {
            ...
            throw new AndroidRuntimeException(C0843a.m444e("Invalid parameter for TransitionSet ordering: ", i));
        }
        return this;
    }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            StringBuilder y = C0843a.m464y(transition, "\n");
            y.append(this.mTransitions.get(i).toString(str + "  "));
            transition = y.toString();
        }
        return transition;
    }
}
