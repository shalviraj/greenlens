...
public abstract class Transition implements Cloneable {
    ...
    private static int[] parseMatchOrder(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if ("id".equalsIgnoreCase(trim)) {
                ...
                throw new InflateException(C0843a.m452m("Unknown match type in matchOrder: '", trim, "'"));
            }
            i++;
        }
        return iArr;
    ...
    public String toString(String str) {
        ...
        if (this.mDuration != -1) {
            StringBuilder y = C0843a.m464y(sb, "dur(");
            y.append(this.mDuration);
            y.append(") ");
            sb = y.toString();
        }
        if (this.mStartDelay != -1) {
            StringBuilder y2 = C0843a.m464y(sb, "dly(");
            y2.append(this.mStartDelay);
            y2.append(") ");
            sb = y2.toString();
        }
        if (this.mInterpolator != null) {
            StringBuilder y3 = C0843a.m464y(sb, "interp(");
            y3.append(this.mInterpolator);
            y3.append(") ");
            sb = y3.toString();
        }
        ...
        String l = C0843a.m451l(sb, "tgts(");
        if (this.mTargetIds.size() > 0) {
            for (int i = 0; i < this.mTargetIds.size(); i++) {
                if (i > 0) {
                    l = C0843a.m451l(l, ", ");
                }
                StringBuilder u2 = C0843a.m460u(l);
        ...
        if (this.mTargets.size() > 0) {
            for (int i2 = 0; i2 < this.mTargets.size(); i2++) {
                ...
                StringBuilder u3 = C0843a.m460u(l);
                u3.append(this.mTargets.get(i2));
                l = u3.toString();
            }
        }
        return C0843a.m451l(l, ")");
    }
}
