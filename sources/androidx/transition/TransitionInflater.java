...
public class TransitionInflater {
    ...
    private Object createCustom(AttributeSet attributeSet, Class<?> cls, String str) {
        ...
        if (attributeValue != null) {
            ...
            throw new InflateException(C0843a.m451l(str, " tag must have a 'class' attribute"));
        }
    }
                    ...
                    if (next == 2) {
                        ...
                        if ("fade".equals(name)) {
                            ...
                            if ("arcMotion".equals(name)) {
                                ...
                                StringBuilder u = C0843a.m460u("Unknown scene name: ");
                                ...
                                if (namedString2 != null) {
                                    ...
                                    if (namedString3 != null) {
                                        try {
                                            ...
                                            throw new RuntimeException(C0843a.m451l("Could not create ", namedString3), e);
                                        }
                                    } else {
    ...
    private void loadTransition(AttributeSet attributeSet, XmlPullParser xmlPullParser, ViewGroup viewGroup, TransitionManager transitionManager) {
        ...
        if (namedResourceId >= 0 && (inflateTransition = inflateTransition(namedResourceId)) != null) {
            if (scene == null) {
                throw new RuntimeException(C0843a.m444e("No toScene for transition ID ", namedResourceId));
