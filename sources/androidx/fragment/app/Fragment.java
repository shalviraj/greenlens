...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner {
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(C0843a.m452m("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (IllegalAccessException e2) {
            throw new InstantiationException(C0843a.m452m("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e2);
        } catch (NoSuchMethodException e3) {
            throw new InstantiationException(C0843a.m452m("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e3);
        } catch (InvocationTargetException e4) {
            throw new InstantiationException(C0843a.m452m("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e4);
        }
    }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(C0843a.m451l(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(C0843a.m450k("Fragment ", this, " has not been attached yet."));
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onActivityCreated()"));
    }
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onAttach()"));
        }
    }
    ...
    public void performCreate(Bundle bundle) {
        ...
        throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onCreate()"));
    }
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onDestroyView()"));
    }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onDetach()"));
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onResume()"));
    }
    ...
    public void performStart() {
        ...
        throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onStart()"));
    }
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i) {
        ...
        throw new IllegalStateException(C0843a.m450k("Fragment ", this, " not attached to Activity"));
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException(C0843a.m450k("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(C0843a.m450k("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(C0843a.m450k("Fragment ", this, " not attached to a context."));
    }
    ...
    public final FragmentManager requireFragmentManager() {
        ...
        throw new IllegalStateException(C0843a.m450k("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(C0843a.m450k("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(C0843a.m450k("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(C0843a.m450k("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(C0843a.m450k("Fragment ", this, " did not call through to super.onViewStateRestored()"));
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i) {
        ...
        throw new IllegalArgumentException(C0843a.m450k("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
    }
