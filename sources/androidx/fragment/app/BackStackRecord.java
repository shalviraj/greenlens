...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    private static boolean isFragmentPostponed(FragmentTransaction.C0323Op op) {
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C0323Op op = this.mOps.get(i2);
                Fragment fragment = op.mFragment;
                if (fragment != null) {
                    fragment.mBackStackNesting += i;
                    if (FragmentManagerImpl.DEBUG) {
                        StringBuilder u = C0843a.m460u("Bump nesting of ");
                        u.append(op.mFragment);
                        u.append(" to ");
                        u.append(op.mFragment.mBackStackNesting);
    ...
    public FragmentTransaction detach(@NonNull Fragment fragment) {
        ...
        StringBuilder u = C0843a.m460u("Cannot detach Fragment attached to a different FragmentManager. Fragment ");
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                FragmentTransaction.C0323Op op = this.mOps.get(i);
                switch (op.mCmd) {
                    case 0:
                        str2 = "NULL";
                        break;
                    ...
                    case 10:
                        ...
                        break;
                    default:
                        StringBuilder u = C0843a.m460u("cmd=");
                        u.append(op.mCmd);
                        str2 = u.toString();
                        break;
                }
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (op.mCmd) {
                ...
                case 10:
                    ...
                    break;
                default:
                    StringBuilder u = C0843a.m460u("Unknown cmd: ");
                    u.append(op.mCmd);
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0323Op op = this.mOps.get(size);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment4.mContainerId == i3) {
                            if (fragment4 == fragment3) {
                                ...
                                if (fragment4 == fragment2) {
                                    this.mOps.add(i, new FragmentTransaction.C0323Op(9, fragment4));
                                    i++;
                                    fragment2 = null;
                                }
                                FragmentTransaction.C0323Op op2 = new FragmentTransaction.C0323Op(3, fragment4);
                    ...
                    if (fragment5 == fragment2) {
                        this.mOps.add(i, new FragmentTransaction.C0323Op(9, fragment5));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
                    if (i2 == 8) {
                        this.mOps.add(i, new FragmentTransaction.C0323Op(9, fragment2));
                        i++;
    ...
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        ...
        StringBuilder u = C0843a.m460u("Cannot hide Fragment attached to a different FragmentManager. Fragment ");
        u.append(fragment.toString());
        u.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(u.toString());
    }
    ...
    public FragmentTransaction remove(@NonNull Fragment fragment) {
        ...
        StringBuilder u = C0843a.m460u("Cannot remove Fragment attached to a different FragmentManager. Fragment ");
        u.append(fragment.toString());
        u.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(u.toString());
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        ...
        StringBuilder u = C0843a.m460u("Cannot setMaxLifecycle for Fragment not attached to FragmentManager ");
        u.append(this.mManager);
        throw new IllegalArgumentException(u.toString());
    }
    ...
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        ...
        StringBuilder u = C0843a.m460u("Cannot setPrimaryNavigation for Fragment attached to a different FragmentManager. Fragment ");
        u.append(fragment.toString());
        u.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(u.toString());
    }
    ...
    public FragmentTransaction show(@NonNull Fragment fragment) {
        ...
        StringBuilder u = C0843a.m460u("Cannot show Fragment attached to a different FragmentManager. Fragment ");
        u.append(fragment.toString());
        u.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(u.toString());
    }
