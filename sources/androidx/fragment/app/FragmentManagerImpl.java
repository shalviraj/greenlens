...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    public void addFragment(Fragment fragment, boolean z) {
        if (DEBUG) {
            C0843a.m429E("add: ", fragment, "FragmentManager");
        }
        makeActive(fragment);
    ...
    public void addRetainedFragment(@NonNull Fragment fragment) {
        if (isStateSaved()) {
            ...
            C0843a.m429E("Updating retained Fragments: Added ", fragment, "FragmentManager");
        }
    }
    ...
    public void attachFragment(Fragment fragment) {
        if (DEBUG) {
            C0843a.m429E("attach: ", fragment, "FragmentManager");
        }
        if (fragment.mDetached) {
            ...
            if (!this.mAdded.contains(fragment)) {
                if (DEBUG) {
                    C0843a.m429E("add from attach: ", fragment, "FragmentManager");
                }
                synchronized (this.mAdded) {
                    this.mAdded.add(fragment);
                }
    ...
    public void detachFragment(Fragment fragment) {
        if (DEBUG) {
            C0843a.m429E("detach: ", fragment, "FragmentManager");
        }
        if (!fragment.mDetached) {
            fragment.mDetached = true;
            if (fragment.mAdded) {
                if (DEBUG) {
                    C0843a.m429E("remove from detach: ", fragment, "FragmentManager");
                }
                synchronized (this.mAdded) {
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        if (!this.mActive.isEmpty()) {
            ...
            for (Fragment next : this.mActive.values()) {
                ...
                if (next != null) {
                    next.dump(l, fileDescriptor, printWriter, strArr);
                }
            }
        }
    ...
    public void hideFragment(Fragment fragment) {
        if (DEBUG) {
            C0843a.m429E("hide: ", fragment, "FragmentManager");
        }
        if (!fragment.mHidden) {
    ...
    public void makeActive(Fragment fragment) {
        if (this.mActive.get(fragment.mWho) == null) {
            ...
            if (DEBUG) {
                C0843a.m429E("Added fragment to active set ", fragment, "FragmentManager");
            }
        }
    }
    ...
    public void makeInactive(Fragment fragment) {
        if (this.mActive.get(fragment.mWho) != null) {
            if (DEBUG) {
                C0843a.m429E("Removed fragment from active set ", fragment, "FragmentManager");
            }
            for (Fragment next : this.mActive.values()) {
    ...
    public void moveToState(androidx.fragment.app.Fragment r17, int r18, int r19, int r20, boolean r21) {
        ...
        L_0x0088:
            ...
            p005b.p035e.p036a.p037a.C0843a.m429E(r0, r7, r12)
        L_0x0093:
        ...
        L_0x0165:
            ...
            java.lang.String r1 = p005b.p035e.p036a.p037a.C0843a.m455p(r1, r2, r9)
            r0.<init>(r1)
            throw r0
        L_0x017f:
            androidx.fragment.app.FragmentHostCallback r0 = r6.mHost
        ...
        L_0x01cd:
            ...
            java.lang.String r1 = p005b.p035e.p036a.p037a.C0843a.m450k(r1, r7, r2)
            r0.<init>(r1)
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if (DEBUG) {
            StringBuilder u = C0843a.m460u("onCreateView: id=0x");
        ...
        throw new IllegalStateException(C0843a.m452m("Fragment ", str2, " did not create a view."));
    }
    ...
    public void popBackStack(int i, int i2) {
        ...
        throw new IllegalArgumentException(C0843a.m444e("Bad id: ", i));
    }
    ...
    public void putFragment(Bundle bundle, String str, Fragment fragment) {
        if (fragment.mFragmentManager != this) {
            throwException(new IllegalStateException(C0843a.m450k("Fragment ", fragment, " is not currently in the FragmentManager")));
        }
    ...
    public void removeRetainedFragment(@NonNull Fragment fragment) {
        if (isStateSaved()) {
            ...
            C0843a.m429E("Updating retained Fragments: Removed ", fragment, "FragmentManager");
        }
    }
        ...
        if (parcelable != null) {
            ...
            if (fragmentManagerState.mActive != null) {
                for (Fragment next : this.mNonConfig.getRetainedFragments()) {
                    if (DEBUG) {
                        C0843a.m429E("restoreSaveState: re-attaching retained ", next, "FragmentManager");
                    }
                ...
                while (it2.hasNext()) {
                    ...
                    if (next2 != null) {
                        ...
                        if (DEBUG) {
                            StringBuilder u = C0843a.m460u("restoreSaveState: active (");
                            u.append(instantiate.mWho);
                            u.append("): ");
                            u.append(instantiate);
                            Log.v("FragmentManager", u.toString());
                        }
                ...
                if (arrayList != null) {
                    ...
                    while (it3.hasNext()) {
                        ...
                        if (fragment3 == null) {
                            throwException(new IllegalStateException(C0843a.m452m("No instantiated fragment for (", next3, ")")));
                        }
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    while (true) {
                        ...
                        if (DEBUG) {
                            StringBuilder v = C0843a.m461v("restoreAllState: back stack #", i, " (index ");
                            v.append(instantiate2.mIndex);
                            v.append("): ");
                            v.append(instantiate2);
    ...
    public Parcelable saveAllState() {
        ...
        for (Fragment next : this.mActive.values()) {
            if (next != null) {
                if (next.mFragmentManager != this) {
                    throwException(new IllegalStateException(C0843a.m450k("Failure saving state: active ", next, " was removed from the FragmentManager")));
                }
        ...
        if (size2 > 0) {
            ...
            while (it.hasNext()) {
                ...
                if (next2.mFragmentManager != this) {
                    throwException(new IllegalStateException(C0843a.m450k("Failure saving state: active ", next2, " was removed from the FragmentManager")));
                }
                if (DEBUG) {
                    StringBuilder u = C0843a.m460u("saveAllState: adding fragment (");
                    u.append(next2.mWho);
                    u.append("): ");
                    u.append(next2);
                    Log.v("FragmentManager", u.toString());
        ...
        if (arrayList3 != null && (size = arrayList3.size()) > 0) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (DEBUG) {
                    StringBuilder v = C0843a.m461v("saveAllState: adding back stack #", i2, ": ");
                    v.append(this.mBackStack.get(i2));
                    Log.v("FragmentManager", v.toString());
                }
            }
        }
    ...
    public void showFragment(Fragment fragment) {
        if (DEBUG) {
            C0843a.m429E("show: ", fragment, "FragmentManager");
        }
        if (fragment.mHidden) {
