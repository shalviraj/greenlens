...
public abstract class FragmentTransaction {
    ...
    @Nullable
    public String mName;
    public ArrayList<C0323Op> mOps = new ArrayList<>();
    ...
    public static final class C0323Op {
        public int mCmd;
        ...
        public C0323Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        public C0323Op(int i, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        if (FragmentTransition.supportsTransition()) {
            ...
            if (transitionName != null) {
                if (this.mSharedElementSourceNames == null) {
                    ...
                    throw new IllegalArgumentException(C0843a.m452m("A shared element with the target name '", str, "' has already been added to the transaction."));
                } else if (this.mSharedElementSourceNames.contains(transitionName)) {
                    throw new IllegalArgumentException(C0843a.m452m("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i2) {
        ...
        if (cls.isAnonymousClass() || !Modifier.isPublic(modifiers) || (cls.isMemberClass() && !Modifier.isStatic(modifiers))) {
            StringBuilder u = C0843a.m460u("Fragment ");
        ...
        if (str != null) {
            ...
            if (str2 == null || str.equals(str2)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                throw new IllegalStateException(C0843a.m456q(sb, fragment.mTag, " now ", str));
            }
        }
        if (i != 0) {
            if (i != -1) {
        ...
        addOp(new C0323Op(i2, fragment));
    }

    @NonNull
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        addOp(new C0323Op(4, fragment));
        return this;
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        addOp(new C0323Op(10, fragment, state));
        return this;
    }

    @NonNull
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0323Op(8, fragment));
        return this;
    }
