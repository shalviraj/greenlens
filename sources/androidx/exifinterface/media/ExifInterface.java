...
public class ExifInterface {
        ...
        public int readInt() {
            ...
            if (i <= this.mLength) {
                ...
                if ((read | read2 | read3 | read4) >= 0) {
                    ...
                    StringBuilder u = C0843a.m460u("Invalid byte order: ");
                    u.append(this.mByteOrder);
    ...
    public static class ExifAttribute {
        ...
        public String toString() {
            ...
            u.append(ExifInterface.IFD_FORMAT_NAMES[this.format]);
            u.append(", data length:");
            return C0843a.m453n(u, this.bytes.length, ")");
        }
    }
    ...
    private void getJpegAttributes(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r21, int r22, int r23) {
        ...
        L_0x01af:
            java.io.IOException r1 = new java.io.IOException
            java.lang.StringBuilder r2 = p005b.p035e.p036a.p037a.C0843a.m460u(r6)
            r3 = r4 & 255(0xff, float:3.57E-43)
            java.lang.String r3 = java.lang.Integer.toHexString(r3)
            r2.append(r3)
            java.lang.String r2 = r2.toString()
    ...
    private void parseTiffHeaders(ByteOrderedDataInputStream byteOrderedDataInputStream, int i) {
        ...
        if (i2 == 7 || i2 == 10 || readUnsignedShort == 42) {
            ...
            if (readInt < 8 || readInt >= i) {
                throw new IOException(C0843a.m444e("Invalid first Ifd offset: ", readInt));
            }
            int i3 = readInt - 8;
            if (i3 > 0 && byteOrderedDataInputStream.skipBytes(i3) != i3) {
                throw new IOException(C0843a.m444e("Couldn't jump to first Ifd: ", i3));
            }
            return;
        }
        StringBuilder u = C0843a.m460u("Invalid start code: ");
        u.append(Integer.toHexString(readUnsignedShort));
        throw new IOException(u.toString());
    }

    private void printAttributes() {
        for (int i = 0; i < this.mAttributes.length; i++) {
            StringBuilder v = C0843a.m461v("The size of tag group[", i, "]: ");
            v.append(this.mAttributes[i].size());
            Log.d(TAG, v.toString());
            for (Map.Entry next : this.mAttributes[i].entrySet()) {
                ExifAttribute exifAttribute = (ExifAttribute) next.getValue();
                StringBuilder u = C0843a.m460u("tagName: ");
                u.append((String) next.getKey());
                u.append(", tagType: ");
                u.append(exifAttribute.toString());
                u.append(", tagValue: '");
                u.append(exifAttribute.getStringValue(this.mExifByteOrder));
                u.append("'");
    ...
    private ByteOrder readByteOrder(ByteOrderedDataInputStream byteOrderedDataInputStream) {
        ...
        if (readShort == 18761) {
            ...
            StringBuilder u = C0843a.m460u("Invalid byte order: ");
            u.append(Integer.toHexString(readShort));
            throw new IOException(u.toString());
        }
    }
    ...
    private void readImageFileDirectory(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r27, int r28) {
        ...
        L_0x02b3:
            ...
            java.lang.String r2 = p005b.p035e.p036a.p037a.C0843a.m448i(r2, r3)
        L_0x02bb:
        ...
        if (exifAttribute3 != null) {
            if (exifAttribute3.format == 5) {
                ...
                if (rationalArr == null || rationalArr.length != 2) {
                    sb = C0843a.m460u("Invalid crop size values. cropSize=");
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream, int i) {
        ...
        while (i9 < EXIF_TAGS.length) {
            if (!this.mAttributes[i9].isEmpty()) {
                ...
                byteOrderedDataOutputStream2.writeUnsignedInt((i9 != 0 || this.mAttributes[4].isEmpty()) ? 0 : (long) iArr[4]);
            ...
            if (str.equals(TAG_GPS_TIMESTAMP)) {
                ...
                if (i == 5 || i == 10) {
                    ...
                    if (rationalArr == null || rationalArr.length != 3) {
                        StringBuilder u = C0843a.m460u("Invalid GPS Timestamp array. array=");
                        u.append(Arrays.toString(rationalArr));
                        str2 = u.toString();
                    } else {
                    ...
                    StringBuilder u2 = C0843a.m460u("GPS Timestamp format is not rational. format=");
                    u2.append(exifAttribute.format);
                    str2 = u2.toString();
                }
                Log.w(TAG, str2);
                return null;
    ...
    public double[] getLatLong() {
        ...
        try {
            ...
            StringBuilder u = C0843a.m460u("Latitude/longitude values are not parsable. ");
            u.append(String.format("latValue=%s, latRef=%s, lngValue=%s, lngRef=%s", new Object[]{attribute, attribute2, attribute3, attribute4}));
    ...
    public void setAttribute(@androidx.annotation.NonNull java.lang.String r18, @androidx.annotation.Nullable java.lang.String r19) {
        ...
        L_0x0119:
            ...
            java.lang.StringBuilder r3 = p005b.p035e.p036a.p037a.C0843a.m465z(r3, r1, r7)
            java.lang.String[] r7 = IFD_FORMAT_NAMES
            int r10 = r8.primaryFormat
            r10 = r7[r10]
            r3.append(r10)
            ...
            goto L_0x0147
        L_0x0138:
            java.lang.StringBuilder r10 = p005b.p035e.p036a.p037a.C0843a.m460u(r13)
        ...
        L_0x0147:
            ...
            goto L_0x017c
        L_0x0167:
            java.lang.StringBuilder r8 = p005b.p035e.p036a.p037a.C0843a.m460u(r13)
