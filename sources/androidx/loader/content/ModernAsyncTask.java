...
public abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    public static /* synthetic */ class C03774 {
        ...
        static {
            ...
            L_0x0014:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.loader.content.ModernAsyncTask.C03774.<clinit>():void");
        }
    }
    ...
    static {
        C03741 r7 = new ThreadFactory() {
            private final AtomicInteger mCount = new AtomicInteger(1);

            public Thread newThread(Runnable runnable) {
                StringBuilder u = C0843a.m460u("ModernAsyncTask #");
    ...
    public ModernAsyncTask() {
        C03752 r0 = new WorkerRunnable<Params, Result>() {
            public Result call() {
