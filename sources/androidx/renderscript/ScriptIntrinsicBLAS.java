...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    public static void validateGEMV(Element element, int i, Allocation allocation, Allocation allocation2, int i2, Allocation allocation3, int i3) {
        ...
        if (!C0843a.m433I(allocation, element) || !C0843a.m433I(allocation2, element) || !C0843a.m433I(allocation3, element)) {
            ...
            if (i == 111) {
                i5 = C0843a.m462w(x, 1, i2, 1);
                i4 = C0843a.m462w(y, 1, i3, 1);
            } else {
                i5 = C0843a.m462w(y, 1, i2, 1);
                i4 = C0843a.m462w(x, 1, i3, 1);
            }
    ...
    public static void validateGER(Element element, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        if (!C0843a.m433I(allocation3, element) || !C0843a.m433I(allocation, element) || !C0843a.m433I(allocation2, element)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
            ...
            if (x < 1 || y < 1) {
                ...
                if (allocation.getType().getX() == C0843a.m462w(y, 1, i, 1)) {
                    if (allocation2.getType().getX() != C0843a.m462w(x, 1, i2, 1)) {
    ...
    public static void validateHEMM(Element element, int i, Allocation allocation, Allocation allocation2, Allocation allocation3) {
        validateSide(i);
        if (!allocation.getType().getElement().isCompatible(element) || !C0843a.m433I(allocation2, element) || !C0843a.m433I(allocation3, element)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        }
        int x = allocation.getType().getX();
    ...
    public static void validateHERK(Element element, int i, Allocation allocation, Allocation allocation2) {
        if (!C0843a.m433I(allocation, element) || !C0843a.m433I(allocation2, element)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        }
        validateConjTranspose(i);
    ...
    public static void validateL3(Element element, int i, int i2, int i3, Allocation allocation, Allocation allocation2, Allocation allocation3) {
        ...
        int i8;
        int i9;
        if ((allocation != null && !C0843a.m433I(allocation, element)) || ((allocation2 != null && !C0843a.m433I(allocation2, element)) || (allocation3 != null && !C0843a.m433I(allocation3, element)))) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
    ...
    public static int validateSPR(Element element, int i, Allocation allocation, int i2, Allocation allocation2) {
        validateUplo(i);
        if (!allocation2.getType().getElement().isCompatible(element) || !C0843a.m433I(allocation, element)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        } else if (allocation.getType().getY() > 1) {
            throw new RSRuntimeException("BLAS vectors must have Y dimension of 0 or 1");
    ...
    public static int validateSPR2(Element element, int i, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        validateUplo(i);
        if (!allocation3.getType().getElement().isCompatible(element) || !C0843a.m433I(allocation, element) || !C0843a.m433I(allocation2, element)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        } else if (allocation.getType().getY() > 1 || allocation2.getType().getY() > 1) {
            throw new RSRuntimeException("BLAS vectors must have Y dimension of 0 or 1");
    ...
    public static int validateSYMV(Element element, int i, Allocation allocation, Allocation allocation2, Allocation allocation3, int i2, int i3) {
        ...
        } else if (!C0843a.m433I(allocation, element) || !C0843a.m433I(allocation2, element) || !C0843a.m433I(allocation3, element)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        } else if (allocation2.getType().getY() > 1 || allocation3.getType().getY() > 1) {
            throw new RSRuntimeException("BLAS vectors must have Y dimension of 0 or 1");
        } else if (i2 <= 0 || i3 <= 0) {
    ...
    public static int validateTPMV(Element element, int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        validateUplo(i);
        validateDiag(i3);
        if (!allocation.getType().getElement().isCompatible(element) || !C0843a.m433I(allocation2, element)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        } else if (allocation2.getType().getY() > 1) {
            throw new RSRuntimeException("BLAS vectors must have Y dimension of 0 or 1");
        } else if (allocation.getType().getY() <= 1) {
    ...
    public static void validateTRMV(Element element, int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        } else if (!C0843a.m433I(allocation, element) || !C0843a.m433I(allocation2, element)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        } else if (allocation2.getType().getY() > 1) {
            throw new RSRuntimeException("BLAS vectors must have Y dimension of 0 or 1");
        } else if (i4 > 0) {
            if (allocation2.getType().getX() != C0843a.m462w(y, 1, i4, 1)) {
    ...
    public void BNNM(Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3, int i3, int i4) {
        ...
        validateL3(Element.m45U8(this.mRS), 111, 112, 0, allocation, allocation2, allocation3);
        if (i5 < 0 || i5 > 255) {
    ...
    public void CGBMV(int i, int i2, int i3, Float2 float2, Allocation allocation, Allocation allocation2, int i4, Float2 float22, Allocation allocation3, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        int i6 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 64, i6, 0, 0, 0, 0, y, x, 0, float23.f156x, float23.f157y, id, id2, float24.f156x, float24.f157y, id3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void CGEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        validateTranspose(i2);
        int i5 = i;
        validateL3(Element.F32_2(this.mRS), i5, i2, 0, allocation, allocation2, allocation3);
        ...
        int i6 = i4;
        int i7 = i3;
        int y = i2 != 111 ? allocation2.getType().getY() : allocation2.getType().getX();
        boolean isIncSupp = isIncSupp();
        long id = allocation4.getID(this.mRS);
        long id2 = allocation5.getID(this.mRS);
        long id3 = allocation6.getID(this.mRS);
        if (isIncSupp) {
            j3 = getDummyAlloc(allocation4);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_cgemm, i, i2, 0, 0, 0, i6, y, i7, float23.f156x, float23.f157y, j3, j2, float24.f156x, float24.f157y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CGEMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 63, i4, 0, 0, 0, 0, y, x, 0, float23.f156x, float23.f157y, id, id2, float24.f156x, float24.f157y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CGERC(Float2 float2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 99, 0, 0, 0, 0, 0, y, x, 0, float22.f156x, float22.f157y, id2, id3, 0.0f, 0.0f, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void CGERU(Float2 float2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 98, 0, 0, 0, 0, 0, y, x, 0, float22.f156x, float22.f157y, id2, id3, 0.0f, 0.0f, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void CHBMV(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, int i3, Float2 float22, Allocation allocation3, int i4) {
        ...
        if (i2 >= 0) {
            ...
            int i5 = i;
            int i6 = i2;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 96, 0, 0, 0, i5, 0, 0, validateSYR2, i6, float23.f156x, float23.f157y, id, id2, float24.f156x, float24.f157y, id3, i3, i4, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CHEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_chemm, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float23.f156x, float23.f157y, j3, j2, float24.f156x, float24.f157y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHEMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 95, 0, 0, 0, i4, 0, 0, validateSYR2, 0, float23.f156x, float23.f157y, id, id2, float24.f156x, float24.f157y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHER2(int i, Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 102, 0, 0, 0, i4, 0, 0, validateSYR2, 0, float22.f156x, float22.f157y, id2, id3, 0.0f, 0.0f, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHER2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, float f, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i);
        validateHER2K(Element.F32_2(this.mRS), i3, allocation4, allocation5, allocation6);
        int x = i3 == 111 ? allocation.getType().getX() : allocation.getType().getY();
        boolean isIncSupp = isIncSupp();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_cher2k, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), x, float22.f156x, float22.f157y, allocation4.getID(this.mRS), j2, f, 0.0f, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHERK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        Allocation allocation4 = allocation2;
        validateUplo(i);
        validateHERK(Element.F32_2(this.mRS), i3, allocation3, allocation4);
        int y = i3 == 113 ? allocation.getType().getY() : allocation.getType().getX();
        boolean isIncSupp = isIncSupp();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_cherk, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, f, 0.0f, j2, 0, f2, 0.0f, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHPMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 97, 0, 0, 0, i4, 0, 0, validateSPR2, 0, float23.f156x, float23.f157y, id, id2, float24.f156x, float24.f157y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHPR2(int i, Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 103, 0, 0, 0, i4, 0, 0, validateSPR2, 0, float22.f156x, float22.f157y, id2, id3, 0.0f, 0.0f, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CSYMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            int i3 = i;
            int i4 = i2;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_csymm, 0, 0, i3, i4, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float23.f156x, float23.f157y, id, id2, float24.f156x, float24.f157y, id3, 0, 0, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CSYR2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i);
        validateSYR2K(Element.F32_2(this.mRS), i3, allocation4, allocation5, allocation6);
        int y = i3 != 111 ? allocation.getType().getY() : allocation.getType().getX();
        boolean isIncSupp = isIncSupp();
        long id = allocation4.getID(this.mRS);
        long id2 = allocation5.getID(this.mRS);
        long id3 = allocation6.getID(this.mRS);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 128, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), y, float23.f156x, float23.f157y, j3, j2, float24.f156x, float24.f157y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CSYRK(int i, int i2, Float2 float2, Allocation allocation, Float2 float22, Allocation allocation2) {
        ...
        validateUplo(i);
        int i3 = i2;
        validateL3(Element.F32_2(this.mRS), i3, 0, 0, allocation, (Allocation) null, allocation2);
        int y = i3 != 111 ? allocation.getType().getY() : allocation.getType().getX();
        boolean isIncSupp = isIncSupp();
        long id = allocation3.getID(this.mRS);
        allocation4.getID(this.mRS);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_csyrk, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, float23.f156x, float23.f157y, id, 0, float24.f156x, float24.f157y, allocation4.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRMM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_ctrmm, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, float22.f156x, float22.f157y, id, j, 0.0f, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRSM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_ctrsm, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, float22.f156x, float22.f157y, id, j, 0.0f, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DGEMM(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 119, i, i2, 0, 0, 0, i6, y, i7, d, j3, j2, d2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DGER(double d, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 90, 0, 0, 0, 0, 0, y, x, 0, d, id2, id3, ShadowDrawableWrapper.COS_45, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void DSPR(int i, double d, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 92, 0, 0, 0, i, 0, 0, validateSPR, 0, d, j2, j, ShadowDrawableWrapper.COS_45, 0, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSPR2(int i, double d, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 94, 0, 0, 0, i, 0, 0, validateSPR2, 0, d, id2, id3, ShadowDrawableWrapper.COS_45, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void DSYR(int i, double d, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 91, 0, 0, 0, i, 0, 0, validateSYR, 0, d, j2, j, ShadowDrawableWrapper.COS_45, 0, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSYR2(int i, double d, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 93, 0, 0, 0, i, 0, 0, validateSYR2, 0, d, id2, id3, ShadowDrawableWrapper.COS_45, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void DSYR2K(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i);
        validateSYR2K(Element.F64(this.mRS), i3, allocation4, allocation5, allocation6);
        int y = i3 != 111 ? allocation.getType().getY() : allocation.getType().getX();
        boolean isIncSupp = isIncSupp();
        long id = allocation4.getID(this.mRS);
        long id2 = allocation5.getID(this.mRS);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 122, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), y, d, j3, j2, d2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSYRK(int i, int i2, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        validateUplo(i);
        int i3 = i2;
        validateL3(Element.F64(this.mRS), i3, 0, 0, allocation, (Allocation) null, allocation2);
        int y = i3 != 111 ? allocation.getType().getY() : allocation.getType().getX();
        boolean isIncSupp = isIncSupp();
        long id = allocation3.getID(this.mRS);
        long id2 = allocation4.getID(this.mRS);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 121, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, d, id, 0, d2, id2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 58, i2, 0, 0, i, i3, 0, y, i4, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void DTBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 61, i2, 0, 0, i, i3, 0, y, i4, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Number of diagonals must be positive");
    }
    ...
    public void DTPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 59, i2, 0, 0, i, i3, 0, validateTPMV, 0, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 62, i2, 0, 0, i, i3, 0, validateTPMV, 0, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRMM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 123, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, j, ShadowDrawableWrapper.COS_45, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 57, i2, 0, 0, i, i3, 0, y, 0, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRSM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 124, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, j, ShadowDrawableWrapper.COS_45, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 60, i2, 0, 0, i, i3, 0, y, 0, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void SGEMM(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 113, i, i2, 0, 0, 0, i6, y, i7, f, j3, j2, f2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSYR2K(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i);
        validateSYR2K(Element.F32(this.mRS), i3, allocation4, allocation5, allocation6);
        int y = i3 != 111 ? allocation.getType().getY() : allocation.getType().getX();
        boolean isIncSupp = isIncSupp();
        long id = allocation4.getID(this.mRS);
        long id2 = allocation5.getID(this.mRS);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 116, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), y, f, j3, j2, f2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSYRK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        validateUplo(i);
        int i3 = i2;
        validateL3(Element.F32(this.mRS), i3, 0, 0, allocation, (Allocation) null, allocation2);
        int y = i3 != 111 ? allocation.getType().getY() : allocation.getType().getX();
        boolean isIncSupp = isIncSupp();
        long id = allocation3.getID(this.mRS);
        long id2 = allocation4.getID(this.mRS);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 115, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, f, id, 0, f2, id2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGBMV(int i, int i2, int i3, Double2 double2, Allocation allocation, Allocation allocation2, int i4, Double2 double22, Allocation allocation3, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        int i6 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 72, i6, 0, 0, 0, 0, y, x, 0, double23.f147x, double23.f148y, id, id2, double24.f147x, double24.f148y, id3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void ZGEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        validateTranspose(i2);
        int i5 = i;
        validateL3(Element.F64_2(this.mRS), i5, i2, 0, allocation, allocation2, allocation3);
        Type type = allocation.getType();
        if (i5 != 111) {
            i4 = type.getX();
            i3 = allocation.getType().getY();
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 131, i, i2, 0, 0, 0, i6, y, i7, double23.f147x, double23.f148y, j3, j2, double24.f147x, double24.f148y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGEMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 71, i4, 0, 0, 0, 0, y, x, 0, double23.f147x, double23.f148y, id, id2, double24.f147x, double24.f148y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZGERC(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 108, 0, 0, 0, 0, 0, y, x, 0, double22.f147x, double22.f148y, id2, id3, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZGERU(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 107, 0, 0, 0, 0, 0, y, x, 0, double22.f147x, double22.f148y, id2, id3, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZHBMV(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, int i3, Double2 double22, Allocation allocation3, int i4) {
        ...
        if (i2 >= 0) {
            ...
            int i5 = i;
            int i6 = i2;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 105, 0, 0, 0, i5, 0, 0, validateSYR2, i6, double23.f147x, double23.f148y, id, id2, double24.f147x, double24.f148y, id3, i3, i4, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be 0 or greater for HBMV");
    }
    ...
    public void ZHEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zhemm, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double23.f147x, double23.f148y, j3, j2, double24.f147x, double24.f148y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHEMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 104, 0, 0, 0, i4, 0, 0, validateSYR2, 0, double23.f147x, double23.f148y, id, id2, double24.f147x, double24.f148y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHER(int i, double d, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 109, 0, 0, 0, i, 0, 0, validateSYR, 0, d, ShadowDrawableWrapper.COS_45, j2, 0, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, j, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 111, 0, 0, 0, i4, 0, 0, validateSYR2, 0, double22.f147x, double22.f148y, id2, id3, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, double d, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i);
        validateHER2K(Element.F64_2(this.mRS), i3, allocation4, allocation5, allocation6);
        int x = i3 == 111 ? allocation.getType().getX() : allocation.getType().getY();
        boolean isIncSupp = isIncSupp();
        allocation4.getID(this.mRS);
        long id = allocation5.getID(this.mRS);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 142, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), x, double22.f147x, double22.f148y, allocation4.getID(this.mRS), j2, d, ShadowDrawableWrapper.COS_45, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHERK(int i, int i2, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        Allocation allocation4 = allocation2;
        validateUplo(i);
        validateHERK(Element.F64_2(this.mRS), i3, allocation3, allocation4);
        int y = i3 == 113 ? allocation.getType().getY() : allocation.getType().getX();
        boolean isIncSupp = isIncSupp();
        long id = allocation3.getID(this.mRS);
        long id2 = allocation4.getID(this.mRS);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 141, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, d, ShadowDrawableWrapper.COS_45, j2, 0, d2, ShadowDrawableWrapper.COS_45, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHPMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 106, 0, 0, 0, i4, 0, 0, validateSPR2, 0, double23.f147x, double23.f148y, id, id2, double24.f147x, double24.f148y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHPR(int i, double d, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 110, 0, 0, 0, i, 0, 0, validateSPR, 0, d, ShadowDrawableWrapper.COS_45, j2, 0, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, j, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHPR2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 112, 0, 0, 0, i4, 0, 0, validateSPR2, 0, double22.f147x, double22.f148y, id2, id3, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZSYMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            int i3 = i;
            int i4 = i2;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 132, 0, 0, i3, i4, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double23.f147x, double23.f148y, id, id2, double24.f147x, double24.f148y, id3, 0, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Matrix A is not symmetric");
    }
    ...
    public void ZSYR2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        Allocation allocation6 = allocation3;
        validateUplo(i);
        validateSYR2K(Element.F64_2(this.mRS), i3, allocation4, allocation5, allocation6);
        int y = i3 != 111 ? allocation.getType().getY() : allocation.getType().getX();
        boolean isIncSupp = isIncSupp();
        long id = allocation4.getID(this.mRS);
        long id2 = allocation5.getID(this.mRS);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zsyr2k, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), y, double23.f147x, double23.f148y, j3, j2, double24.f147x, double24.f148y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZSYRK(int i, int i2, Double2 double2, Allocation allocation, Double2 double22, Allocation allocation2) {
        ...
        validateUplo(i);
        int i3 = i2;
        validateL3(Element.F64_2(this.mRS), i3, 0, 0, allocation, (Allocation) null, allocation2);
        int y = i3 != 111 ? allocation.getType().getY() : allocation.getType().getX();
        boolean isIncSupp = isIncSupp();
        long id = allocation3.getID(this.mRS);
        allocation4.getID(this.mRS);
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zsyrk, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, double23.f147x, double23.f148y, id, 0, double24.f147x, double24.f148y, allocation4.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 74, i2, 0, 0, i, i3, 0, y, i4, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void ZTBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 77, i2, 0, 0, i, i3, 0, y, i4, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Number of diagonals must be positive");
    }
    ...
    public void ZTPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 75, i2, 0, 0, i, i3, 0, validateTPMV, 0, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 78, i2, 0, 0, i, i3, 0, validateTPMV, 0, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_ztrmm, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, double22.f147x, double22.f148y, id, j, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 73, i2, 0, 0, i, i3, 0, y, 0, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_ztrsm, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, double22.f147x, double22.f148y, id, j, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 76, i2, 0, 0, i, i3, 0, y, 0, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, id, id2, ShadowDrawableWrapper.COS_45, ShadowDrawableWrapper.COS_45, 0, i4, 0, 0, 0, isIncSupp);
    }
}
