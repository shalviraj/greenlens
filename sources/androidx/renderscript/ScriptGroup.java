...
public final class ScriptGroup extends BaseObj {
            ...
            if (this.mNodes.size() != 0) {
                ...
                for (int i3 = 0; i3 < this.mNodes.size(); i3++) {
                    ...
                    while (i4 < node.mKernels.size()) {
                        ...
                        if (!z) {
                            arrayList.add(new C0472IO(kernelID));
                        }
                        if (!z2) {
                            arrayList2.add(new C0472IO(kernelID));
                        }
                        i4++;
                        i2 = i5;
                    }
                ...
                if (i2 == this.mKernelCount) {
                    ...
                    scriptGroup.mOutputs = new C0472IO[arrayList2.size()];
                    for (int i9 = 0; i9 < arrayList2.size(); i9++) {
                        scriptGroup.mOutputs[i9] = (C0472IO) arrayList2.get(i9);
                    }
                    scriptGroup.mInputs = new C0472IO[arrayList.size()];
                    for (int i10 = 0; i10 < arrayList.size(); i10++) {
                        scriptGroup.mInputs[i10] = (C0472IO) arrayList.get(i10);
                    }
            ...
            public ValueAndSize(RenderScript renderScript, Object obj) {
                ...
                if (obj instanceof Boolean) {
                    ...
                    if (obj instanceof Long) {
                        ...
                        j = (long) Float.floatToRawIntBits(((Float) obj).floatValue());
    ...
    public static class C0472IO {
        public Allocation mAllocation;
        public Script.KernelID mKID;

        public C0472IO(Script.KernelID kernelID) {
            this.mKID = kernelID;
        }
    }
        ...
        if (objArr.length < this.mInputs2.size()) {
            ...
            while (i2 < this.mInputs2.size()) {
                ...
                if ((obj instanceof Future) || (obj instanceof Input)) {
                    str = toString() + ": input " + i2 + " is a future or unbound value";
                } else {
