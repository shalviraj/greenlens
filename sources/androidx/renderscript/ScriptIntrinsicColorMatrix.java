...
public class ScriptIntrinsicColorMatrix extends ScriptIntrinsic {
    ...
    public void setAdd(float f, float f2, float f3, float f4) {
        ...
        fieldPacker.addF32(this.mAdd.f162x);
        fieldPacker.addF32(this.mAdd.f163y);
        fieldPacker.addF32(this.mAdd.f164z);
        fieldPacker.addF32(this.mAdd.f161w);
        setVar(1, fieldPacker);
    }

    public void setAdd(Float4 float4) {
        Float4 float42 = this.mAdd;
        float42.f162x = float4.f162x;
        float42.f163y = float4.f163y;
        float42.f164z = float4.f164z;
        float42.f161w = float4.f161w;
        FieldPacker fieldPacker = new FieldPacker(16);
        fieldPacker.addF32(float4.f162x);
        fieldPacker.addF32(float4.f163y);
        fieldPacker.addF32(float4.f164z);
        fieldPacker.addF32(float4.f161w);
        setVar(1, fieldPacker);
    }
