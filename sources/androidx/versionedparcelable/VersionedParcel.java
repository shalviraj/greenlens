...
public abstract class VersionedParcel {
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(C0843a.m452m("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e);
        }
    }
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException(C0843a.m452m("VersionedParcelable encountered IOException reading a Serializable object (name = ", readString, ")"), e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException(C0843a.m452m("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", readString, ")"), e2);
        }
    }
