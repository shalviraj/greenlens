...
public class VersionedParcelParcel extends VersionedParcel {
    ...
    public VersionedParcel createSubParcel() {
        ...
        return new VersionedParcelParcel(parcel, dataPosition, i, C0843a.m455p(new StringBuilder(), this.mPrefix, "  "), this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
