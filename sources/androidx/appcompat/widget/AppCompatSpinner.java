...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public void show(int i, int i2) {
            ...
            if (!isShowing && (viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver()) != null) {
                final C00982 r5 = new ViewTreeObserver.OnGlobalLayoutListener() {
    ...
    public AppCompatSpinner(@androidx.annotation.NonNull android.content.Context r7, @androidx.annotation.Nullable android.util.AttributeSet r8, int r9, int r10, android.content.res.Resources.Theme r11) {
        ...
        L_0x0026:
            ...
            goto L_0x0039
        L_0x0029:
            int r11 = androidx.appcompat.C0035R.styleable.Spinner_popupTheme
        ...
        L_0x006f:
            ...
            int r3 = androidx.appcompat.C0035R.styleable.Spinner_android_dropDownWidth
            r4 = -2
            int r3 = r1.getLayoutDimension((int) r3, (int) r4)
            r6.mDropDownWidth = r3
            int r3 = androidx.appcompat.C0035R.styleable.Spinner_android_popupBackground
            android.graphics.drawable.Drawable r3 = r1.getDrawable(r3)
            r10.setBackgroundDrawable(r3)
            int r3 = androidx.appcompat.C0035R.styleable.Spinner_android_prompt
        ...
        L_0x00b6:
            int r10 = androidx.appcompat.C0035R.styleable.Spinner_android_entries
            java.lang.CharSequence[] r10 = r0.getTextArray(r10)
            if (r10 == 0) goto L_0x00ce
            android.widget.ArrayAdapter r1 = new android.widget.ArrayAdapter
            r3 = 17367048(0x1090008, float:2.5162948E-38)
            r1.<init>(r7, r3, r10)
            int r7 = androidx.appcompat.C0035R.layout.support_simple_spinner_dropdown_item
