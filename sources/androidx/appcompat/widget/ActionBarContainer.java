...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        boolean z = true;
        if (getId() == C0035R.C0038id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0035R.C0038id.action_bar);
        this.mContextView = findViewById(C0035R.C0038id.action_context_bar);
    }
