...
public class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            StringBuilder y = C0843a.m464y("[", "resolveInfo:");
            y.append(this.resolveInfo.toString());
            y.append("; weight:");
            y.append(new BigDecimal((double) this.weight));
            y.append("]");
            return y.toString();
        }
    }
    ...
    public static final class HistoricalRecord {
        ...
        public String toString() {
            StringBuilder y = C0843a.m464y("[", "; activity:");
            y.append(this.activity);
            y.append("; time:");
            y.append(this.time);
            y.append("; weight:");
            y.append(new BigDecimal((double) this.weight));
    ...
    private ActivityChooserModel(Context context, String str) {
        ...
        if (TextUtils.isEmpty(str) || str.endsWith(HISTORY_FILE_EXTENSION)) {
            ...
            this.mHistoryFileName = C0843a.m451l(str, HISTORY_FILE_EXTENSION);
        }
    }
