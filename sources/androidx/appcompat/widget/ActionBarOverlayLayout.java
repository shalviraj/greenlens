...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static final int[] ATTRS = {C0035R.attr.actionBarSize, 16842841};
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        StringBuilder u = C0843a.m460u("Can't make a decor toolbar out of ");
        u.append(view.getClass().getSimpleName());
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mOverlayMode || z) {
            windowInsetsCompat = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.m33of(windowInsetsCompat2.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + i3, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0)).build();
        } else {
            Rect rect = this.mContentInsets;
            rect.top += i3;
            rect.bottom += 0;
            windowInsetsCompat = windowInsetsCompat2.inset(0, i3, 0, 0);
        }
        this.mInnerInsets = windowInsetsCompat;
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0035R.C0038id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0035R.C0038id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0035R.C0038id.action_bar));
        }
    }
