...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            int itemViewType = getItemViewType(i);
            if (itemViewType == 0) {
                if (view == null || view.getId() != C0035R.C0038id.list_item) {
                ...
                ((ImageView) view.findViewById(C0035R.C0038id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                ((TextView) view.findViewById(C0035R.C0038id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                inflate.setId(1);
                ((TextView) inflate.findViewById(C0035R.C0038id.title)).setText(ActivityChooserView.this.getContext().getString(C0035R.string.abc_activity_chooser_view_see_all));
                return inflate;
            }
        }
    ...
    public ActivityChooserView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0035R.styleable.ActivityChooserView;
        ...
        View findViewById = findViewById(C0035R.C0038id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0035R.C0038id.default_activity_button);
        ...
        int i2 = C0035R.C0038id.image;
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(i2);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0035R.C0038id.expand_activities_button);
