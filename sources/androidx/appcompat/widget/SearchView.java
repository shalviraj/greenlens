...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        C01145 r1 = new View.OnClickListener() {
        ...
        C01167 r2 = new TextView.OnEditorActionListener() {
        ...
        C01178 r3 = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                SearchView.this.onItemClicked(i, 0, (String) null);
            }
        };
        this.mOnItemClickListener = r3;
        C01189 r4 = new AdapterView.OnItemSelectedListener() {
        ...
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0035R.C0038id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0035R.C0038id.search_edit_frame);
        View findViewById = findViewById(C0035R.C0038id.search_plate);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(C0035R.C0038id.submit_area);
        this.mSubmitArea = findViewById2;
        ImageView imageView = (ImageView) findViewById(C0035R.C0038id.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(C0035R.C0038id.search_go_btn);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(C0035R.C0038id.search_close_btn);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(C0035R.C0038id.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(C0035R.C0038id.search_mag_icon);
        this.mCollapsedIcon = imageView5;
        ViewCompat.setBackground(findViewById, obtainStyledAttributes.getDrawable(C0035R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, obtainStyledAttributes.getDrawable(C0035R.styleable.SearchView_submitBackground));
        int i2 = C0035R.styleable.SearchView_searchIcon;
        imageView.setImageDrawable(obtainStyledAttributes.getDrawable(i2));
        imageView2.setImageDrawable(obtainStyledAttributes.getDrawable(C0035R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(obtainStyledAttributes.getDrawable(C0035R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(obtainStyledAttributes.getDrawable(C0035R.styleable.SearchView_voiceIcon));
        ...
        TooltipCompat.setTooltipText(imageView, getResources().getString(C0035R.string.abc_searchview_description_search));
        ...
        int i3 = obtainStyledAttributes.getInt(C0035R.styleable.SearchView_android_imeOptions, -1);
        if (i3 != -1) {
            setImeOptions(i3);
        }
        int i4 = obtainStyledAttributes.getInt(C0035R.styleable.SearchView_android_inputType, -1);
        if (i4 != -1) {
            setInputType(i4);
        }
    ...
    public void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0035R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0035R.dimen.abc_dropdownitem_icon_width) : 0;
