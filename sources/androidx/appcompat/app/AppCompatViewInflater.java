...
public class AppCompatViewInflater {
    ...
    public static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context) {
            ...
            if (id == -1) {
                ...
                StringBuilder u = C0843a.m460u(" with id '");
                u.append(this.mHostView.getContext().getResources().getResourceEntryName(id));
                u.append("'");
                str = u.toString();
            }
            StringBuilder u2 = C0843a.m460u("Could not find method ");
            u2.append(this.mMethodName);
            u2.append("(View) in a parent or ancestor Context for android:onClick attribute defined on view ");
            u2.append(this.mHostView.getClass());
            u2.append(str);
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        ...
        if (z2 && resourceId == 0 && (resourceId = obtainStyledAttributes.getResourceId(C0035R.styleable.View_theme, 0)) != 0) {
