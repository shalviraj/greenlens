...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private void applyFixedSizeWindow() {
        ...
        int i = C0035R.styleable.AppCompatTheme_windowFixedWidthMajor;
        if (obtainStyledAttributes.hasValue(i)) {
            obtainStyledAttributes.getValue(i, contentFrameLayout.getFixedWidthMajor());
        }
        int i2 = C0035R.styleable.AppCompatTheme_windowFixedWidthMinor;
        if (obtainStyledAttributes.hasValue(i2)) {
            obtainStyledAttributes.getValue(i2, contentFrameLayout.getFixedWidthMinor());
        }
        int i3 = C0035R.styleable.AppCompatTheme_windowFixedHeightMajor;
        if (obtainStyledAttributes.hasValue(i3)) {
            obtainStyledAttributes.getValue(i3, contentFrameLayout.getFixedHeightMajor());
        }
        int i4 = C0035R.styleable.AppCompatTheme_windowFixedHeightMinor;
    ...
    private ViewGroup createSubDecor() {
        ViewGroup viewGroup;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0035R.styleable.AppCompatTheme);
        int i = C0035R.styleable.AppCompatTheme_windowActionBar;
        if (obtainStyledAttributes.hasValue(i)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new androidx.appcompat.view.ContextThemeWrapper(this.mContext, typedValue.resourceId) : this.mContext).inflate(C0035R.layout.abc_screen_toolbar, (ViewGroup) null);
                DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C0035R.C0038id.decor_content_parent);
            ...
            if (viewGroup != null) {
                ...
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) viewGroup.findViewById(C0035R.C0038id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0035R.C0038id.action_bar_activity_content);
            ...
            StringBuilder u = C0843a.m460u("AppCompat does not support the current theme features: { windowActionBar: ");
            u.append(this.mHasActionBar);
            u.append(", windowActionBarOverlay: ");
            u.append(this.mOverlayActionBar);
            u.append(", android:windowIsFloating: ");
            u.append(this.mIsFloating);
            u.append(", windowActionModeOverlay: ");
            u.append(this.mOverlayActionMode);
            u.append(", windowNoTitle: ");
            u.append(this.mWindowNoTitle);
            u.append(" }");
                ...
                if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
                    ...
                    if (viewGroup == null || panelFeatureState.refreshDecorView) {
                        ...
                        if (!(view == null || (layoutParams = view.getLayoutParams()) == null || layoutParams.width != -1)) {
                            ...
                            WindowManager.LayoutParams layoutParams3 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f74x, panelFeatureState.f75y, PointerIconCompat.TYPE_HAND, 8519680, -3);
                    ...
                    i = -2;
                    panelFeatureState.isHandled = false;
                    WindowManager.LayoutParams layoutParams32 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f74x, panelFeatureState.f75y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            ...
            i = C0035R.C0036color.abc_decor_view_status_guard_light;
        } else {
            context = this.mContext;
            i = C0035R.C0036color.abc_decor_view_status_guard;
        }
    ...
    public Context attachBaseContext2(@NonNull Context context) {
        ...
        try {
            ...
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, C0035R.style.Theme_AppCompat_Empty);
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(@androidx.annotation.NonNull androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        L_0x00b5:
            ...
            int r4 = androidx.appcompat.C0035R.C0038id.action_mode_bar_stub
