...
public final class TextViewCompat {
    ...
    private static int retrieveIntFromField(Field field, TextView textView) {
        try {
            ...
            StringBuilder u = C0843a.m460u("Could not retrieve value of ");
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @C0033Px @IntRange(from = 0) int i) {
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @C0033Px @IntRange(from = 0) int i) {
        Preconditions.checkArgumentNonnegative(i);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
    ...
    public static void setLineHeight(@NonNull TextView textView, @C0033Px @IntRange(from = 0) int i) {
        Preconditions.checkArgumentNonnegative(i);
