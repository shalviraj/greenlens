...
public final class ColorUtils {
    ...
    public static void RGBToHSL(@IntRange(from = 0, mo119to = 255) int i, @IntRange(from = 0, mo119to = 255) int i2, @IntRange(from = 0, mo119to = 255) int i3, @NonNull float[] fArr) {
        float f;
        float f2;
    ...
    public static void RGBToLAB(@IntRange(from = 0, mo119to = 255) int i, @IntRange(from = 0, mo119to = 255) int i2, @IntRange(from = 0, mo119to = 255) int i3, @NonNull double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = 0, mo119to = 255) int i, @IntRange(from = 0, mo119to = 255) int i2, @IntRange(from = 0, mo119to = 255) int i3, @NonNull double[] dArr) {
        double[] dArr2 = dArr;
        if (dArr2.length == 3) {
    ...
    public static double calculateContrast(@ColorInt int i, @ColorInt int i2) {
        ...
        StringBuilder u = C0843a.m460u("background can not be translucent: #");
    ...
    public static Color compositeColors(@NonNull Color color, @NonNull Color color2) {
        ...
        StringBuilder u = C0843a.m460u("Color models must match (");
        u.append(color.getModel());
        u.append(" vs. ");
        u.append(color2.getModel());
        u.append(")");
        throw new IllegalArgumentException(u.toString());
    }
    ...
    private static int compositeComponent(int i, int i2, int i3, int i4, int i5) {
        ...
        return C0843a.m462w(255, i2, i3 * i4, (i * 255) * i2) / (i5 * 255);
    }
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i, @IntRange(from = 0, mo119to = 255) int i2) {
        if (i2 >= 0 && i2 <= 255) {
