...
public class WindowInsetsCompat {
    ...
    public static class Impl20 extends Impl {
        ...
        public final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m33of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
    ...
    public static class Impl21 extends Impl20 {
        ...
        public final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m33of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    private WindowInsetsCompat(@NonNull WindowInsets windowInsets) {
        ...
        this.mImpl = i >= 29 ? new Impl29(this, windowInsets) : i >= 28 ? new Impl28(this, windowInsets) : new Impl21(this, windowInsets);
    }
    ...
    public static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return (max == i && max2 == i2 && max3 == i3 && max4 == i4) ? insets : Insets.m33of(max, max2, max3, max4);
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m33of(i, i2, i3, i4)).build();
    }

    @NonNull
    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(@NonNull Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m34of(rect)).build();
    }
