    ...
    private static void forceSetFactory2(LayoutInflater layoutInflater, LayoutInflater.Factory2 factory2) {
        if (!sCheckedField) {
            try {
                ...
                StringBuilder u = C0843a.m460u("forceSetFactory2 Could not find field 'mFactory2' on class ");
                u.append(LayoutInflater.class.getName());
                u.append("; inflation may have unexpected results.");
