...
public abstract class ActionProvider {
    ...
    public void setVisibilityListener(VisibilityListener visibilityListener) {
        if (!(this.mVisibilityListener == null || visibilityListener == null)) {
            StringBuilder u = C0843a.m460u("setVisibilityListener: Setting a new ActionProvider.VisibilityListener when one is already set. Are you reusing this ");
            u.append(getClass().getSimpleName());
            u.append(" instance while it is still in use somewhere else?");
