...
public class ShortcutInfoCompat {
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i < this.mPersons.length) {
                StringBuilder u = C0843a.m460u(EXTRA_PERSON_);
                int i2 = i + 1;
                u.append(i2);
                persistableBundle.putPersistableBundle(u.toString(), this.mPersons[i].toPersistableBundle());
                i = i2;
            }
        }
    ...
    public static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i2 < i) {
            ...
            int i3 = i2 + 1;
            u.append(i3);
            personArr[i2] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(u.toString()));
            i2 = i3;
        }
        return personArr;
    }
