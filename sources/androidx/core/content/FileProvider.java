...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public File getFileForUri(Uri uri) {
            ...
            if (file != null) {
                ...
                throw new IllegalArgumentException(C0843a.m449j("Unable to find configured root for ", uri));
            }
        }
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                throw new IllegalArgumentException(C0843a.m451l("Failed to find configured root that contains ", canonicalPath));
            } catch (IOException unused) {
    ...
    private static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(C0843a.m451l("Invalid mode: ", str));
    }
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) {
        ...
        if (resolveContentProvider != null) {
            ...
            throw new IllegalArgumentException(C0843a.m451l("Couldn't find meta-data for provider with authority ", str));
        }
    }
