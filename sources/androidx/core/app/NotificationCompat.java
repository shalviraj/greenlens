...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0201R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0201R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0201R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0201R.C0204id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0201R.C0204id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            if (!z2) {
                i = 8;
            }
            applyStandardTemplate.setViewVisibility(C0201R.C0204id.actions, i);
            applyStandardTemplate.setViewVisibility(C0201R.C0204id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0201R.layout.notification_action_tombstone : C0201R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0201R.C0204id.action_image, createColoredBitmap(action.getIconCompat(), this.mBuilder.mContext.getResources().getColor(C0201R.C0202color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0201R.C0204id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0201R.C0204id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0201R.C0204id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v3, resolved type: android.app.Person} */
        ...
        public void apply(androidx.core.app.NotificationBuilderWithBuilderAccessor r11) {
            ...
            L_0x002f:
                ...
                java.lang.Boolean r0 = r10.mIsGroupConversation
                boolean r0 = r0.booleanValue()
                r2.setGroupConversation(r0)
            L_0x003a:
                java.util.List<androidx.core.app.NotificationCompat$MessagingStyle$Message> r0 = r10.mMessages
            ...
            L_0x0040:
                ...
                goto L_0x0066
            L_0x0062:
                android.app.Person r5 = r4.toAndroidPerson()
            L_0x0066:
                r6.<init>(r7, r8, r5)
                goto L_0x0085
            L_0x006a:
                ...
                androidx.core.app.Person r4 = r3.getPerson()
                java.lang.CharSequence r5 = r4.getName()
            L_0x0078:
                android.app.Notification$MessagingStyle$Message r6 = new android.app.Notification$MessagingStyle$Message
            ...
            L_0x0085:
                ...
                java.lang.String r4 = r3.getDataMimeType()
                android.net.Uri r3 = r3.getDataUri()
                r6.setData(r4, r3)
            L_0x0096:
                r2.addMessage(r6)
                goto L_0x0040
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0201R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0201R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0201R.C0203drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0201R.C0204id.title, 8);
            remoteViews.setViewVisibility(C0201R.C0204id.text2, 8);
            remoteViews.setViewVisibility(C0201R.C0204id.text, 8);
        }
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r12, int r13, boolean r14) {
            /*
                ...
                int r13 = androidx.core.C0201R.C0204id.icon
                ...
                int r12 = r12.icon
                if (r12 == 0) goto L_0x0091
                int r12 = androidx.core.C0201R.dimen.notification_right_icon_size
                int r12 = r0.getDimensionPixelSize(r12)
                int r13 = androidx.core.C0201R.dimen.notification_small_icon_background_padding
                ...
                int r13 = androidx.core.C0201R.C0204id.right_icon
            ...
            L_0x0060:
                ...
                int r12 = r12.icon
                if (r12 == 0) goto L_0x0091
                int r12 = androidx.core.C0201R.C0204id.icon
                r7.setViewVisibility(r12, r8)
                int r13 = androidx.core.C0201R.dimen.notification_large_icon_width
                int r13 = r0.getDimensionPixelSize(r13)
                int r1 = androidx.core.C0201R.dimen.notification_big_circle_margin
                int r1 = r0.getDimensionPixelSize(r1)
                int r13 = r13 - r1
                int r1 = androidx.core.C0201R.dimen.notification_small_icon_size_as_large
                int r1 = r0.getDimensionPixelSize(r1)
            ...
            L_0x0091:
                ...
                int r13 = androidx.core.C0201R.C0204id.title
            ...
            L_0x009c:
                ...
                int r1 = androidx.core.C0201R.C0204id.text
            ...
            L_0x00ab:
                ...
                int r12 = androidx.core.C0201R.C0204id.info
            ...
            L_0x00be:
                ...
                int r12 = androidx.core.C0201R.integer.status_bar_notification_info_maxnum
                int r12 = r0.getInteger(r12)
                androidx.core.app.NotificationCompat$Builder r1 = r11.mBuilder
                int r1 = r1.mNumber
                if (r1 <= r12) goto L_0x00da
                int r12 = androidx.core.C0201R.C0204id.info
                int r1 = androidx.core.C0201R.string.status_bar_notification_info_overflow
                java.lang.String r1 = r0.getString(r1)
                r7.setTextViewText(r12, r1)
                goto L_0x00ec
            L_0x00da:
                java.text.NumberFormat r12 = java.text.NumberFormat.getIntegerInstance()
                int r1 = androidx.core.C0201R.C0204id.info
                androidx.core.app.NotificationCompat$Builder r2 = r11.mBuilder
                int r2 = r2.mNumber
                long r2 = (long) r2
            ...
            L_0x00f5:
                ...
                int r2 = androidx.core.C0201R.C0204id.text
                r7.setTextViewText(r2, r1)
                androidx.core.app.NotificationCompat$Builder r1 = r11.mBuilder
                java.lang.CharSequence r1 = r1.mContentText
                if (r1 == 0) goto L_0x0110
                int r2 = androidx.core.C0201R.C0204id.text2
                r7.setTextViewText(r2, r1)
                r7.setViewVisibility(r2, r8)
                r1 = r13
                goto L_0x0116
            L_0x0110:
                int r1 = androidx.core.C0201R.C0204id.text2
                r7.setViewVisibility(r1, r9)
            L_0x0115:
                r1 = r8
            L_0x0116:
                ...
                int r14 = androidx.core.C0201R.dimen.notification_subtext_size
                int r14 = r0.getDimensionPixelSize(r14)
                float r14 = (float) r14
                int r0 = androidx.core.C0201R.C0204id.text
                r7.setTextViewTextSize(r0, r8, r14)
            L_0x0126:
                int r2 = androidx.core.C0201R.C0204id.line1
                r3 = 0
                r4 = 0
                r5 = 0
                r6 = 0
            ...
            L_0x0130:
                ...
                int r14 = androidx.core.C0201R.C0204id.chronometer
                ...
                goto L_0x017d
            L_0x016b:
                int r14 = androidx.core.C0201R.C0204id.time
                r7.setViewVisibility(r14, r8)
                androidx.core.app.NotificationCompat$Builder r0 = r11.mBuilder
                long r0 = r0.getWhenIfShowing()
            ...
            L_0x017c:
                r13 = r10
            L_0x017d:
                int r14 = androidx.core.C0201R.C0204id.right_side
            ...
            L_0x0184:
                ...
                int r13 = androidx.core.C0201R.C0204id.line3
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            int i = C0201R.C0204id.notification_main_column;
            remoteViews.removeAllViews(i);
            remoteViews.addView(i, remoteViews2.clone());
            remoteViews.setViewVisibility(i, 0);
            remoteViews.setViewPadding(C0201R.C0204id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (action.getIcon() == null && (i = action2.icon) != 0) {
            return new Action(i, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z3, z4);
        }
