...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        public Uri getStream(int i) {
            ...
            if (arrayList != null) {
                ...
                StringBuilder u = C0843a.m460u("Stream items available: ");
                u.append(getStreamCount());
                u.append(" index requested: ");
                u.append(i);
    ...
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int i, @NonNull IntentBuilder intentBuilder) {
        ...
        throw new IllegalArgumentException(C0843a.m445f("Could not find menu item with id ", i, " in the supplied menu"));
    }
    ...
    public static void configureMenuItem(@NonNull MenuItem menuItem, @NonNull IntentBuilder intentBuilder) {
        ...
        StringBuilder u = C0843a.m460u(HISTORY_FILENAME_PREFIX);
        u.append(intentBuilder.getContext().getClass().getName());
        shareActionProvider.setShareHistoryFileName(u.toString());
