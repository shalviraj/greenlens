...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public String toString() {
            ...
            StringBuilder u = C0843a.m460u("textSize=");
            u.append(this.mPaint.getTextSize());
            sb.append(u.toString());
            sb.append(", textScaleX=" + this.mPaint.getTextScaleX());
            sb.append(", textSkewX=" + this.mPaint.getTextSkewX());
            int i = Build.VERSION.SDK_INT;
            StringBuilder u2 = C0843a.m460u(", letterSpacing=");
            u2.append(this.mPaint.getLetterSpacing());
            sb.append(u2.toString());
            sb.append(", elegantTextHeight=" + this.mPaint.isElegantTextHeight());
            sb.append(", textLocale=" + this.mPaint.getTextLocales());
            sb.append(", typeface=" + this.mPaint.getTypeface());
            if (i >= 26) {
                StringBuilder u3 = C0843a.m460u(", variationSettings=");
                u3.append(this.mPaint.getFontVariationSettings());
                sb.append(u3.toString());
            }
            StringBuilder u4 = C0843a.m460u(", textDir=");
            u4.append(this.mTextDir);
