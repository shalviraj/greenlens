...
import androidx.coordinatorlayout.C0195R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0195R.styleable.CoordinatorLayout_Layout);
            this.gravity = obtainStyledAttributes.getInteger(C0195R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0195R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0195R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0195R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = obtainStyledAttributes.getInt(C0195R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = obtainStyledAttributes.getInt(C0195R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            int i = C0195R.styleable.CoordinatorLayout_Layout_layout_behavior;
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (findViewById != null) {
                ...
                StringBuilder u = C0843a.m460u("Could not find CoordinatorLayout descendant view with id ");
                u.append(coordinatorLayout.getResources().getResourceName(this.mAnchorId));
                u.append(" to anchor view ");
                u.append(view);
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0195R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        ...
        int[] iArr = C0195R.styleable.CoordinatorLayout;
        TypedArray obtainStyledAttributes = i == 0 ? context.obtainStyledAttributes(attributeSet, iArr, 0, C0195R.style.Widget_Support_CoordinatorLayout) : context.obtainStyledAttributes(attributeSet, iArr, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            int[] iArr2 = C0195R.styleable.CoordinatorLayout;
            if (i == 0) {
                saveAttributeDataForStyleable(context, iArr2, attributeSet, obtainStyledAttributes, 0, C0195R.style.Widget_Support_CoordinatorLayout);
            } else {
                saveAttributeDataForStyleable(context, iArr2, attributeSet, obtainStyledAttributes, i, 0);
            }
        }
        int resourceId = obtainStyledAttributes.getResourceId(C0195R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = obtainStyledAttributes.getDrawable(C0195R.styleable.CoordinatorLayout_statusBarBackground);
        obtainStyledAttributes.recycle();
        setupForInsets();
    ...
    private void offsetChildByInset(View view, Rect rect, int i) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior == null || !behavior.getInsetDodgeRect(this, view, acquireTempRect)) {
                ...
                StringBuilder u = C0843a.m460u("Rect should be within the child's bounds. Rect:");
                u.append(acquireTempRect.toShortString());
                u.append(" | Bounds:");
                u.append(acquireTempRect2.toShortString());
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(C0843a.m451l("Could not inflate Behavior subclass ", str), e);
        }
    }
            ...
            if (view instanceof AttachedBehavior) {
                ...
                if (defaultBehavior != null) {
                    try {
                        ...
                        StringBuilder u = C0843a.m460u("Default behavior class ");
                        u.append(defaultBehavior.value().getName());
