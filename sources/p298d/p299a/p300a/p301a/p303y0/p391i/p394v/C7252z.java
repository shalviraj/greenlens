...
/* renamed from: d.a.a.a.y0.i.v.z */
public final class C7252z extends C7222b0<Long> {
    public C7252z(long j) {
    ...
    public C7452c0 mo24893a(C6021a0 a0Var) {
        ...
        C6046e N0 = C5266a.m9849N0(a0Var, StandardNames.FqNames.uLong);
        C7489j0 defaultType = N0 == null ? null : N0.getDefaultType();
        if (defaultType != null) {
            return defaultType;
        }
        C7489j0 d = C7570v.m13783d("Unsigned type ULong not found");
        C6888i.m12437d(d, "createErrorType(\"Unsigned type ULong not found\")");
        return d;
    }

    public String toString() {
        return ((Number) this.f14459a).longValue() + ".toULong()";
    }
}
