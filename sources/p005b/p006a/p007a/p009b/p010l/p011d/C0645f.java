...
/* renamed from: b.a.a.b.l.d.f */
public final class C0645f<T extends RecyclerView.ViewHolder> extends C0641b<T> {

    /* renamed from: g */
    public Interpolator f324g;
    ...
    public C0645f(androidx.recyclerview.widget.RecyclerView.Adapter r7, androidx.recyclerview.widget.RecyclerView r8, java.util.List r9, android.view.animation.Interpolator r10, java.lang.String r11, int r12, java.lang.String r13, int r14) {
        /*
            r6 = this;
            r9 = r14 & 4
            r3 = 0
        ...
        L_0x0013:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p005b.p006a.p007a.p009b.p010l.p011d.C0645f.<init>(androidx.recyclerview.widget.RecyclerView$Adapter, androidx.recyclerview.widget.RecyclerView, java.util.List, android.view.animation.Interpolator, java.lang.String, int, java.lang.String, int):void");
    }
    ...
    public List<Animator> mo10426a(View view) {
        ...
        if (C6888i.m12434a(this.f325h, "top")) {
        ...
        Interpolator interpolator = this.f324g;
