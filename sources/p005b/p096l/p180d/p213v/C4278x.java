...
/* renamed from: b.l.d.v.x */
public final class C4278x {

    /* renamed from: a */
    public final SharedPreferences f7924a;

    /* renamed from: b */
    public final Context f7925b;

    /* renamed from: c */
    public final C4281y0 f7926c;
    @GuardedBy("this")

    /* renamed from: d */
    public final Map<String, C4279x0> f7927d = new ArrayMap();
    ...
    public C4278x(android.content.Context r4) {
        /*
            r3 = this;
            ...
            r3.mo15875c()     // Catch:{ IOException -> 0x0054 }
            com.google.firebase.iid.FirebaseInstanceId r4 = com.google.firebase.iid.FirebaseInstanceId.m10541a()     // Catch:{ IOException -> 0x0054 }
            r4.mo22177o()     // Catch:{ IOException -> 0x0054 }
            goto L_0x007d
        L_0x0051:
            r4 = move-exception
            monitor-exit(r3)     // Catch:{ IOException -> 0x0054 }
        ...
        L_0x007d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p005b.p096l.p180d.p213v.C4278x.<init>(android.content.Context):void");
    }

    /* renamed from: a */
    public static String m7829a(String str, String str2, String str3) {
    ...
    /* renamed from: d */
    public static String m7830d(String str, String str2) {
    ...
    /* renamed from: b */
    public final synchronized String mo15874b() {
        return this.f7924a.getString("topic_operation_queue", "");
    }

    /* renamed from: c */
    public final synchronized void mo15875c() {
        this.f7927d.clear();
        for (File file : C4281y0.m7839i(this.f7925b).listFiles()) {
