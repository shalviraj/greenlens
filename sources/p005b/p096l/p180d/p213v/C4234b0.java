...
/* renamed from: b.l.d.v.b0 */
public final class C4234b0 {
    @GuardedBy("this")
    ...
    /* renamed from: b */
    public final Map<Integer, C3429i<Void>> f7833b = new ArrayMap();
    @GuardedBy("itself")

    /* renamed from: c */
    public final C4278x f7834c;

    public C4234b0(C4278x xVar) {
        this.f7834c = xVar;
    }
    ...
    @Nullable
    /* renamed from: a */
    public final String mo15818a() {
        String b;
        synchronized (this.f7834c) {
            b = this.f7834c.mo15874b();
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x005a, code lost:
        if (r10.mo22173h(r5) != false) goto L_0x0074;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x005c, code lost:
        r10.mo22170d(r10.f11443d.mo15813a(com.google.firebase.iid.FirebaseInstanceId.m10544l(), r5.f7829a, r3));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x006f, code lost:
        if (com.google.firebase.iid.FirebaseInstanceId.m10545n() == false) goto L_0x00c5;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x0082, code lost:
        if (r10.mo22173h(r5) != false) goto L_0x009f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0084, code lost:
        r10.mo22170d(r10.f11443d.mo15814b(com.google.firebase.iid.FirebaseInstanceId.m10544l(), r5.f7829a, r3));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:?, code lost:
        r2 = r9.f7833b.remove(java.lang.Integer.valueOf(r9.f7832a));
        mo15820c(r0);
        r9.f7832a++;
     */
    ...
    public final boolean mo15819b(com.google.firebase.iid.FirebaseInstanceId r10) {
        /*
            r9 = this;
        L_0x0000:
            monitor-enter(r9)
            java.lang.String r0 = r9.mo15818a()     // Catch:{ all -> 0x00ee }
            r1 = 1
            if (r0 != 0) goto L_0x0017
            boolean r10 = com.google.firebase.iid.FirebaseInstanceId.m10545n()     // Catch:{ all -> 0x00ee }
        ...
        L_0x004a:
            ...
            goto L_0x00c5
        L_0x0052:
            b.l.d.v.a0 r5 = r10.mo22176m()     // Catch:{ IOException -> 0x00a5 }
            boolean r7 = r10.mo22173h(r5)     // Catch:{ IOException -> 0x00a5 }
            if (r7 != 0) goto L_0x0074
            java.lang.String r4 = com.google.firebase.iid.FirebaseInstanceId.m10544l()     // Catch:{ IOException -> 0x00a5 }
            b.l.d.v.b r7 = r10.f11443d     // Catch:{ IOException -> 0x00a5 }
            java.lang.String r5 = r5.f7829a     // Catch:{ IOException -> 0x00a5 }
            b.l.a.c.j.h r3 = r7.mo15813a(r4, r5, r3)     // Catch:{ IOException -> 0x00a5 }
            r10.mo22170d(r3)     // Catch:{ IOException -> 0x00a5 }
            boolean r3 = com.google.firebase.iid.FirebaseInstanceId.m10545n()     // Catch:{ IOException -> 0x00a5 }
        ...
        L_0x007a:
            ...
            java.lang.String r5 = r5.f7829a     // Catch:{ IOException -> 0x00a5 }
            b.l.d.v.b r7 = r10.f11443d     // Catch:{ IOException -> 0x00a5 }
            b.l.a.c.j.h r3 = r7.mo15814b(r4, r5, r3)     // Catch:{ IOException -> 0x00a5 }
            r10.mo22170d(r3)     // Catch:{ IOException -> 0x00a5 }
            boolean r3 = com.google.firebase.iid.FirebaseInstanceId.m10545n()     // Catch:{ IOException -> 0x00a5 }
            if (r3 == 0) goto L_0x00c5
        ...
        L_0x00c9:
            monitor-enter(r9)
            java.util.Map<java.lang.Integer, b.l.a.c.j.i<java.lang.Void>> r2 = r9.f7833b     // Catch:{ all -> 0x00eb }
            int r3 = r9.f7832a     // Catch:{ all -> 0x00eb }
            java.lang.Integer r3 = java.lang.Integer.valueOf(r3)     // Catch:{ all -> 0x00eb }
            java.lang.Object r2 = r2.remove(r3)     // Catch:{ all -> 0x00eb }
            b.l.a.c.j.i r2 = (p005b.p096l.p097a.p113c.p150j.C3429i) r2     // Catch:{ all -> 0x00eb }
            r9.mo15820c(r0)     // Catch:{ all -> 0x00eb }
            int r0 = r9.f7832a     // Catch:{ all -> 0x00eb }
            int r0 = r0 + r1
            r9.f7832a = r0     // Catch:{ all -> 0x00eb }
            monitor-exit(r9)     // Catch:{ all -> 0x00eb }
            if (r2 == 0) goto L_0x0000
            r0 = 0
            b.l.a.c.j.e0<TResult> r1 = r2.f6197a
            r1.mo14695q(r0)
            goto L_0x0000
        L_0x00eb:
            r10 = move-exception
        ...
        L_0x00ee:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: p005b.p096l.p180d.p213v.C4234b0.mo15819b(com.google.firebase.iid.FirebaseInstanceId):boolean");
    }

    /* renamed from: c */
    public final synchronized boolean mo15820c(String str) {
        synchronized (this.f7834c) {
            String b = this.f7834c.mo15874b();
            if (!b.startsWith(str.length() != 0 ? ",".concat(str) : new String(","))) {
                return false;
            }
            String substring = b.substring((str.length() != 0 ? ",".concat(str) : new String(",")).length());
            C4278x xVar = this.f7834c;
            synchronized (xVar) {
                xVar.f7924a.edit().putString("topic_operation_queue", substring).apply();
            }
            return true;
        }
    }
