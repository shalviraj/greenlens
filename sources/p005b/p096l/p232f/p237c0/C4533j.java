...
/* renamed from: b.l.f.c0.j */
public final class C4533j extends C4549z {
    /* renamed from: a */
    public C4658b mo16167a(String str, C4484a aVar, int i, int i2, Map<C4613g, ?> map) {
        if (aVar == C4484a.EAN_13) {
    ...
    public boolean[] mo16166d(String str) {
        ...
        C4542s.m8358c(str);
        int i = C4532i.f8455j[Character.digit(str.charAt(0), 10)];
        ...
        for (int i2 = 1; i2 <= 6; i2++) {
            ...
            b += C4542s.m8357b(zArr, b, C4548y.f8487h[digit], false);
        }
        int b2 = C4542s.m8357b(zArr, b, C4548y.f8484e, false) + b;
        for (int i3 = 7; i3 <= 12; i3++) {
            b2 += C4542s.m8357b(zArr, b2, C4548y.f8486g[Character.digit(str.charAt(i3), 10)], true);
        }
