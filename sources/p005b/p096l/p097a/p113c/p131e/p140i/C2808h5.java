...
public enum C2808h5 {
    ...
    GROUP_LIST(49, 2, r12),
    MAP(50, 4, C3029y5.VOID);
    

    /* renamed from: g0 */
    public static final C2808h5[] f4793g0 = null;
    ...
    static {
        C2808h5[] values = values();
        f4793g0 = new C2808h5[51];
        for (int i = 0; i < 51; i++) {
            C2808h5 h5Var = values[i];
            f4793g0[h5Var.f4814g] = h5Var;
        }
    }

    /* access modifiers changed from: public */
    C2808h5(int i, int i2, C3029y5 y5Var) {
        this.f4814g = i;
        C3029y5 y5Var2 = C3029y5.VOID;
        int i3 = i2 - 1;
        if (i3 == 1 || i3 == 3) {
            Class<?> cls = y5Var.f5168g;
        }
        if (i2 == 1) {
            y5Var.ordinal();
        }
