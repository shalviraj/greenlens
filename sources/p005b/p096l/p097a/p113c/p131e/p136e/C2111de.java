...
/* renamed from: b.l.a.c.e.e.de */
public final class C2111de implements Parcelable.Creator<C2086ce> {
    public final Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < l0) {
            ...
            switch (65535 & readInt) {
                case 1:
                    yVar = (C3940y) C0823f.m392r(parcel2, readInt, C3940y.CREATOR);
                    break;
                case 2:
        ...
        return new C2086ce(yVar, str, str2, j, z, z2, str3, str4, z3);
    }

    public final /* bridge */ /* synthetic */ Object[] newArray(int i) {
        return new C2086ce[i];
    }
}
