...
/* renamed from: b.l.a.c.e.e.ph */
public final class C2408ph extends C2091cj<Object, C3900y> {

    /* renamed from: p */
    public final C2428qd f4204p;

    public C2408ph(C3859c cVar, @Nullable String str) {
        super(2);
        C0823f.m380l(cVar, "credential cannot be null");
        this.f4204p = new C2428qd(C1960d.m2771Z0(cVar, str));
    }
