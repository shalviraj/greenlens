...
/* renamed from: b.l.a.c.e.e.yg */
public final class C2623yg extends C2091cj<Object, C3900y> {

    /* renamed from: p */
    public final C2364nl f4496p;

    public C2623yg(C3859c cVar) {
        super(2);
        C0823f.m380l(cVar, "credential cannot be null");
        this.f4496p = C1960d.m2771Z0(cVar, (String) null);
    }
