...
/* renamed from: b.l.a.c.e.e.kh */
public final class C2288kh extends C2091cj<Object, C3900y> {

    /* renamed from: p */
    public final C2620yd f4019p;

    public C2288kh(C3938x xVar, @Nullable String str) {
        super(2);
        C0823f.m380l(xVar, "credential cannot be null");
        xVar.f7213k = false;
        this.f4019p = new C2620yd(xVar, str);
    }
