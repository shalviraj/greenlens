...
/* renamed from: b.l.a.c.e.e.sg */
public final class C2479sg extends C2091cj<Object, C3900y> {
    @NonNull

    /* renamed from: p */
    public final C2331mc f4288p;

    public C2479sg(String str, String str2, @Nullable String str3) {
        super(2);
        C0823f.m374i(str, "email cannot be null or empty");
        C0823f.m374i(str2, "password cannot be null or empty");
        this.f4288p = new C2331mc(str, str2, str3);
    }
