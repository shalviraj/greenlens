package p005b.p096l.p224e.p226e0.p228z.p229u;

import com.google.android.material.datepicker.UtcDates;
import java.util.TimeZone;
import p005b.p035e.p036a.p037a.C0843a;

/* renamed from: b.l.e.e0.z.u.a */
public class C4453a {

    /* renamed from: a */
    public static final TimeZone f8248a = TimeZone.getTimeZone(UtcDates.UTC);

    /* renamed from: a */
    public static boolean m8152a(String str, int i, char c) {
    ...
    public static java.util.Date m8153b(java.lang.String r17, java.text.ParsePosition r18) {
        /*
            r1 = r17
            r2 = r18
            int r0 = r18.getIndex()     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            int r3 = r0 + 4
            int r0 = m8154c(r1, r0, r3)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r4 = 45
            boolean r5 = m8152a(r1, r3, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            if (r5 == 0) goto L_0x0018
            int r3 = r3 + 1
        L_0x0018:
            int r5 = r3 + 2
            int r3 = m8154c(r1, r3, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            boolean r6 = m8152a(r1, r5, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            if (r6 == 0) goto L_0x0026
            int r5 = r5 + 1
        L_0x0026:
            int r6 = r5 + 2
            int r5 = m8154c(r1, r5, r6)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r7 = 84
            boolean r7 = m8152a(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r8 = 1
        ...
        L_0x0049:
            ...
            int r6 = r6 + 1
            int r7 = r6 + 2
            int r6 = m8154c(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r12 = 58
            boolean r13 = m8152a(r1, r7, r12)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            if (r13 == 0) goto L_0x0062
            int r7 = r7 + 1
        L_0x0062:
            int r13 = r7 + 2
            int r7 = m8154c(r1, r7, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            boolean r12 = m8152a(r1, r13, r12)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
        ...
        L_0x0070:
            ...
            int r4 = r13 + 2
            int r12 = m8154c(r1, r13, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r13 = 59
        ...
        L_0x0090:
            r13 = 46
            boolean r13 = m8152a(r1, r4, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
        ...
        L_0x00b6:
            ...
            int r15 = m8154c(r1, r4, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            int r14 = r14 - r4
        ...
        L_0x00db:
            ...
            java.util.TimeZone r9 = f8248a     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            int r4 = r4 + r8
            goto L_0x0197
        L_0x00ed:
        ...
        L_0x0213:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p005b.p096l.p224e.p226e0.p228z.p229u.C4453a.m8153b(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    /* renamed from: c */
    public static int m8154c(String str, int i, int i2) {
        int i3;
        int i4;
        ...
        if (i < i2) {
            ...
            if (digit >= 0) {
                ...
                StringBuilder u = C0843a.m460u("Invalid number: ");
                u.append(str.substring(i, i2));
        ...
        while (i4 < i2) {
            ...
            if (digit2 >= 0) {
                ...
                StringBuilder u2 = C0843a.m460u("Invalid number: ");
                u2.append(str.substring(i, i2));
