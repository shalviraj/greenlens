...
/* renamed from: b.o.f0 */
public class C4833f0 {

    /* renamed from: a */
    public static final Pattern f9284a = Pattern.compile("^([A-Fa-f0-9]{8})$");
    ...
    public static java.lang.String m8851a(android.content.Context r9, android.app.NotificationManager r10, org.json.JSONObject r11) {
        /*
        ...
        L_0x0099:
            ...
            java.util.regex.Pattern r1 = f9284a
            ...
            p005b.p273o.C4857i2.m8933a(r0, r1, r5)
        ...
        L_0x00c9:
            r0 = move-exception
            b.o.i2$k r1 = p005b.p273o.C4857i2.C4868k.ERROR
            java.lang.String r3 = "Couldn't convert ARGB Hex value to BigInteger:"
            p005b.p273o.C4857i2.m8933a(r1, r3, r0)
        L_0x00d1:
        ...
        L_0x00dc:
            ...
            long[] r0 = p005b.p273o.C4835f2.m8870t(r11)
            if (r0 == 0) goto L_0x00f0
        ...
        L_0x00fb:
            ...
            android.net.Uri r9 = p005b.p273o.C4835f2.m8857g(r9, r0)
        ...
        L_0x0147:
            r4.setBypassDnd(r7)
            b.o.i2$k r9 = p005b.p273o.C4857i2.C4868k.VERBOSE
            ...
            p005b.p273o.C4857i2.m8933a(r9, r11, r5)
        ...
        L_0x0168:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p005b.p273o.C4833f0.m8851a(android.content.Context, android.app.NotificationManager, org.json.JSONObject):java.lang.String");
    }

    /* renamed from: b */
    public static String m8852b(C4849h0 h0Var) {
        if (Build.VERSION.SDK_INT < 26) {
            return "fcm_fallback_notification_channel";
        }
        Context context = h0Var.f9311a;
        JSONObject jSONObject = h0Var.f9312b;
        NotificationManager h = C4805c3.m8809h(context);
        if (h0Var.f9313c) {
            h.createNotificationChannel(new NotificationChannel("restored_OS_notifications", "Restored", 2));
            return "restored_OS_notifications";
        }
        if (jSONObject.has("oth_chnl")) {
            String optString = jSONObject.optString("oth_chnl");
            if (h.getNotificationChannel(optString) != null) {
                return optString;
            }
        }
        ...
        try {
            return m8851a(context, h, jSONObject);
