...
import p005b.p006a.p007a.p021l.C0791f;
...
public class OAuthDialogFragment extends DialogFragmentCompat {
    ...
    public static void access$000(OAuthDialogFragment oAuthDialogFragment, String str, View view, int i) {
        ...
        if (view != null) {
            ...
            if (callback != null && (callback instanceof ProgressBar)) {
                ...
                ((ProgressBar) callback).setProgress(i);
            }
            if (i == 100) {
                i2 = 8;
            }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        if (webView != null) {
            ...
            if (severalScopes) {
                try {
                    String str = ((C0791f) this.mController).f582a.f570g;
        ...
        if (findViewById == null) {
            ...
            webView.setWebChromeClient(new WebChromeClient() {
                public void onProgressChanged(WebView webView, int i) {
                    ...
                    if (i != 0 && i != 100) {
                        OAuthDialogFragment.access$000(OAuthDialogFragment.this, webView.getUrl(), OAuthDialogFragment.this.getView(), i);
                    }
                }
            });
                ...
                public final boolean interceptUrlCompat(WebView webView, String str, boolean z) {
                    ...
                    if (fragment != null ? fragment.isAdded() : oAuthDialogFragment2.nativeFragment.isAdded()) {
                        ...
                        if (!(fragment2 != null ? fragment2.isRemoving() : oAuthDialogFragment3.nativeFragment.isRemoving()) && (authorizationDialogController = oAuthDialogFragment.mController) != null) {
                            try {
                                String str2 = ((C0791f) authorizationDialogController).f582a.f570g;
                                ...
                                if (OAuthDialogFragment.isRedirectUriFound(str, str2)) {
                                    if (TextUtils.equals(string, "10a")) {
                                        ...
                                        try {
                                            ...
                                            ((DialogFragmentController) OAuthDialogFragment.this.mController).set(authorizationCodeResponseUrl.mo22100b(), error, (ImplicitResponseUrl) null, true);
                                        ...
                                        if (!TextUtils.isEmpty(error2) && !TextUtils.isEmpty(implicitResponseUrl.getErrorDescription())) {
                                            StringBuilder y = C0843a.m464y(error2, ": ");
                                            y.append(implicitResponseUrl.getErrorDescription());
                                            error2 = y.toString();
                                        }
