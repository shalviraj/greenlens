...
public abstract class DialogFragmentController implements AuthorizationDialogController {
    ...
    public void requestAuthorization(final C3658b bVar) {
        this.uiHandler.post(new Runnable() {
            public void run() {
                ...
                if (!fragmentManager.isDestroyed()) {
                    ...
                    bundle.putString("authType", cVar instanceof OAuthAuthorizeTemporaryTokenUrl ? "10a" : cVar instanceof C3658b ? "explicit" : "implicit");
    ...
    public void requestAuthorization(final C3661d dVar) {
        this.uiHandler.post(new Runnable() {
            public void run() {
                OAuthDialogFragment oAuthDialogFragment;
                DialogFragmentCompat.NativeDialogFragmentImpl nativeDialogFragmentImpl;
