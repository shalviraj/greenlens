...
public class WebhookIntegration extends Integration<Void> {
    ...
    public static class WebhookIntegrationFactory implements Integration.Factory {
        ...
        public String key() {
            StringBuilder u = C0843a.m460u("webhook_");
            u.append(this.key);
            return u.toString();
        }
    }
        ...
        this.networkExecutor.submit(new Runnable() {
            ...
            public void run() {
                ...
                L_0x00c2:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.segment.analytics.WebhookIntegration.C58291.run():void");
            }
        });
    }
