...
public abstract class IntegrationOperation {
    ...
    /* renamed from: com.segment.analytics.IntegrationOperation$11 */
    public static /* synthetic */ class C581511 {
        ...
        static {
            ...
            L_0x0029:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.segment.analytics.IntegrationOperation.C581511.<clinit>():void");
        }
    }
                ...
                IntegrationOperation.runMiddlewareChain(basePayload, IntegrationOperation.getMiddlewareList(map, str), new Middleware.Callback() {
                    public void invoke(BasePayload basePayload) {
                        ...
                        if (ordinal == 0) {
                            ...
                            StringBuilder u = C0843a.m460u("unknown type ");
                            u.append(basePayload.type());
