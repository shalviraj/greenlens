...
public class MiscUtils {
    ...
    public static double lerp(double d, double d2, @FloatRange(from = 0.0d, mo101to = 1.0d) double d3) {
        return ((d2 - d) * d3) + d;
    }

    public static float lerp(float f, float f2, @FloatRange(from = 0.0d, mo101to = 1.0d) float f3) {
        return C0843a.m440a(f2, f, f3, f);
    }

    public static int lerp(int i, int i2, @FloatRange(from = 0.0d, mo101to = 1.0d) float f) {
