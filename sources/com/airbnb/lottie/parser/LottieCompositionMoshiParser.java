...
public class LottieCompositionMoshiParser {
    public static JsonReader.Options ASSETS_NAMES = JsonReader.Options.m10110of(AnalyticsContext.Device.DEVICE_ID_KEY, "layers", "w", C0866h.f730g, "p", "u");
    private static final JsonReader.Options FONT_NAMES = JsonReader.Options.m10110of("list");
    private static final JsonReader.Options MARKER_NAMES = JsonReader.Options.m10110of("cm", "tm", "dr");
    private static final JsonReader.Options NAMES = JsonReader.Options.m10110of("w", C0866h.f730g, "ip", "op", "fr", "v", "layers", "assets", "fonts", "chars", "markers");
