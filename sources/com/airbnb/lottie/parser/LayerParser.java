...
import p005b.p096l.p097a.p113c.p131e.p136e.C2093cl;

public class LayerParser {
    private static final JsonReader.Options EFFECTS_NAMES = JsonReader.Options.m10110of("nm");
    private static final JsonReader.Options NAMES = JsonReader.Options.m10110of("nm", "ind", "refId", "ty", "parent", "sw", "sh", "sc", "ks", "tt", "masksProperties", "shapes", "t", "ef", "sr", "st", "w", C0866h.f730g, "ip", "op", "tm", C2093cl.f3691h, "hd");
    private static final JsonReader.Options TEXT_NAMES = JsonReader.Options.m10110of("d", "a");

    /* renamed from: com.airbnb.lottie.parser.LayerParser$1 */
    public static /* synthetic */ class C53721 {
        ...
        static {
            ...
            L_0x0016:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.parser.LayerParser.C53721.<clinit>():void");
        }
    }
