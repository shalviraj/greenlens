...
public final class JsonUtf8Reader extends JsonReader {
    private static final C8044h CLOSING_BLOCK_COMMENT = C8044h.m14839k("*/");
    private static final C8044h DOUBLE_QUOTE_OR_SLASH = C8044h.m14839k("\"\\");
    private static final C8044h LINEFEED_OR_CARRIAGE_RETURN = C8044h.m14839k("\n\r");
    ...
    private static final C8044h SINGLE_QUOTE_OR_SLASH = C8044h.m14839k("'\\");
    private static final C8044h UNQUOTED_STRING_TERMINALS = C8044h.m14839k("{}[]:, \n\t\r\f/\\;#=");
    private final C8040e buffer;
    private int peeked = 0;
    private long peekedLong;
    private int peekedNumberLength;
    @Nullable
    private String peekedString;
    private final C8043g source;

    public JsonUtf8Reader(C8043g gVar) {
        Objects.requireNonNull(gVar, "source == null");
        this.source = gVar;
        this.buffer = gVar.mo25900a();
        pushScope(6);
    }
    ...
    private int doPeek() {
        ...
        L_0x0044:
            ...
            n.g r1 = r0.source
            r14 = 1
            boolean r1 = r1.mo25935t(r14)
            if (r1 == 0) goto L_0x009a
            n.e r1 = r0.buffer
            byte r1 = r1.mo25891N(r4)
            r2 = 62
            if (r1 != r2) goto L_0x009a
            n.e r1 = r0.buffer
            r1.readByte()
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0039, code lost:
        if (r6.source.mo25935t(2) != false) goto L_0x003c;
     */
    ...
    private int nextNonWhitespace(boolean r7) {
        ...
        L_0x0002:
            ...
            int r3 = r1 + 1
            long r4 = (long) r3
            boolean r2 = r2.mo25935t(r4)
            if (r2 == 0) goto L_0x007f
            n.e r2 = r6.buffer
            long r4 = (long) r1
            byte r1 = r2.mo25891N(r4)
            r2 = 10
    ...
    private String nextQuotedValue(C8044h hVar) {
        StringBuilder sb = null;
        while (true) {
            long P = this.source.mo25893P(hVar);
            if (P == -1) {
                throw syntaxError("Unterminated string");
            } else if (this.buffer.mo25891N(P) == 92) {
                if (sb == null) {
                    sb = new StringBuilder();
                }
                sb.append(this.buffer.mo25921o0(P));
                this.buffer.readByte();
                sb.append(readEscapeCharacter());
            } else {
                String o0 = this.buffer.mo25921o0(P);
                if (sb == null) {
                    this.buffer.readByte();
                    return o0;
                }
    ...
    private String nextUnquotedValue() {
        long P = this.source.mo25893P(UNQUOTED_STRING_TERMINALS);
        return P != -1 ? this.buffer.mo25921o0(P) : this.buffer.mo25919n0();
    }
    ...
    private int peekKeyword() {
        ...
        while (i2 < length) {
            int i3 = i2 + 1;
            if (!this.source.mo25935t((long) i3)) {
                return 0;
            }
            byte N2 = this.buffer.mo25891N((long) i2);
            if (N2 != str2.charAt(i2) && N2 != str.charAt(i2)) {
                return 0;
            }
            i2 = i3;
        }
        if (this.source.mo25935t((long) (length + 1)) && isLiteral(this.buffer.mo25891N((long) length))) {
            return 0;
        }
    ...
    private char readEscapeCharacter() {
        ...
        if (this.source.mo25935t(1)) {
            ...
            if (readByte != 117) {
                ...
                throw syntaxError(u.toString());
            } else if (this.source.mo25935t(4)) {
                char c = 0;
                for (int i3 = 0; i3 < 4; i3++) {
                    byte N = this.buffer.mo25891N((long) i3);
                    char c2 = (char) (c << 4);
                    if (N < 48 || N > 57) {
                        if (N >= 97 && N <= 102) {
                            i2 = N - 97;
                            ...
                            u2.append(this.buffer.mo25921o0(4));
                            throw syntaxError(u2.toString());
                        } else {
                            i2 = N - 65;
                        }
                        i = i2 + 10;
    ...
    private void skipQuotedValue(C8044h hVar) {
        while (true) {
            long P = this.source.mo25893P(hVar);
            if (P == -1) {
                throw syntaxError("Unterminated string");
    ...
    private boolean skipToEndOfBlockComment() {
        long j;
        C8043g gVar = this.source;
        C8044h hVar = CLOSING_BLOCK_COMMENT;
        long C = gVar.mo25885C(hVar);
        boolean z = C != -1;
        C8040e eVar = this.buffer;
        if (z) {
            j = C + ((long) hVar.mo25959l());
        } else {
            j = eVar.f16140h;
        }
        eVar.skip(j);
    ...
    private void skipToEndOfLine() {
        long P = this.source.mo25893P(LINEFEED_OR_CARRIAGE_RETURN);
        C8040e eVar = this.buffer;
        eVar.skip(P != -1 ? P + 1 : eVar.f16140h);
    }
    ...
    public double nextDouble() {
        ...
        L_0x0033:
            ...
            n.h r0 = DOUBLE_QUOTE_OR_SLASH
            goto L_0x0040
        L_0x003a:
            r1 = 8
            if (r0 != r1) goto L_0x0045
            n.h r0 = SINGLE_QUOTE_OR_SLASH
        L_0x0040:
    ...
    public int nextInt() {
        ...
        if (i == 16) {
            ...
            u.append(this.peekedLong);
            u.append(" at path ");
            u.append(getPath());
            throw new JsonDataException(u.toString());
        }
        if (i == 17) {
            this.peekedString = this.buffer.mo25921o0((long) this.peekedNumberLength);
        } else if (i == 9 || i == 8) {
    ...
    public String nextString() {
        ...
        if (i == 10) {
            ...
            if (i == 9) {
                ...
                str = this.buffer.mo25921o0((long) this.peekedNumberLength);
            } else {
    ...
    public int selectName(JsonReader.Options options) {
        ...
        int m0 = this.source.mo25917m0(options.doubleQuoteSuffix);
        if (m0 != -1) {
            this.peeked = 0;
            this.pathNames[this.stackSize - 1] = options.strings[m0];
            return m0;
        }
    ...
    public void skipName() {
        ...
        StringBuilder u2 = C0843a.m460u("Cannot skip unexpected ");
        u2.append(peek());
        u2.append(" at ");
        u2.append(getPath());
        throw new JsonDataException(u2.toString());
    ...
    public void skipValue() {
        ...
        StringBuilder u4 = C0843a.m460u("Cannot skip unexpected ");
        u4.append(peek());
        u4.append(" at ");
        u4.append(getPath());
        throw new JsonDataException(u4.toString());
