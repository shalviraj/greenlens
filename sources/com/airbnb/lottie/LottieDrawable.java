...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public LottieDrawable() {
        ...
        C53371 r3 = new ValueAnimator.AnimatorUpdateListener() {
    ...
    public void draw(@NonNull Canvas canvas) {
        this.isDirty = false;
        C5312L.beginSection("Drawable#draw");
        if (this.safeMode) {
            try {
                drawInternal(canvas);
            } catch (Throwable th) {
        ...
        C5312L.endSection("Drawable#draw");
    }
    ...
    public void setAlpha(@IntRange(from = 0, mo119to = 255) int i) {
        this.alpha = i;
        invalidateSelf();
    }
    ...
    public void setMaxFrame(final String str) {
        ...
        throw new IllegalArgumentException(C0843a.m452m("Cannot find marker with name ", str, "."));
    }

    public void setMaxProgress(@FloatRange(from = 0.0d, mo101to = 1.0d) final float f) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() {
                public void run(LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final String str, final String str2, final boolean z) {
        ...
        if (marker != null) {
            ...
            throw new IllegalArgumentException(C0843a.m452m("Cannot find marker with name ", str2, "."));
        }
        throw new IllegalArgumentException(C0843a.m452m("Cannot find marker with name ", str, "."));
    }

    public void setMinAndMaxProgress(@FloatRange(from = 0.0d, mo101to = 1.0d) final float f, @FloatRange(from = 0.0d, mo101to = 1.0d) final float f2) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() {
                public void run(LottieComposition lottieComposition) {
    ...
    public void setProgress(@FloatRange(from = 0.0d, mo101to = 1.0d) final float f) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() {
                public void run(LottieComposition lottieComposition) {
