    ...
    public static class SSLContextBuilder {
        ...
        public javax.net.ssl.SSLContext build() {
            ...
            L_0x0023:
                ...
                n.e r8 = new n.e     // Catch:{ GeneralSecurityException -> 0x006c, IOException -> 0x0062 }
                r8.<init>()     // Catch:{ GeneralSecurityException -> 0x006c, IOException -> 0x0062 }
                n.h r7 = p435n.C8044h.m14838e(r7)     // Catch:{ GeneralSecurityException -> 0x006c, IOException -> 0x0062 }
                r8.mo25933s0(r7)     // Catch:{ GeneralSecurityException -> 0x006c, IOException -> 0x0062 }
                n.e$a r7 = new n.e$a     // Catch:{ GeneralSecurityException -> 0x006c, IOException -> 0x0062 }
    ...
    public SSLSocketFactory getPinnedCertSslSocketFactory(SSLContextBuilder sSLContextBuilder) {
        ...
        if (this.sslSocketFactory == null) {
            try {
                ...
                logger.mo18153i(TAG, "Pinning SSL session using Comodo CA Cert");
            } catch (Exception e) {
                logger.mo18151e(TAG, e.getMessage(), e);
            }
        }
            ...
            public void run() {
                if (!this.initializedSSLSocketFactory) {
                    ...
                    if (pinnedCertSslSocketFactory != null) {
                        ...
                        C6888i.m12438e(pinnedCertSslSocketFactory, "sslSocketFactory");
                        C6888i.m12434a(pinnedCertSslSocketFactory, aVar.f15493n);
                        aVar.f15493n = pinnedCertSslSocketFactory;
                        C7976h.C7977a aVar2 = C7976h.f16015c;
                        X509TrustManager o = C7976h.f16013a.mo25756o(pinnedCertSslSocketFactory);
                        if (o != null) {
                            aVar.f15494o = o;
                            C7976h hVar = C7976h.f16013a;
                            X509TrustManager x509TrustManager = aVar.f15494o;
                            C6888i.m12436c(x509TrustManager);
                            aVar.f15499t = hVar.mo25752b(x509TrustManager);
                            pinnedAmplitudeClient.httpClient = new C7831c0(aVar);
                        } else {
                            StringBuilder u = C0843a.m460u("Unable to extract the trust manager on ");
                            u.append(C7976h.f16013a);
                            u.append(", ");
                            u.append("sslSocketFactory is ");
                            u.append(pinnedCertSslSocketFactory.getClass());
                            throw new IllegalStateException(u.toString());
                        }
                    } else {
                        PinnedAmplitudeClient.logger.mo18150e(PinnedAmplitudeClient.TAG, "Unable to pin SSL as requested. Will send data without SSL pinning.");
                    }
