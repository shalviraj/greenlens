...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private synchronized long addEventToTable(String str, String str2) {
        ...
        try {
            ...
            if (j == -1) {
                try {
                    logger.mo18161w(TAG, String.format("Insert into %s failed", new Object[]{str}));
                } catch (SQLiteException e3) {
                    e = e3;
                } catch (StackOverflowError e4) {
                    e2 = e4;
                    try {
                        logger.mo18151e(TAG, String.format("addEvent to %s failed", new Object[]{str}), e2);
            ...
            e = e5;
            j = -1;
            logger.mo18151e(TAG, String.format("addEvent to %s failed", new Object[]{str}), e);
    ...
    private void delete() {
        ...
        L_0x0035:
            ...
            r7.mo18151e(r2, r1, r6)     // Catch:{ all -> 0x0033 }
        ...
        L_0x0069:
            ...
            r7.mo18151e(r2, r8, r6)     // Catch:{ all -> 0x0067 }
        ...
        L_0x009a:
            ...
            r7.mo18151e(r2, r1, r6)     // Catch:{ all -> 0x0098 }
        ...
        L_0x00f1:
            ...
            r8.mo18151e(r2, r1, r7)     // Catch:{ all -> 0x00ef }
    ...
    private static String getDatabaseName(String str) {
        return (Utils.isEmptyString(str) || str.equals(Constants.DEFAULT_INSTANCE)) ? "com.amplitude.api" : C0843a.m451l("com.amplitude.api_", str);
    }
    ...
    private synchronized long getEventCountFromTable(String str) {
        ...
        try {
            ...
            logger.mo18151e(TAG, String.format("getNumberRows for %s failed", new Object[]{str}), e);
            ...
            try {
                logger.mo18151e(TAG, String.format("getNumberRows for %s failed", new Object[]{str}), e2);
    ...
    private synchronized long getNthEventIdFromTable(String str, long j) {
        ...
        try {
            ...
            try {
                ...
                logger.mo18163w(TAG, (Throwable) e);
            }
            if (sQLiteStatement != null) {
                sQLiteStatement.close();
            }
        } catch (SQLiteException e2) {
            logger.mo18151e(TAG, String.format("getNthEventId from %s failed", new Object[]{str}), e2);
            ...
            try {
                logger.mo18151e(TAG, String.format("getNthEventId from %s failed", new Object[]{str}), e3);
    ...
    private synchronized void removeEventFromTable(String str, long j) {
        try {
            ...
            logger.mo18151e(TAG, String.format("removeEvent from %s failed", new Object[]{str}), e);
            Diagnostics.getLogger().logError(String.format("DB: Failed to removeEvent from table %s", new Object[]{str}), e);
            delete();
        } catch (StackOverflowError e2) {
            try {
                logger.mo18151e(TAG, String.format("removeEvent from %s failed", new Object[]{str}), e2);
    ...
    private synchronized void removeEventsFromTable(String str, long j) {
        try {
            ...
            logger.mo18151e(TAG, String.format("removeEvents from %s failed", new Object[]{str}), e);
            Diagnostics.getLogger().logError(String.format("DB: Failed to removeEvents from table %s", new Object[]{str}), e);
            delete();
        } catch (StackOverflowError e2) {
            try {
                logger.mo18151e(TAG, String.format("removeEvents from %s failed", new Object[]{str}), e2);
    ...
    public synchronized long deleteKeyFromTable(String str, String str2) {
        ...
        try {
            ...
            logger.mo18151e(TAG, String.format("deleteKey from %s failed", new Object[]{str}), e);
            ...
            try {
                logger.mo18151e(TAG, String.format("deleteKey from %s failed", new Object[]{str}), e2);
    ...
    public synchronized java.util.List<org.json.JSONObject> getEventsFromTable(java.lang.String r19, long r20, long r22) {
        ...
        L_0x00c9:
            ...
            r1.mo18151e(r2, r3, r0)     // Catch:{ all -> 0x0090 }
            com.amplitude.api.Diagnostics r1 = com.amplitude.api.Diagnostics.getLogger()     // Catch:{ all -> 0x0090 }
            java.lang.String r2 = "DB: Failed to getEventsFromTable %s"
            java.lang.Object[] r3 = new java.lang.Object[r15]     // Catch:{ all -> 0x0090 }
            r3[r14] = r19     // Catch:{ all -> 0x0090 }
    ...
    public synchronized java.lang.Object getValueFromTable(java.lang.String r14, java.lang.String r15) {
        ...
        L_0x0089:
            ...
            r5.mo18151e(r6, r14, r4)     // Catch:{ all -> 0x00e4 }
    ...
    public synchronized long insertOrReplaceKeyValueToTable(SQLiteDatabase sQLiteDatabase, String str, String str2, Object obj) {
        ...
        if (insertKeyValueContentValuesIntoTable == -1) {
            logger.mo18161w(TAG, "Insert failed");
        }
    ...
    public synchronized long insertOrReplaceKeyValueToTable(java.lang.String r8, java.lang.String r9, java.lang.Object r10) {
        ...
        L_0x001a:
            ...
            r3.mo18151e(r4, r8, r10)     // Catch:{ all -> 0x0018 }
    ...
    public void onCreate(SQLiteDatabase sQLiteDatabase) {
        ...
        if (databaseResetListener2 != null && this.callResetListenerOnDatabaseReset) {
            try {
                ...
                logger.mo18151e(TAG, String.format("databaseReset callback failed during onCreate", new Object[0]), e);
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (i > i2) {
            logger.mo18150e(TAG, "onUpgrade() with invalid oldVersion and newVersion");
            ...
            if (i == 1) {
                ...
                if (i != 3) {
                    ...
                    amplitudeLog.mo18150e(TAG, "onUpgrade() with unknown oldVersion " + i);
                    resetDatabase(sQLiteDatabase);
                    return;
                }
                return;
