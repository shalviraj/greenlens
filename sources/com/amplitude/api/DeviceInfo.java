...
public class DeviceInfo {
    ...
    public class CachedInfo {
        ...
        private boolean checkGPSEnabled() {
            try {
                Integer num = (Integer) Class.forName("b.l.a.c.b.h").getMethod("isGooglePlayServicesAvailable", new Class[]{Context.class}).invoke((Object) null, new Object[]{DeviceInfo.this.context});
                return num != null && num.intValue() == 0;
            } catch (ClassNotFoundException | NoClassDefFoundError e) {
                AmplitudeLog.getLogger().mo18161w(DeviceInfo.TAG, "Google Play Services Util not found!");
                Diagnostics.getLogger().logError("Failed to check GPS enabled", e);
                return false;
            } catch (IllegalAccessException | NoSuchMethodException | InvocationTargetException e2) {
                e = e2;
                AmplitudeLog.getLogger().mo18161w(DeviceInfo.TAG, "Google Play Services not available");
                Diagnostics.getLogger().logError("Failed to check GPS enabled", e);
                return false;
            } catch (Exception e3) {
                e = e3;
                AmplitudeLog logger = AmplitudeLog.getLogger();
                logger.mo18161w(DeviceInfo.TAG, "Error when checking for Google Play Services: " + e);
                Diagnostics.getLogger().logError("Failed to check GPS enabled", e);
                return false;
            }
        }
        ...
        private String getAndCacheGoogleAdvertisingId() {
            ...
            try {
                ...
                amplitudeLog.mo18161w(DeviceInfo.TAG, str);
                ...
                e = e3;
                AmplitudeLog.getLogger().mo18151e(DeviceInfo.TAG, "Encountered an error connecting to Google Play Services", e);
                Diagnostics.getLogger().logError("Failed to get ADID", e);
                return this.advertisingId;
            }
            return this.advertisingId;
        ...
        private String getCountryFromLocation() {
            ...
            if (DeviceInfo.this.isLocationListening() && (mostRecentLocation = DeviceInfo.this.getMostRecentLocation()) != null) {
                ...
                } catch (IOException | IllegalArgumentException | IllegalStateException | NoSuchMethodError | NullPointerException e) {
