...
public class AmplitudeClient {
    ...
    public static boolean upgradePrefs(Context context2, String str, String str2) {
        ...
        try {
            ...
            logger.mo18153i(TAG, "Upgraded shared preferences from " + str3 + " to " + str4);
            return true;
        } catch (Exception e) {
            logger.mo18151e(TAG, "Error upgrading shared preferences", e);
    ...
    public static boolean upgradeSharedPrefsToDB(Context context2, String str) {
        ...
        SharedPreferences sharedPreferences = context2.getSharedPreferences(y.toString(), 0);
    ...
    public synchronized boolean contextAndApiKeySet(String str) {
        if (this.context == null) {
            ...
            amplitudeLog.mo18150e(TAG, "context cannot be null, set context with initialize() before calling " + str);
            return false;
        } else if (!Utils.isEmptyString(this.apiKey)) {
            return true;
        } else {
            AmplitudeLog amplitudeLog2 = logger;
            amplitudeLog2.mo18150e(TAG, "apiKey cannot be null or empty, set apiKey with initialize() before calling " + str);
            return false;
        }
    }
    ...
    public synchronized AmplitudeClient initialize(Context context2, String str, String str2, String str3, boolean z) {
        if (context2 == null) {
            logger.mo18150e(TAG, "Argument context cannot be null in initialize()");
            return this;
        } else if (Utils.isEmptyString(str)) {
            logger.mo18150e(TAG, "Argument apiKey cannot be null or blank in initialize()");
            return this;
        } else {
                ...
                public void run() {
                    ...
                    if (!amplitudeClient.initialized) {
                        try {
                            ...
                            AmplitudeClient.this.httpClient = new C7831c0(new C7831c0.C7832a());
                            ...
                            long j = amplitudeClient5.previousSessionId;
                            if (j >= 0) {
                                amplitudeClient5.sessionId = j;
                            }
                            ...
                            AmplitudeClient.logger.mo18150e(AmplitudeClient.TAG, String.format("Failed to initialize Amplitude SDK due to: %s", new Object[]{e.getMessage()}));
    ...
    public long logEvent(String str, JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, JSONObject jSONObject5, long j, boolean z) {
        ...
        long j2 = j;
        AmplitudeLog amplitudeLog = logger;
        amplitudeLog.mo18148d(TAG, "Logged event to Amplitude: " + str3);
        if (this.optOut) {
            return -1;
        }
        ...
        try {
            ...
            jSONObject10.put(BasePayload.TIMESTAMP_KEY, j2);
            ...
            if (!this.trackingOptions.shouldTrackLatLng() || (mostRecentLocation = this.deviceInfo.getMostRecentLocation()) == null) {
                ...
                try {
                    ...
                    e = e;
                    logger.mo18150e(str2, String.format("JSON Serialization of event type %s failed, skipping: %s", new Object[]{str3, e.toString()}));
    ...
    public void makeEventUploadPostRequest(p421m.C7831c0 r10, java.lang.String r11, long r12, long r14) {
        /*
            r9 = this;
            java.lang.String r0 = "com.amplitude.api.AmplitudeClient"
            java.lang.String r1 = "2"
            java.lang.String r2 = ""
            java.lang.StringBuilder r3 = p005b.p035e.p036a.p037a.C0843a.m460u(r2)
        ...
        L_0x0053:
            ...
            r4.mo25830a(r11, r2)
            m.v r11 = new m.v
            java.util.List<java.lang.String> r1 = r4.f16088a
            java.util.List<java.lang.String> r2 = r4.f16089b
            r11.<init>(r1, r2)
            r1 = 0
            m.e0$a r2 = new m.e0$a     // Catch:{ IllegalArgumentException -> 0x018c }
            r2.<init>()     // Catch:{ IllegalArgumentException -> 0x018c }
            java.lang.String r3 = r9.url     // Catch:{ IllegalArgumentException -> 0x018c }
            r2.mo25540f(r3)     // Catch:{ IllegalArgumentException -> 0x018c }
            r2.mo25538d(r11)     // Catch:{ IllegalArgumentException -> 0x018c }
            m.e0 r11 = r2.mo25535a()     // Catch:{ IllegalArgumentException -> 0x018c }
            r2 = 1
            m.f r10 = r10.mo25525a(r11)     // Catch:{ ConnectException -> 0x0177, UnknownHostException -> 0x0175, IOException -> 0x0169, AssertionError -> 0x015f, Exception -> 0x015d }
            m.m0.g.e r10 = (p421m.p422m0.p426g.C7887e) r10     // Catch:{ ConnectException -> 0x0177, UnknownHostException -> 0x0175, IOException -> 0x0169, AssertionError -> 0x015f, Exception -> 0x015d }
            m.h0 r10 = r10.mo25623h()     // Catch:{ ConnectException -> 0x0177, UnknownHostException -> 0x0175, IOException -> 0x0169, AssertionError -> 0x015f, Exception -> 0x015d }
            m.j0 r11 = r10.f15555m     // Catch:{ ConnectException -> 0x0177, UnknownHostException -> 0x0175, IOException -> 0x0169, AssertionError -> 0x015f, Exception -> 0x015d }
            java.lang.String r11 = r11.mo25572z()     // Catch:{ ConnectException -> 0x0177, UnknownHostException -> 0x0175, IOException -> 0x0169, AssertionError -> 0x015f, Exception -> 0x015d }
        ...
        L_0x00c6:
            ...
            r10.mo18150e(r0, r11)     // Catch:{ ConnectException -> 0x0177, UnknownHostException -> 0x0175, IOException -> 0x0169, AssertionError -> 0x015f, Exception -> 0x015d }
            goto L_0x015b
        L_0x00d7:
        ...
        L_0x00e5:
            ...
            goto L_0x0158
        L_0x00f2:
            int r10 = r10.f15552j     // Catch:{ ConnectException -> 0x0177, UnknownHostException -> 0x0175, IOException -> 0x0169, AssertionError -> 0x015f, Exception -> 0x015d }
        ...
        L_0x0114:
            ...
            r10.mo18161w((java.lang.String) r0, (java.lang.String) r11)     // Catch:{ ConnectException -> 0x0177, UnknownHostException -> 0x0175, IOException -> 0x0169, AssertionError -> 0x015f, Exception -> 0x015d }
        ...
        L_0x018c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amplitude.api.AmplitudeClient.makeEventUploadPostRequest(m.c0, java.lang.String, long, long):void");
    }
    ...
    public Pair<Pair<Long, Long>, JSONArray> mergeEventsAndIdentifys(List<JSONObject> list, List<JSONObject> list2, long j) {
        ...
        while (true) {
            ...
            if (isEmpty && isEmpty2) {
                logger.mo18161w(TAG, String.format("mergeEventsAndIdentifys: number of events and identifys less than expected by %d", new Object[]{Long.valueOf(j - ((long) jSONArray.length()))}));
                break;
    ...
    public long saveEvent(String str, JSONObject jSONObject) {
        ...
        if (Utils.isEmptyString(jSONObject2)) {
            logger.mo18150e(TAG, String.format("Detected empty event string for event type %s, skipping", new Object[]{str}));
            return -1;
        }
    ...
    public JSONObject truncate(JSONObject jSONObject) {
        ...
        if (jSONObject.length() > 1000) {
            logger.mo18161w(TAG, "Warning: too many properties (more than 1000), ignoring");
            return new JSONObject();
        }
    ...
    public boolean validateLogEvent(String str) {
        ...
        logger.mo18150e(TAG, "Argument eventType cannot be null or blank in logEvent()");
        return false;
    }
}
