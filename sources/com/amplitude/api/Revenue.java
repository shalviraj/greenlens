...
public class Revenue {
    ...
    public boolean isValidRevenue() {
        ...
        logger.mo18161w(TAG, "Invalid revenue, need to set price");
        return false;
    }
    ...
    public Revenue setProductId(String str) {
        if (Utils.isEmptyString(str)) {
            logger.mo18161w(TAG, "Invalid empty productId");
            return this;
        }
        this.productId = str;
        return this;
    ...
    public Revenue setRevenueProperties(JSONObject jSONObject) {
        logger.mo18161w(TAG, "setRevenueProperties is deprecated, please use setEventProperties instead");
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            ...
            logger.mo18150e(TAG, String.format("Failed to convert revenue object to JSON: %s", new Object[]{e.toString()}));
        }
        return jSONObject;
    }
}
