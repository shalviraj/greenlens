...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        C55841 r4 = new AccessibilityDelegateCompat() {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C5480R.layout.design_navigation_menu_item, this, true);
        setIconSize(context.getResources().getDimensionPixelSize(C5480R.dimen.design_navigation_icon_size));
        CheckedTextView checkedTextView = (CheckedTextView) findViewById(C5480R.C5483id.design_menu_item_text);
    ...
    private void setActionView(@Nullable View view) {
        if (view != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C5480R.C5483id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    public void setIcon(@Nullable Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.emptyDrawable == null) {
                Drawable drawable2 = ResourcesCompat.getDrawable(getResources(), C5480R.C5482drawable.navigation_empty_icon, getContext().getTheme());
