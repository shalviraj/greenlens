...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup, View.OnClickListener onClickListener) {
            super(layoutInflater.inflate(C5480R.layout.design_navigation_item, viewGroup, false));
    ...
    public static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C5480R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }

    public static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C5480R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }
    ...
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.menuView == null) {
            NavigationMenuView navigationMenuView = (NavigationMenuView) this.layoutInflater.inflate(C5480R.layout.design_navigation_menu, viewGroup, false);
            ...
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(C5480R.layout.design_navigation_item_header, this.menuView, false);
    ...
    public void initForMenu(@NonNull Context context, @NonNull MenuBuilder menuBuilder) {
        ...
        this.paddingSeparator = context.getResources().getDimensionPixelOffset(C5480R.dimen.design_navigation_separator_vertical_padding);
    }
