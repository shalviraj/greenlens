...
public final class MaterialContainerTransform extends Transition {
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, mo101to = 1.0d) float f, @FloatRange(from = 0.0d, mo101to = 1.0d) float f2) {
            this.start = f;
            this.end = f2;
        }
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            if (i > 0 || f < 0.0f) {
                ...
                float f6 = fArr2[0];
                float f7 = fArr2[1];
                f4 = C0843a.m440a(f4, f6, f2, f4);
                f5 = C0843a.m440a(f5, f7, f2, f5);
            }
            float f8 = f4;
            float f9 = f5;
    ...
    private static void captureValues(@androidx.annotation.NonNull android.transition.TransitionValues r2, @androidx.annotation.Nullable android.view.View r3, @androidx.annotation.IdRes int r4, @androidx.annotation.Nullable com.google.android.material.shape.ShapeAppearanceModel r5) {
        ...
        L_0x000f:
            android.view.View r3 = r2.view
            int r4 = com.google.android.material.C5480R.C5483id.mtrl_motion_snapshot_view
    ...
    private static ShapeAppearanceModel getShapeAppearance(@NonNull View view, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        int i = C5480R.C5483id.mtrl_motion_snapshot_view;
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(new int[]{C5480R.attr.transitionShapeAppearance});
    ...
    private boolean isEntering(@NonNull RectF rectF, @NonNull RectF rectF2) {
        ...
        StringBuilder u = C0843a.m460u("Invalid transition direction: ");
        u.append(this.transitionDirection);
        throw new IllegalArgumentException(u.toString());
    }

    private void maybeApplyThemeValues(Context context, boolean z) {
        TransitionUtils.maybeApplyThemeInterpolator(this, context, C5480R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        TransitionUtils.maybeApplyThemeDuration(this, context, z ? C5480R.attr.motionDurationLong1 : C5480R.attr.motionDurationMedium2);
        if (!this.pathMotionCustom) {
            TransitionUtils.maybeApplyThemePath(this, context, C5480R.attr.motionPath);
        }
    }
