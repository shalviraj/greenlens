...
public class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Chip chip2 = (Chip) from.inflate(C5480R.layout.material_time_chip, this, false);
        this.chip = chip2;
        TextInputLayout textInputLayout2 = (TextInputLayout) from.inflate(C5480R.layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C5480R.C5483id.material_label);
