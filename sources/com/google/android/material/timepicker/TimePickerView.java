...
public class TimePickerView extends ConstraintLayout implements TimePickerControls {
        ...
        this.selectionListener = new View.OnClickListener() {
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C5480R.C5483id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C5480R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C5480R.C5483id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C5480R.C5483id.material_clock_period_toggle);
        this.toggle = materialButtonToggleGroup;
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            public void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z) {
                int i2 = i == C5480R.C5483id.material_clock_period_pm_button ? 1 : 0;
                if (TimePickerView.this.onPeriodChangeListener != null && z) {
                    TimePickerView.this.onPeriodChangeListener.onPeriodChange(i2);
                }
            }
        });
        this.minuteView = (Chip) findViewById(C5480R.C5483id.material_minute_tv);
        this.hourView = (Chip) findViewById(C5480R.C5483id.material_hour_tv);
        this.clockHandView = (ClockHandView) findViewById(C5480R.C5483id.material_clock_hand);
        setupDoubleTap();
        setUpDisplay();
    }
    ...
    private void setUpDisplay() {
        ...
        int i = C5480R.C5483id.selection_type;
        chip.setTag(i, 12);
    ...
    private void setupDoubleTap() {
        ...
        C57154 r1 = new View.OnTouchListener() {
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C5480R.C5483id.material_clock_display, i);
    ...
    public void updateTime(int i, int i2, int i3) {
        this.toggle.check(i == 1 ? C5480R.C5483id.material_clock_period_pm_button : C5480R.C5483id.material_clock_period_am_button);
