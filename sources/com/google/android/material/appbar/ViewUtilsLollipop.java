...
public class ViewUtilsLollipop {
    ...
    public static void setDefaultAppBarLayoutStateListAnimator(@NonNull View view, float f) {
        int integer = view.getResources().getInteger(C5480R.integer.app_bar_elevation_anim_duration);
        StateListAnimator stateListAnimator = new StateListAnimator();
        long j = (long) integer;
        stateListAnimator.addState(new int[]{16842766, C5480R.attr.state_liftable, -C5480R.attr.state_lifted}, ObjectAnimator.ofFloat(view, Key.ELEVATION, new float[]{0.0f}).setDuration(j));
        stateListAnimator.addState(new int[]{16842766}, ObjectAnimator.ofFloat(view, Key.ELEVATION, new float[]{f}).setDuration(j));
