...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C5480R.styleable.RangeSlider, i, BaseSlider.DEF_STYLE_RES, new int[0]);
        int i2 = C5480R.styleable.RangeSlider_values;
        ...
        this.minSeparation = obtainStyledAttributes.getDimension(C5480R.styleable.RangeSlider_minSeparation, 0.0f);
