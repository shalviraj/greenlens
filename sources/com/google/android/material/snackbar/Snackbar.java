...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    static {
        int i = C5480R.attr.snackbarButtonStyle;
        SNACKBAR_BUTTON_STYLE_ATTR = new int[]{i};
        SNACKBAR_CONTENT_STYLE_ATTRS = new int[]{i, C5480R.attr.snackbarTextViewStyle};
    }
    ...
    private static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            ...
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(context).inflate(hasSnackbarContentStyleAttrs(context) ? C5480R.layout.mtrl_layout_snackbar_include : C5480R.layout.design_layout_snackbar_include, findSuitableParent, false);
