...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C5480R.styleable.SnackbarLayout);
        this.maxWidth = obtainStyledAttributes.getDimensionPixelSize(C5480R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.maxInlineActionWidth = obtainStyledAttributes.getDimensionPixelSize(C5480R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    public void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C5480R.C5483id.snackbar_text);
        this.actionView = (Button) findViewById(C5480R.C5483id.snackbar_action);
    }
    ...
    public void onMeasure(int r8, int r9) {
        ...
        L_0x0018:
            ...
            int r1 = com.google.android.material.C5480R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r1)
            android.content.res.Resources r1 = r7.getResources()
            int r2 = com.google.android.material.C5480R.dimen.design_snackbar_padding_vertical
    ...
    public void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C5480R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
}
