...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C5480R.attr.snackbarStyle};
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(@NonNull Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C5480R.styleable.SnackbarLayout);
            int i = C5480R.styleable.SnackbarLayout_elevation;
            if (obtainStyledAttributes.hasValue(i)) {
                ViewCompat.setElevation(this, (float) obtainStyledAttributes.getDimensionPixelSize(i, 0));
            }
            this.animationMode = obtainStyledAttributes.getInt(C5480R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = obtainStyledAttributes.getFloat(C5480R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, obtainStyledAttributes, C5480R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C5480R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = obtainStyledAttributes.getFloat(C5480R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
        ...
        private Drawable createThemedBackground() {
            float dimension = getResources().getDimension(C5480R.dimen.mtrl_snackbar_background_corner_radius);
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setShape(0);
            gradientDrawable.setCornerRadius(dimension);
            gradientDrawable.setColor(MaterialColors.layer(this, C5480R.attr.colorSurface, C5480R.attr.colorOnSurface, getBackgroundOverlayColorAlpha()));
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C5480R.layout.mtrl_layout_snackbar : C5480R.layout.design_layout_snackbar;
    }
    ...
    public B setAnchorView(@IdRes int i) {
        ...
        throw new IllegalArgumentException(C0843a.m444e("Unable to find anchor view with id: ", i));
    }
