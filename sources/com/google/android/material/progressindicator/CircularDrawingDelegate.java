...
public final class CircularDrawingDelegate extends DrawingDelegate<CircularProgressIndicatorSpec> {
    ...
    public void adjustCanvas(@NonNull Canvas canvas, @FloatRange(from = 0.0d, mo101to = 1.0d) float f) {
        S s = this.spec;
    ...
    public void fillIndicator(@NonNull Canvas canvas, @NonNull Paint paint, @FloatRange(from = 0.0d, mo101to = 1.0d) float f, @FloatRange(from = 0.0d, mo101to = 1.0d) float f2, @ColorInt int i) {
        Paint paint2 = paint;
        if (f != f2) {
