...
public abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    public void setGrowFraction(@FloatRange(from = 0.0d, mo101to = 1.0d) float f) {
    ...
    @VisibleForTesting
    public void setMockHideAnimationRunning(boolean z, @FloatRange(from = 0.0d, mo101to = 1.0d) float f) {
        this.mockHideAnimationRunning = z;
        this.mockGrowFraction = f;
    }

    @VisibleForTesting
    public void setMockShowAnimationRunning(boolean z, @FloatRange(from = 0.0d, mo101to = 1.0d) float f) {
