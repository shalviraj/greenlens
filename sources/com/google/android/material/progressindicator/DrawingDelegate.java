...
public abstract class DrawingDelegate<S extends BaseProgressIndicatorSpec> {
    ...
    public abstract void adjustCanvas(@NonNull Canvas canvas, @FloatRange(from = 0.0d, mo101to = 1.0d) float f);

    public abstract void fillIndicator(@NonNull Canvas canvas, @NonNull Paint paint, @FloatRange(from = 0.0d, mo101to = 1.0d) float f, @FloatRange(from = 0.0d, mo101to = 1.0d) float f2, @ColorInt int i);
    ...
    public void validateSpecAndAdjustCanvas(@NonNull Canvas canvas, @FloatRange(from = 0.0d, mo101to = 1.0d) float f) {
