...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C5480R.style.Widget_MaterialComponents_Chip_Action;
        ...
        public void onPopulateNodeForVirtualView(int i, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (i == 1) {
                ...
                if (closeIconContentDescription == null) {
                    ...
                    int i2 = C5480R.string.mtrl_chip_close_icon_content_description;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C5480R.attr.chipStyle);
    }
    ...
    public Chip(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        /*
            ...
            int r9 = com.google.android.material.C5480R.styleable.Chip_shapeAppearance
    ...
    private void initMinTouchTarget(Context context, @Nullable AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C5480R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = obtainStyledAttributes.getBoolean(C5480R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil((double) obtainStyledAttributes.getDimension(C5480R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil((double) ViewUtils.dpToPx(getContext(), 48))));
