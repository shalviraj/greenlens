...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    @AttrRes
    private static final int DEF_STYLE_ATTR = C5480R.attr.alertDialogStyle;
    @StyleRes
    private static final int DEF_STYLE_RES = C5480R.style.MaterialAlertDialog_MaterialComponents;
    @AttrRes
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C5480R.attr.materialAlertDialogTheme;
    @Nullable
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C5480R.attr.colorSurface, getClass().getCanonicalName());
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetBottom(@C0033Px int i) {
        this.backgroundInsets.bottom = i;
        return this;
    }

    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetEnd(@C0033Px int i) {
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetStart(@C0033Px int i) {
        if (getContext().getResources().getConfiguration().getLayoutDirection() == 1) {
            this.backgroundInsets.right = i;
        } else {
            this.backgroundInsets.left = i;
    ...
    @NonNull
    public MaterialAlertDialogBuilder setBackgroundInsetTop(@C0033Px int i) {
