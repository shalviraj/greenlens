...
public abstract class NavigationBarView extends FrameLayout {
    ...
    public NavigationBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        int[] iArr = C5480R.styleable.NavigationBarView;
        int i3 = C5480R.styleable.NavigationBarView_itemTextAppearanceInactive;
        int i4 = C5480R.styleable.NavigationBarView_itemTextAppearanceActive;
        ...
        int i5 = C5480R.styleable.NavigationBarView_itemIconTint;
        createNavigationBarMenuView.setIconTintList(obtainTintedStyledAttributes.hasValue(i5) ? obtainTintedStyledAttributes.getColorStateList(i5) : createNavigationBarMenuView.createDefaultColorStateList(16842808));
        setItemIconSize(obtainTintedStyledAttributes.getDimensionPixelSize(C5480R.styleable.NavigationBarView_itemIconSize, getResources().getDimensionPixelSize(C5480R.dimen.mtrl_navigation_bar_item_default_icon_size)));
        ...
        int i6 = C5480R.styleable.NavigationBarView_itemTextColor;
        ...
        int i7 = C5480R.styleable.NavigationBarView_elevation;
        if (obtainTintedStyledAttributes.hasValue(i7)) {
            setElevation((float) obtainTintedStyledAttributes.getDimensionPixelSize(i7, 0));
        }
        DrawableCompat.setTintList(getBackground().mutate(), MaterialResources.getColorStateList(context2, obtainTintedStyledAttributes, C5480R.styleable.NavigationBarView_backgroundTint));
        setLabelVisibilityMode(obtainTintedStyledAttributes.getInteger(C5480R.styleable.NavigationBarView_labelVisibilityMode, -1));
        int resourceId = obtainTintedStyledAttributes.getResourceId(C5480R.styleable.NavigationBarView_itemBackground, 0);
        if (resourceId != 0) {
            createNavigationBarMenuView.setItemBackgroundRes(resourceId);
        } else {
            setItemRippleColor(MaterialResources.getColorStateList(context2, obtainTintedStyledAttributes, C5480R.styleable.NavigationBarView_itemRippleColor));
        }
        int i8 = C5480R.styleable.NavigationBarView_menu;
