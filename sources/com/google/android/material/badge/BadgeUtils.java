        ...
        toolbar.post(new Runnable() {
            public void run() {
                ...
                if (actionMenuItemView != null) {
                    ...
                    badgeDrawable.setHorizontalOffset(toolbar.getResources().getDimensionPixelOffset(C5480R.dimen.mtrl_badge_toolbar_action_menu_item_horizontal_offset) + badgeDrawable.getHorizontalOffset());
                    BadgeDrawable badgeDrawable2 = badgeDrawable;
                    badgeDrawable2.setVerticalOffset(toolbar.getResources().getDimensionPixelOffset(C5480R.dimen.mtrl_badge_toolbar_action_menu_item_vertical_offset) + badgeDrawable2.getVerticalOffset());
