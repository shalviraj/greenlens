...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C5480R.attr.editTextStyle);
    }

    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, i, 0), attributeSet, i);
        this.parentRect = new Rect();
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C5480R.styleable.TextInputEditText, i, C5480R.style.Widget_Design_TextInputEditText, new int[0]);
        setTextInputLayoutFocusedRectEnabled(obtainStyledAttributes.getBoolean(C5480R.styleable.TextInputEditText_textInputLayoutFocusedRectEnabled, false));
    ...
    private String getAccessibilityNodeInfoText(@NonNull TextInputLayout textInputLayout) {
        ...
        setLabelFor(C5480R.C5483id.textinput_helper_text);
        String str = "";
    ...
    public boolean requestRectangleOnScreen(@Nullable Rect rect) {
        ...
        if (textInputLayout != null && this.textInputLayoutFocusedRectEnabled) {
            this.parentRect.set(0, textInputLayout.getHeight() - getResources().getDimensionPixelOffset(C5480R.dimen.mtrl_edittext_rectangle_top_offset), textInputLayout.getWidth(), textInputLayout.getHeight());
