...
public class MaterialRadioButton extends AppCompatRadioButton {
    private static final int DEF_STYLE_RES = C5480R.style.Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    public MaterialRadioButton(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C5480R.attr.radioButtonStyle);
    }
    ...
    public MaterialRadioButton(@androidx.annotation.NonNull android.content.Context r8, @androidx.annotation.Nullable android.util.AttributeSet r9, int r10) {
        /*
            ...
            int[] r2 = com.google.android.material.C5480R.styleable.MaterialRadioButton
            r6 = 0
            int[] r5 = new int[r6]
            r0 = r8
            r1 = r9
            ...
            int r10 = com.google.android.material.C5480R.styleable.MaterialRadioButton_buttonTint
        ...
        L_0x0028:
            int r8 = com.google.android.material.C5480R.styleable.MaterialRadioButton_useMaterialThemeColors
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            int color = MaterialColors.getColor(this, C5480R.attr.colorControlActivated);
            int color2 = MaterialColors.getColor(this, C5480R.attr.colorOnSurface);
            int color3 = MaterialColors.getColor(this, C5480R.attr.colorSurface);
