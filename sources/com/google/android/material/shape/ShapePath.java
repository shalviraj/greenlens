...
public class ShapePath {
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f11389y - this.startY), (double) (this.operation.f11388x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f11389y - this.startY) / (this.operation.f11388x - this.startX))));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        /* renamed from: x */
        public float f11388x;
        /* access modifiers changed from: private */

        /* renamed from: y */
        public float f11389y;

        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            Matrix matrix2 = this.matrix;
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f11388x, this.f11389y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f, float f2) {
        ...
        float unused = pathLineOperation.f11388x = f;
        float unused2 = pathLineOperation.f11389y = f2;
