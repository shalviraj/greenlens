...
public class YearGridAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        String string = viewHolder.textView.getContext().getString(C5480R.string.mtrl_picker_navigate_to_year_description);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder((TextView) LayoutInflater.from(viewGroup.getContext()).inflate(C5480R.layout.mtrl_calendar_year, viewGroup, false));
    }
}
