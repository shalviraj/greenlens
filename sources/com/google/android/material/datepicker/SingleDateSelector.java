...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C5480R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }

    public int getDefaultTitleResId() {
        return C5480R.string.mtrl_picker_date_header_title;
    }
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            return resources.getString(C5480R.string.mtrl_picker_date_header_unselected);
        }
        String yearMonthDay = DateStrings.getYearMonthDay(l.longValue());
        return resources.getString(C5480R.string.mtrl_picker_date_header_selected, new Object[]{yearMonthDay});
    }
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull OnSelectionChangedListener<Long> onSelectionChangedListener) {
        View inflate = layoutInflater.inflate(C5480R.layout.mtrl_picker_text_input_date, viewGroup, false);
        TextInputLayout textInputLayout = (TextInputLayout) inflate.findViewById(C5480R.C5483id.mtrl_picker_text_input_date);
