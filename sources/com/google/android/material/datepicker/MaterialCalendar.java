...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(C5480R.C5483id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    ...
                    i = C5480R.string.mtrl_picker_toggle_to_year_selection;
                } else {
                    materialCalendar = MaterialCalendar.this;
                    i = C5480R.string.mtrl_picker_toggle_to_day_selection;
                }
                accessibilityNodeInfoCompat.setHintText(materialCalendar.getString(i));
            }
        });
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(C5480R.C5483id.month_navigation_previous);
        materialButton2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton3 = (MaterialButton) view.findViewById(C5480R.C5483id.month_navigation_next);
        materialButton3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C5480R.C5483id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C5480R.C5483id.mtrl_calendar_day_selector_frame);
    ...
    public static int getDayHeight(@NonNull Context context) {
        return context.getResources().getDimensionPixelSize(C5480R.dimen.mtrl_calendar_day_height);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            i2 = C5480R.layout.mtrl_calendar_vertical;
            i = 1;
        } else {
            i2 = C5480R.layout.mtrl_calendar_horizontal;
            i = 0;
        }
        View inflate = cloneInContext.inflate(i2, viewGroup, false);
        GridView gridView = (GridView) inflate.findViewById(C5480R.C5483id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) inflate.findViewById(C5480R.C5483id.mtrl_calendar_months);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C5480R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView2 = (RecyclerView) inflate.findViewById(C5480R.C5483id.mtrl_calendar_year_selector_frame);
        ...
        if (inflate.findViewById(C5480R.C5483id.month_navigation_fragment_toggle) != null) {
