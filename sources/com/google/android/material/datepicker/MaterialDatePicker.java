...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C5480R.C5482drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C5480R.C5482drawable.material_ic_edit_black_24dp));
        return stateListDrawable;
    }

    private static int getDialogPickerHeight(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C5480R.dimen.mtrl_calendar_navigation_bottom_padding) + resources.getDimensionPixelOffset(C5480R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelSize(C5480R.dimen.mtrl_calendar_navigation_height);
        int dimensionPixelSize = resources.getDimensionPixelSize(C5480R.dimen.mtrl_calendar_days_of_week_height);
        int i = MonthAdapter.MAXIMUM_WEEKS;
        return C0843a.m441b(dimensionPixelOffset, dimensionPixelSize, (resources.getDimensionPixelOffset(C5480R.dimen.mtrl_calendar_month_vertical_padding) * (i - 1)) + (resources.getDimensionPixelSize(C5480R.dimen.mtrl_calendar_day_height) * i), resources.getDimensionPixelOffset(C5480R.dimen.mtrl_calendar_bottom_padding));
    }

    private static int getPaddedPickerWidth(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C5480R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        int dimensionPixelSize = resources.getDimensionPixelSize(C5480R.dimen.mtrl_calendar_day_width) * i;
        return ((i - 1) * resources.getDimensionPixelOffset(C5480R.dimen.mtrl_calendar_month_horizontal_padding)) + dimensionPixelSize + (dimensionPixelOffset * 2);
    }
    ...
    public static boolean isNestedScrollable(@NonNull Context context) {
        return readMaterialCalendarStyleBoolean(context, C5480R.attr.nestedScrollable);
    }
    ...
    public static boolean readMaterialCalendarStyleBoolean(@NonNull Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C5480R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(C5480R.C5483id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C5480R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void updateToggleContentDescription(@NonNull CheckableImageButton checkableImageButton) {
        this.headerToggleButton.setContentDescription(checkableImageButton.getContext().getString(this.headerToggleButton.isChecked() ? C5480R.string.mtrl_picker_toggle_to_calendar_input_mode : C5480R.string.mtrl_picker_toggle_to_text_input_mode));
    }
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C5480R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, C5480R.attr.materialCalendarStyle, C5480R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C5480R.layout.mtrl_picker_fullscreen : C5480R.layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C5480R.C5483id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View findViewById = inflate.findViewById(C5480R.C5483id.mtrl_calendar_main_pane);
            View findViewById2 = inflate.findViewById(C5480R.C5483id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) inflate.findViewById(C5480R.C5483id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C5480R.C5483id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(C5480R.C5483id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C5480R.C5483id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C5480R.C5483id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C5480R.dimen.mtrl_calendar_dialog_background_inset);
