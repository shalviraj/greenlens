...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final int DEF_STYLE_RES = C5480R.style.Widget_Design_BottomSheet_Modal;
    ...
    private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(@androidx.annotation.NonNull android.view.View r7, float r8, float r9) {
            ...
            L_0x00ff:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.bottomsheet.BottomSheetBehavior.C55144.onViewReleased(android.view.View, float, float):void");
        }
    ...
    public BottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        int i;
        this.peekHeightGestureInsetBuffer = context.getResources().getDimensionPixelSize(C5480R.dimen.mtrl_min_touch_target_size);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C5480R.styleable.BottomSheetBehavior_Layout);
        this.shapeThemingEnabled = obtainStyledAttributes.hasValue(C5480R.styleable.BottomSheetBehavior_Layout_shapeAppearance);
        int i2 = C5480R.styleable.BottomSheetBehavior_Layout_backgroundTint;
        ...
        this.elevation = obtainStyledAttributes.getDimension(C5480R.styleable.BottomSheetBehavior_Layout_android_elevation, -1.0f);
        int i3 = C5480R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight;
        ...
        setHideable(obtainStyledAttributes.getBoolean(C5480R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setGestureInsetBottomIgnored(obtainStyledAttributes.getBoolean(C5480R.styleable.BottomSheetBehavior_Layout_gestureInsetBottomIgnored, false));
        setFitToContents(obtainStyledAttributes.getBoolean(C5480R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        setSkipCollapsed(obtainStyledAttributes.getBoolean(C5480R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
        setDraggable(obtainStyledAttributes.getBoolean(C5480R.styleable.BottomSheetBehavior_Layout_behavior_draggable, true));
        setSaveFlags(obtainStyledAttributes.getInt(C5480R.styleable.BottomSheetBehavior_Layout_behavior_saveFlags, 0));
        setHalfExpandedRatio(obtainStyledAttributes.getFloat(C5480R.styleable.BottomSheetBehavior_Layout_behavior_halfExpandedRatio, 0.5f));
        int i4 = C5480R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset;
        ...
        this.paddingBottomSystemWindowInsets = obtainStyledAttributes.getBoolean(C5480R.styleable.BottomSheetBehavior_Layout_paddingBottomSystemWindowInsets, false);
        this.paddingLeftSystemWindowInsets = obtainStyledAttributes.getBoolean(C5480R.styleable.BottomSheetBehavior_Layout_paddingLeftSystemWindowInsets, false);
        this.paddingRightSystemWindowInsets = obtainStyledAttributes.getBoolean(C5480R.styleable.BottomSheetBehavior_Layout_paddingRightSystemWindowInsets, false);
    ...
    private void createMaterialShapeDrawable(@NonNull Context context, AttributeSet attributeSet, boolean z, @Nullable ColorStateList colorStateList) {
        if (this.shapeThemingEnabled) {
            this.shapeAppearanceModelDefault = ShapeAppearanceModel.builder(context, attributeSet, C5480R.attr.bottomSheetStyle, DEF_STYLE_RES).build();
    ...
    private void updateAccessibilityActions() {
        ...
        if (weakReference != null && (view = (View) weakReference.get()) != null) {
            ...
            if (!this.fitToContents && this.state != 6) {
                this.expandHalfwayActionId = addAccessibilityActionForState(view, C5480R.string.bottomsheet_action_expand_halfway, 6);
            }
    ...
    public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, int i) {
        ...
        if (this.viewRef == null) {
            this.peekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C5480R.dimen.design_bottom_sheet_peek_height_min);
    ...
    public void setHalfExpandedRatio(@FloatRange(from = 0.0d, mo101to = 1.0d) float f) {
        if (f <= 0.0f || f >= 1.0f) {
    ...
    public void settleToState(@NonNull View view, int i) {
        ...
        if (i == 4) {
            ...
            throw new IllegalArgumentException(C0843a.m444e("Illegal state argument: ", i));
        } else {
            i2 = this.parentHeight;
        }
