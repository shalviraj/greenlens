...
/* renamed from: es.voghdev.pdfviewpager.library.subscaleview.decoder.SkiaImageDecoder */
public class SkiaImageDecoder implements C6991c {

    /* renamed from: a */
    public final Bitmap.Config f13929a;

    @Keep
    public SkiaImageDecoder() {
        Bitmap.Config preferredBitmapConfig = SubsamplingScaleImageView.getPreferredBitmapConfig();
        this.f13929a = preferredBitmapConfig == null ? Bitmap.Config.RGB_565 : preferredBitmapConfig;
    }
    ...
    public android.graphics.Bitmap mo24298a(android.content.Context r9, @androidx.annotation.NonNull android.net.Uri r10) {
        /*
            r8 = this;
            java.lang.String r0 = r10.toString()
            android.graphics.BitmapFactory$Options r1 = new android.graphics.BitmapFactory$Options
            r1.<init>()
            android.graphics.Bitmap$Config r2 = r8.f13929a
        ...
        L_0x00cc:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: p351es.voghdev.pdfviewpager.library.subscaleview.decoder.SkiaImageDecoder.mo24298a(android.content.Context, android.net.Uri):android.graphics.Bitmap");
    }
}
