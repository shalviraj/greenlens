...
public class C6996c {
    ...
    /* renamed from: l */
    public static final String f14034l = "c";

    /* renamed from: a */
    public ImageView f14035a;

    /* renamed from: b */
    public FrameLayout.LayoutParams f14036b;

    /* renamed from: c */
    public C6997a f14037c;

    /* renamed from: d */
    public boolean f14038d = false;

    /* renamed from: e */
    public float f14039e = 4.0f;

    /* renamed from: f */
    public int f14040f = 8;

    /* renamed from: g */
    public Activity f14041g;

    /* renamed from: h */
    public Toolbar f14042h;
    ...
    public class C6997a extends AsyncTask<Void, Void, Void> {

        /* renamed from: a */
        public Bitmap f14046a;

        /* renamed from: b */
        public View f14047b;

        public C6997a(C6994a aVar) {
        }

        /* JADX WARNING: Code restructure failed: missing block: B:19:0x0062, code lost:
            r8 = r1.f14041g.getResources().getIdentifier("status_bar_height", "dimen", com.amplitude.api.DeviceInfo.OS_NAME);
         */
        ...
        public java.lang.Object doInBackground(java.lang.Object[] r38) {
            /*
                ...
                android.graphics.Bitmap r1 = r0.f14046a
                boolean r1 = r1.isRecycled()
                if (r1 != 0) goto L_0x0579
                i.a.a.a.c r1 = p372i.p373a.p374a.p375a.C6996c.this
                android.graphics.Bitmap r2 = r0.f14046a
                android.view.View r3 = r0.f14047b
                java.lang.String r4 = p372i.p373a.p374a.p375a.C6996c.f14034l
                ...
                r6.<init>(r7, r7)
                r1.f14036b = r6
                boolean r6 = r1.f14044j
                r7 = 0
                if (r6 == 0) goto L_0x0031
                goto L_0x004d
            L_0x0031:
                androidx.appcompat.widget.Toolbar r6 = r1.f14042h     // Catch:{ NoClassDefFoundError -> 0x004d }
                if (r6 == 0) goto L_0x003a
                int r6 = r6.getHeight()     // Catch:{ NoClassDefFoundError -> 0x004d }
                goto L_0x004e
            L_0x003a:
                android.app.Activity r6 = r1.f14041g     // Catch:{ NoClassDefFoundError -> 0x004d }
            ...
            L_0x004d:
                r6 = r7
            L_0x004e:
                android.app.Activity r8 = r1.f14041g
                ...
                if (r8 <= 0) goto L_0x007b
                android.app.Activity r11 = r1.f14041g
            ...
            L_0x007c:
                ...
                r13[r7] = r14
                android.app.Activity r14 = r1.f14041g
            ...
            L_0x00af:
                r9 = r7
            L_0x00b0:
                android.app.Activity r10 = r1.f14041g
            ...
            L_0x0100:
                ...
                android.app.Activity r7 = r1.f14041g     // Catch:{ NoClassDefFoundError -> 0x0117 }
                boolean r7 = r7 instanceof androidx.appcompat.app.AppCompatActivity     // Catch:{ NoClassDefFoundError -> 0x0117 }
                if (r7 == 0) goto L_0x011d
                android.widget.FrameLayout$LayoutParams r7 = r1.f14036b     // Catch:{ NoClassDefFoundError -> 0x0117 }
                r8 = 0
                r7.setMargins(r8, r6, r8, r8)     // Catch:{ NoClassDefFoundError -> 0x0117 }
                android.widget.FrameLayout$LayoutParams r6 = r1.f14036b     // Catch:{ NoClassDefFoundError -> 0x0117 }
                r7 = 48
                r6.gravity = r7     // Catch:{ NoClassDefFoundError -> 0x0117 }
                goto L_0x011d
            L_0x0117:
                android.widget.FrameLayout$LayoutParams r6 = r1.f14036b
                r7 = 0
            ...
            L_0x011d:
                ...
                boolean r6 = r1.f14045k
                if (r6 == 0) goto L_0x018f
                int r6 = r1.f14040f
                android.app.Activity r8 = r1.f14041g
                java.lang.String r9 = p372i.p373a.p374a.p375a.C6998d.f14049a
            ...
            L_0x0156:
                ...
                goto L_0x0186
            L_0x017e:
                java.lang.String r3 = p372i.p373a.p374a.p375a.C6998d.f14049a
            ...
            L_0x0554:
                ...
                android.app.Activity r2 = r0.f14041g
                r1.<init>(r2)
                r0.f14035a = r1
                android.widget.ImageView$ScaleType r2 = android.widget.ImageView.ScaleType.CENTER_CROP
                r1.setScaleType(r2)
                android.widget.ImageView r1 = r0.f14035a
                android.graphics.drawable.BitmapDrawable r2 = new android.graphics.drawable.BitmapDrawable
                android.app.Activity r0 = r0.f14041g
            ...
            L_0x0579:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p372i.p373a.p374a.p375a.C6996c.C6997a.doInBackground(java.lang.Object[]):java.lang.Object");
        }

        @SuppressLint({"NewApi"})
        public void onPostExecute(Object obj) {
            super.onPostExecute((Void) obj);
            this.f14047b.destroyDrawingCache();
            this.f14047b.setDrawingCacheEnabled(false);
            C6996c cVar = C6996c.this;
            if (cVar.f14035a != null) {
                Window window = cVar.f14041g.getWindow();
                C6996c cVar2 = C6996c.this;
                window.addContentView(cVar2.f14035a, cVar2.f14036b);
                C6996c.this.f14035a.setAlpha(0.0f);
                C6996c.this.f14035a.animate().alpha(1.0f).setDuration((long) C6996c.this.f14043i).setInterpolator(new LinearInterpolator()).start();
            }
            this.f14047b = null;
            this.f14046a = null;
        }
        ...
        public void onPreExecute() {
            super.onPreExecute();
            this.f14047b = C6996c.this.f14041g.getWindow().getDecorView();
            Rect rect = new Rect();
            this.f14047b.getWindowVisibleDisplayFrame(rect);
            this.f14047b.destroyDrawingCache();
            this.f14047b.setDrawingCacheEnabled(true);
            this.f14047b.buildDrawingCache(true);
            Bitmap drawingCache = this.f14047b.getDrawingCache(true);
            this.f14046a = drawingCache;
            if (drawingCache == null) {
                this.f14047b.measure(View.MeasureSpec.makeMeasureSpec(rect.width(), BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(rect.height(), BasicMeasure.EXACTLY));
                View view = this.f14047b;
                view.layout(0, 0, view.getMeasuredWidth(), this.f14047b.getMeasuredHeight());
                this.f14047b.destroyDrawingCache();
                this.f14047b.setDrawingCacheEnabled(true);
                this.f14047b.buildDrawingCache(true);
                this.f14046a = this.f14047b.getDrawingCache(true);
            }
        }
    }

    public C6996c(Activity activity) {
        this.f14041g = activity;
        this.f14043i = activity.getResources().getInteger(R.integer.blur_dialog_animation_duration);
    }

    /* renamed from: a */
    public final void mo24380a() {
        ImageView imageView = this.f14035a;
        if (imageView != null) {
            ViewGroup viewGroup = (ViewGroup) imageView.getParent();
            if (viewGroup != null) {
                viewGroup.removeView(this.f14035a);
            }
            this.f14035a = null;
        }
    }
