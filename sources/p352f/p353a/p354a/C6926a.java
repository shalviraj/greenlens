...
public interface C6926a extends IInterface {

    /* renamed from: f.a.a.a$a */
    public static abstract class C6927a extends Binder implements C6926a {
        ...
        public static class C6928a implements C6926a {

            /* renamed from: a */
            public IBinder f13944a;

            public C6928a(IBinder iBinder) {
            ...
            public void extraCallback(String str, Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(C6927a.DESCRIPTOR);
            ...
            public void onMessageChannelReady(Bundle bundle) {
                ...
                try {
                    ...
                    this.f13944a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onPostMessage(String str, Bundle bundle) {
                ...
                try {
                    ...
                    this.f13944a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onRelationshipValidationResult(int i, Uri uri, boolean z, Bundle bundle) {
                ...
                try {
                    ...
                    this.f13944a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static C6926a asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C6926a)) ? new C6928a(iBinder) : (C6926a) queryLocalInterface;
        }
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) {
            ...
            L_0x00b7:
                ...
                goto L_0x0053
            */
            throw new UnsupportedOperationException("Method not decompiled: p352f.p353a.p354a.C6926a.C6927a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }
