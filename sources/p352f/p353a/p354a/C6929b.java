...
public interface C6929b extends IInterface {

    /* renamed from: f.a.a.b$a */
    public static abstract class C6930a extends Binder implements C6929b {
        ...
        public static class C6931a implements C6929b {

            /* renamed from: a */
            public IBinder f13945a;

            public C6931a(IBinder iBinder) {
            ...
            public Bundle extraCommand(String str, Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(C6930a.DESCRIPTOR);
            ...
            public int postMessage(C6926a aVar, String str, Bundle bundle) {
                ...
                try {
                    ...
                    this.f13945a.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public boolean validateRelationship(C6926a aVar, int i, Uri uri, Bundle bundle) {
                ...
                try {
                    ...
                    this.f13945a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() == 0) {
                        z = false;
                    }
        ...
        public static C6929b asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C6929b)) ? new C6931a(iBinder) : (C6929b) queryLocalInterface;
        }
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) {
            ...
            L_0x014a:
                ...
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: p352f.p353a.p354a.C6929b.C6930a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }

    Bundle extraCommand(String str, Bundle bundle);

    boolean mayLaunchUrl(C6926a aVar, Uri uri, Bundle bundle, List<Bundle> list);

    boolean newSession(C6926a aVar);

    int postMessage(C6926a aVar, String str, Bundle bundle);

    boolean requestPostMessageChannel(C6926a aVar, Uri uri);

    boolean updateVisuals(C6926a aVar, Bundle bundle);

    boolean validateRelationship(C6926a aVar, int i, Uri uri, Bundle bundle);
